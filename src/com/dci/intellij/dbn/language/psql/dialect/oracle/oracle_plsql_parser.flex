...
"offset" {return tt.getKeywordTokenType(233);}
"oid" {return tt.getKeywordTokenType(234);}
"old" {return tt.getKeywordTokenType(235);}
"on" {return tt.getKeywordTokenType(236);}
"one_sided_prob_or_less" {return tt.getKeywordTokenType(237);}
"one_sided_prob_or_more" {return tt.getKeywordTokenType(238);}
"one_sided_sig" {return tt.getKeywordTokenType(239);}
"only" {return tt.getKeywordTokenType(240);}
"opaque" {return tt.getKeywordTokenType(241);}
"open" {return tt.getKeywordTokenType(242);}
"operator" {return tt.getKeywordTokenType(243);}
"option" {return tt.getKeywordTokenType(244);}
"or" {return tt.getKeywordTokenType(245);}
"order" {return tt.getKeywordTokenType(246);}
"ordinality" {return tt.getKeywordTokenType(247);}
"organization" {return tt.getKeywordTokenType(248);}
"others" {return tt.getKeywordTokenType(249);}
"out" {return tt.getKeywordTokenType(250);}
"outer" {return tt.getKeywordTokenType(251);}
"over" {return tt.getKeywordTokenType(252);}
"overriding" {return tt.getKeywordTokenType(253);}
"package" {return tt.getKeywordTokenType(254);}
"parallel_enable" {return tt.getKeywordTokenType(255);}
"parameters" {return tt.getKeywordTokenType(256);}
"parent" {return tt.getKeywordTokenType(257);}
"partition" {return tt.getKeywordTokenType(258);}
"passing" {return tt.getKeywordTokenType(259);}
"path" {return tt.getKeywordTokenType(260);}
"pctfree" {return tt.getKeywordTokenType(261);}
"percent" {return tt.getKeywordTokenType(262);}
"phi_coefficient" {return tt.getKeywordTokenType(263);}
"pipe" {return tt.getKeywordTokenType(264);}
"pipelined" {return tt.getKeywordTokenType(265);}
"pivot" {return tt.getKeywordTokenType(266);}
"positive" {return tt.getKeywordTokenType(267);}
"positiven" {return tt.getKeywordTokenType(268);}
"power" {return tt.getKeywordTokenType(269);}
"pragma" {return tt.getKeywordTokenType(270);}
"preceding" {return tt.getKeywordTokenType(271);}
"present" {return tt.getKeywordTokenType(272);}
"prior" {return tt.getKeywordTokenType(273);}
"private" {return tt.getKeywordTokenType(274);}
"procedure" {return tt.getKeywordTokenType(275);}
"public" {return tt.getKeywordTokenType(276);}
"raise" {return tt.getKeywordTokenType(277);}
"range" {return tt.getKeywordTokenType(278);}
"read" {return tt.getKeywordTokenType(279);}
"record" {return tt.getKeywordTokenType(280);}
"ref" {return tt.getKeywordTokenType(281);}
"reference" {return tt.getKeywordTokenType(282);}
"referencing" {return tt.getKeywordTokenType(283);}
"regexp_like" {return tt.getKeywordTokenType(284);}
"reject" {return tt.getKeywordTokenType(285);}
"release" {return tt.getKeywordTokenType(286);}
"relies_on" {return tt.getKeywordTokenType(287);}
"remainder" {return tt.getKeywordTokenType(288);}
"rename" {return tt.getKeywordTokenType(289);}
"replace" {return tt.getKeywordTokenType(290);}
"restrict_references" {return tt.getKeywordTokenType(291);}
"result" {return tt.getKeywordTokenType(292);}
"result_cache" {return tt.getKeywordTokenType(293);}
"return" {return tt.getKeywordTokenType(294);}
"returning" {return tt.getKeywordTokenType(295);}
"reverse" {return tt.getKeywordTokenType(296);}
"revoke" {return tt.getKeywordTokenType(297);}
"right" {return tt.getKeywordTokenType(298);}
"rnds" {return tt.getKeywordTokenType(299);}
"rnps" {return tt.getKeywordTokenType(300);}
"rollback" {return tt.getKeywordTokenType(301);}
"rollup" {return tt.getKeywordTokenType(302);}
"row" {return tt.getKeywordTokenType(303);}
"rowcount" {return tt.getKeywordTokenType(304);}
"rownum" {return tt.getKeywordTokenType(305);}
"rows" {return tt.getKeywordTokenType(306);}
"rowtype" {return tt.getKeywordTokenType(307);}
"rules" {return tt.getKeywordTokenType(308);}
"sample" {return tt.getKeywordTokenType(309);}
"save" {return tt.getKeywordTokenType(310);}
"savepoint" {return tt.getKeywordTokenType(311);}
"schema" {return tt.getKeywordTokenType(312);}
"schemacheck" {return tt.getKeywordTokenType(313);}
"scn" {return tt.getKeywordTokenType(314);}
"second" {return tt.getKeywordTokenType(315);}
"seed" {return tt.getKeywordTokenType(316);}
"segment" {return tt.getKeywordTokenType(317);}
"select" {return tt.getKeywordTokenType(318);}
"self" {return tt.getKeywordTokenType(319);}
"separate" {return tt.getKeywordTokenType(320);}
"sequential" {return tt.getKeywordTokenType(321);}
"serializable" {return tt.getKeywordTokenType(322);}
"serially_reusable" {return tt.getKeywordTokenType(323);}
"servererror" {return tt.getKeywordTokenType(324);}
"set" {return tt.getKeywordTokenType(325);}
"sets" {return tt.getKeywordTokenType(326);}
"share" {return tt.getKeywordTokenType(327);}
"show" {return tt.getKeywordTokenType(328);}
"shutdown" {return tt.getKeywordTokenType(329);}
"siblings" {return tt.getKeywordTokenType(330);}
"sig" {return tt.getKeywordTokenType(331);}
"single" {return tt.getKeywordTokenType(332);}
"size" {return tt.getKeywordTokenType(333);}
"some" {return tt.getKeywordTokenType(334);}
"space" {return tt.getKeywordTokenType(335);}
"sql" {return tt.getKeywordTokenType(336);}
"sqlcode" {return tt.getKeywordTokenType(337);}
"sqlerrm" {return tt.getKeywordTokenType(338);}
"standalone" {return tt.getKeywordTokenType(339);}
"start" {return tt.getKeywordTokenType(340);}
"startup" {return tt.getKeywordTokenType(341);}
"statement" {return tt.getKeywordTokenType(342);}
"static" {return tt.getKeywordTokenType(343);}
"statistic" {return tt.getKeywordTokenType(344);}
"statistics" {return tt.getKeywordTokenType(345);}
"struct" {return tt.getKeywordTokenType(346);}
"submultiset" {return tt.getKeywordTokenType(347);}
"subpartition" {return tt.getKeywordTokenType(348);}
"subtype" {return tt.getKeywordTokenType(349);}
"successful" {return tt.getKeywordTokenType(350);}
"sum_squares_between" {return tt.getKeywordTokenType(351);}
"sum_squares_within" {return tt.getKeywordTokenType(352);}
"suspend" {return tt.getKeywordTokenType(353);}
"synonym" {return tt.getKeywordTokenType(354);}
"table" {return tt.getKeywordTokenType(355);}
"tdo" {return tt.getKeywordTokenType(356);}
"then" {return tt.getKeywordTokenType(357);}
"ties" {return tt.getKeywordTokenType(358);}
"time" {return tt.getKeywordTokenType(359);}
"timezone_abbr" {return tt.getKeywordTokenType(360);}
"timezone_hour" {return tt.getKeywordTokenType(361);}
"timezone_minute" {return tt.getKeywordTokenType(362);}
"timezone_region" {return tt.getKeywordTokenType(363);}
"to" {return tt.getKeywordTokenType(364);}
"trailing" {return tt.getKeywordTokenType(365);}
"transaction" {return tt.getKeywordTokenType(366);}
"trigger" {return tt.getKeywordTokenType(367);}
"truncate" {return tt.getKeywordTokenType(368);}
"trust" {return tt.getKeywordTokenType(369);}
"two_sided_prob" {return tt.getKeywordTokenType(370);}
"two_sided_sig" {return tt.getKeywordTokenType(371);}
"type" {return tt.getKeywordTokenType(372);}
"u_statistic" {return tt.getKeywordTokenType(373);}
"unbounded" {return tt.getKeywordTokenType(374);}
"under" {return tt.getKeywordTokenType(375);}
"under_path" {return tt.getKeywordTokenType(376);}
"union" {return tt.getKeywordTokenType(377);}
"unique" {return tt.getKeywordTokenType(378);}
"unlimited" {return tt.getKeywordTokenType(379);}
"unpivot" {return tt.getKeywordTokenType(380);}
"until" {return tt.getKeywordTokenType(381);}
"update" {return tt.getKeywordTokenType(382);}
"updated" {return tt.getKeywordTokenType(383);}
"updating" {return tt.getKeywordTokenType(384);}
"upsert" {return tt.getKeywordTokenType(385);}
"use" {return tt.getKeywordTokenType(386);}
"user" {return tt.getKeywordTokenType(387);}
"using" {return tt.getKeywordTokenType(388);}
"validate" {return tt.getKeywordTokenType(389);}
"values" {return tt.getKeywordTokenType(390);}
"variable" {return tt.getKeywordTokenType(391);}
"varray" {return tt.getKeywordTokenType(392);}
"varying" {return tt.getKeywordTokenType(393);}
"version" {return tt.getKeywordTokenType(394);}
"versions" {return tt.getKeywordTokenType(395);}
"view" {return tt.getKeywordTokenType(396);}
"wait" {return tt.getKeywordTokenType(397);}
"wellformed" {return tt.getKeywordTokenType(398);}
"when" {return tt.getKeywordTokenType(399);}
"whenever" {return tt.getKeywordTokenType(400);}
"where" {return tt.getKeywordTokenType(401);}
"while" {return tt.getKeywordTokenType(402);}
"with" {return tt.getKeywordTokenType(403);}
"within" {return tt.getKeywordTokenType(404);}
"wnds" {return tt.getKeywordTokenType(405);}
