...
"log" {return tt.getKeywordTokenType(199);}
"logoff" {return tt.getKeywordTokenType(200);}
"logon" {return tt.getKeywordTokenType(201);}
"loop" {return tt.getKeywordTokenType(202);}
"main" {return tt.getKeywordTokenType(203);}
"map" {return tt.getKeywordTokenType(204);}
"matched" {return tt.getKeywordTokenType(205);}
"maxlen" {return tt.getKeywordTokenType(206);}
"maxvalue" {return tt.getKeywordTokenType(207);}
"mean_squares_between" {return tt.getKeywordTokenType(208);}
"mean_squares_within" {return tt.getKeywordTokenType(209);}
"measures" {return tt.getKeywordTokenType(210);}
"member" {return tt.getKeywordTokenType(211);}
"merge" {return tt.getKeywordTokenType(212);}
"minus" {return tt.getKeywordTokenType(213);}
"minute" {return tt.getKeywordTokenType(214);}
"minvalue" {return tt.getKeywordTokenType(215);}
"mlslabel" {return tt.getKeywordTokenType(216);}
"mode" {return tt.getKeywordTokenType(217);}
"model" {return tt.getKeywordTokenType(218);}
"month" {return tt.getKeywordTokenType(219);}
"multiset" {return tt.getKeywordTokenType(220);}
"name" {return tt.getKeywordTokenType(221);}
"nan" {return tt.getKeywordTokenType(222);}
"natural" {return tt.getKeywordTokenType(223);}
"naturaln" {return tt.getKeywordTokenType(224);}
"nav" {return tt.getKeywordTokenType(225);}
"nchar_cs" {return tt.getKeywordTokenType(226);}
"nested" {return tt.getKeywordTokenType(227);}
"new" {return tt.getKeywordTokenType(228);}
"next" {return tt.getKeywordTokenType(229);}
"nextval" {return tt.getKeywordTokenType(230);}
"no" {return tt.getKeywordTokenType(231);}
"noaudit" {return tt.getKeywordTokenType(232);}
"nocopy" {return tt.getKeywordTokenType(233);}
"nocycle" {return tt.getKeywordTokenType(234);}
"noentityescaping" {return tt.getKeywordTokenType(235);}
"noneditionable" {return tt.getKeywordTokenType(236);}
"noschemacheck" {return tt.getKeywordTokenType(237);}
"not" {return tt.getKeywordTokenType(238);}
"notfound" {return tt.getKeywordTokenType(239);}
"nowait" {return tt.getKeywordTokenType(240);}
"null" {return tt.getKeywordTokenType(241);}
"nulls" {return tt.getKeywordTokenType(242);}
"number_base" {return tt.getKeywordTokenType(243);}
"object" {return tt.getKeywordTokenType(244);}
"ocirowid" {return tt.getKeywordTokenType(245);}
"of" {return tt.getKeywordTokenType(246);}
"offset" {return tt.getKeywordTokenType(247);}
"oid" {return tt.getKeywordTokenType(248);}
"old" {return tt.getKeywordTokenType(249);}
"on" {return tt.getKeywordTokenType(250);}
"one_sided_prob_or_less" {return tt.getKeywordTokenType(251);}
"one_sided_prob_or_more" {return tt.getKeywordTokenType(252);}
"one_sided_sig" {return tt.getKeywordTokenType(253);}
"only" {return tt.getKeywordTokenType(254);}
"opaque" {return tt.getKeywordTokenType(255);}
"open" {return tt.getKeywordTokenType(256);}
"operator" {return tt.getKeywordTokenType(257);}
"option" {return tt.getKeywordTokenType(258);}
"or" {return tt.getKeywordTokenType(259);}
"order" {return tt.getKeywordTokenType(260);}
"ordinality" {return tt.getKeywordTokenType(261);}
"organization" {return tt.getKeywordTokenType(262);}
"others" {return tt.getKeywordTokenType(263);}
"out" {return tt.getKeywordTokenType(264);}
"outer" {return tt.getKeywordTokenType(265);}
"over" {return tt.getKeywordTokenType(266);}
"overflow" {return tt.getKeywordTokenType(267);}
"overriding" {return tt.getKeywordTokenType(268);}
"package" {return tt.getKeywordTokenType(269);}
"parallel_enable" {return tt.getKeywordTokenType(270);}
"parameters" {return tt.getKeywordTokenType(271);}
"parent" {return tt.getKeywordTokenType(272);}
"partition" {return tt.getKeywordTokenType(273);}
"passing" {return tt.getKeywordTokenType(274);}
"path" {return tt.getKeywordTokenType(275);}
"pctfree" {return tt.getKeywordTokenType(276);}
"percent" {return tt.getKeywordTokenType(277);}
"phi_coefficient" {return tt.getKeywordTokenType(278);}
"pipe" {return tt.getKeywordTokenType(279);}
"pipelined" {return tt.getKeywordTokenType(280);}
"pivot" {return tt.getKeywordTokenType(281);}
"positive" {return tt.getKeywordTokenType(282);}
"positiven" {return tt.getKeywordTokenType(283);}
"power" {return tt.getKeywordTokenType(284);}
"pragma" {return tt.getKeywordTokenType(285);}
"preceding" {return tt.getKeywordTokenType(286);}
"present" {return tt.getKeywordTokenType(287);}
"pretty" {return tt.getKeywordTokenType(288);}
"prior" {return tt.getKeywordTokenType(289);}
"private" {return tt.getKeywordTokenType(290);}
"procedure" {return tt.getKeywordTokenType(291);}
"public" {return tt.getKeywordTokenType(292);}
"raise" {return tt.getKeywordTokenType(293);}
"range" {return tt.getKeywordTokenType(294);}
"read" {return tt.getKeywordTokenType(295);}
"record" {return tt.getKeywordTokenType(296);}
"ref" {return tt.getKeywordTokenType(297);}
"reference" {return tt.getKeywordTokenType(298);}
"referencing" {return tt.getKeywordTokenType(299);}
"regexp_like" {return tt.getKeywordTokenType(300);}
"reject" {return tt.getKeywordTokenType(301);}
"release" {return tt.getKeywordTokenType(302);}
"relies_on" {return tt.getKeywordTokenType(303);}
"remainder" {return tt.getKeywordTokenType(304);}
"rename" {return tt.getKeywordTokenType(305);}
"replace" {return tt.getKeywordTokenType(306);}
"restrict_references" {return tt.getKeywordTokenType(307);}
"result" {return tt.getKeywordTokenType(308);}
"result_cache" {return tt.getKeywordTokenType(309);}
"return" {return tt.getKeywordTokenType(310);}
"returning" {return tt.getKeywordTokenType(311);}
"reverse" {return tt.getKeywordTokenType(312);}
"revoke" {return tt.getKeywordTokenType(313);}
"right" {return tt.getKeywordTokenType(314);}
"rnds" {return tt.getKeywordTokenType(315);}
"rnps" {return tt.getKeywordTokenType(316);}
"rollback" {return tt.getKeywordTokenType(317);}
"rollup" {return tt.getKeywordTokenType(318);}
"row" {return tt.getKeywordTokenType(319);}
"rowcount" {return tt.getKeywordTokenType(320);}
"rownum" {return tt.getKeywordTokenType(321);}
"rows" {return tt.getKeywordTokenType(322);}
"rowtype" {return tt.getKeywordTokenType(323);}
"rules" {return tt.getKeywordTokenType(324);}
"sample" {return tt.getKeywordTokenType(325);}
"save" {return tt.getKeywordTokenType(326);}
"savepoint" {return tt.getKeywordTokenType(327);}
"schema" {return tt.getKeywordTokenType(328);}
"schemacheck" {return tt.getKeywordTokenType(329);}
"scn" {return tt.getKeywordTokenType(330);}
"second" {return tt.getKeywordTokenType(331);}
"seed" {return tt.getKeywordTokenType(332);}
"segment" {return tt.getKeywordTokenType(333);}
"select" {return tt.getKeywordTokenType(334);}
"self" {return tt.getKeywordTokenType(335);}
"separate" {return tt.getKeywordTokenType(336);}
"sequential" {return tt.getKeywordTokenType(337);}
"serializable" {return tt.getKeywordTokenType(338);}
"serially_reusable" {return tt.getKeywordTokenType(339);}
"servererror" {return tt.getKeywordTokenType(340);}
"set" {return tt.getKeywordTokenType(341);}
"sets" {return tt.getKeywordTokenType(342);}
"share" {return tt.getKeywordTokenType(343);}
"show" {return tt.getKeywordTokenType(344);}
"shutdown" {return tt.getKeywordTokenType(345);}
"siblings" {return tt.getKeywordTokenType(346);}
"sig" {return tt.getKeywordTokenType(347);}
"single" {return tt.getKeywordTokenType(348);}
"size" {return tt.getKeywordTokenType(349);}
"some" {return tt.getKeywordTokenType(350);}
"space" {return tt.getKeywordTokenType(351);}
"sql" {return tt.getKeywordTokenType(352);}
"sqlcode" {return tt.getKeywordTokenType(353);}
"sqlerrm" {return tt.getKeywordTokenType(354);}
"standalone" {return tt.getKeywordTokenType(355);}
"start" {return tt.getKeywordTokenType(356);}
"startup" {return tt.getKeywordTokenType(357);}
"statement" {return tt.getKeywordTokenType(358);}
"static" {return tt.getKeywordTokenType(359);}
"statistic" {return tt.getKeywordTokenType(360);}
"statistics" {return tt.getKeywordTokenType(361);}
"strict" {return tt.getKeywordTokenType(362);}
"struct" {return tt.getKeywordTokenType(363);}
"submultiset" {return tt.getKeywordTokenType(364);}
"subpartition" {return tt.getKeywordTokenType(365);}
"subtype" {return tt.getKeywordTokenType(366);}
"successful" {return tt.getKeywordTokenType(367);}
"sum_squares_between" {return tt.getKeywordTokenType(368);}
"sum_squares_within" {return tt.getKeywordTokenType(369);}
"suspend" {return tt.getKeywordTokenType(370);}
"synonym" {return tt.getKeywordTokenType(371);}
"table" {return tt.getKeywordTokenType(372);}
"tdo" {return tt.getKeywordTokenType(373);}
"then" {return tt.getKeywordTokenType(374);}
"ties" {return tt.getKeywordTokenType(375);}
"time" {return tt.getKeywordTokenType(376);}
"timezone_abbr" {return tt.getKeywordTokenType(377);}
"timezone_hour" {return tt.getKeywordTokenType(378);}
"timezone_minute" {return tt.getKeywordTokenType(379);}
"timezone_region" {return tt.getKeywordTokenType(380);}
"to" {return tt.getKeywordTokenType(381);}
"trailing" {return tt.getKeywordTokenType(382);}
"transaction" {return tt.getKeywordTokenType(383);}
"trigger" {return tt.getKeywordTokenType(384);}
"truncate" {return tt.getKeywordTokenType(385);}
"trust" {return tt.getKeywordTokenType(386);}
"two_sided_prob" {return tt.getKeywordTokenType(387);}
"two_sided_sig" {return tt.getKeywordTokenType(388);}
"type" {return tt.getKeywordTokenType(389);}
"u_statistic" {return tt.getKeywordTokenType(390);}
"unbounded" {return tt.getKeywordTokenType(391);}
"unconditional" {return tt.getKeywordTokenType(392);}
"under" {return tt.getKeywordTokenType(393);}
"under_path" {return tt.getKeywordTokenType(394);}
"union" {return tt.getKeywordTokenType(395);}
"unique" {return tt.getKeywordTokenType(396);}
"unlimited" {return tt.getKeywordTokenType(397);}
"unpivot" {return tt.getKeywordTokenType(398);}
"until" {return tt.getKeywordTokenType(399);}
"update" {return tt.getKeywordTokenType(400);}
"updated" {return tt.getKeywordTokenType(401);}
"updating" {return tt.getKeywordTokenType(402);}
"upsert" {return tt.getKeywordTokenType(403);}
"use" {return tt.getKeywordTokenType(404);}
"user" {return tt.getKeywordTokenType(405);}
"using" {return tt.getKeywordTokenType(406);}
"validate" {return tt.getKeywordTokenType(407);}
"value" {return tt.getKeywordTokenType(408);}
"values" {return tt.getKeywordTokenType(409);}
"variable" {return tt.getKeywordTokenType(410);}
"varray" {return tt.getKeywordTokenType(411);}
"varying" {return tt.getKeywordTokenType(412);}
"version" {return tt.getKeywordTokenType(413);}
"versions" {return tt.getKeywordTokenType(414);}
"view" {return tt.getKeywordTokenType(415);}
"wait" {return tt.getKeywordTokenType(416);}
"wellformed" {return tt.getKeywordTokenType(417);}
"when" {return tt.getKeywordTokenType(418);}
"whenever" {return tt.getKeywordTokenType(419);}
"where" {return tt.getKeywordTokenType(420);}
"while" {return tt.getKeywordTokenType(421);}
"with" {return tt.getKeywordTokenType(422);}
"within" {return tt.getKeywordTokenType(423);}
"without" {return tt.getKeywordTokenType(424);}
"wnds" {return tt.getKeywordTokenType(425);}
"wnps" {return tt.getKeywordTokenType(426);}
"work" {return tt.getKeywordTokenType(427);}
"write" {return tt.getKeywordTokenType(428);}
"wrapped" {return tt.getKeywordTokenType(429);}
"wrapper" {return tt.getKeywordTokenType(430);}
"xml" {return tt.getKeywordTokenType(431);}
"xmlnamespaces" {return tt.getKeywordTokenType(432);}
"year" {return tt.getKeywordTokenType(433);}
"yes" {return tt.getKeywordTokenType(434);}
"zone" {return tt.getKeywordTokenType(435);}
"false" {return tt.getKeywordTokenType(436);}
"true" {return tt.getKeywordTokenType(437);}
