...
"pipe" {return tt.getKeywordTokenType(262);}
"pipelined" {return tt.getKeywordTokenType(263);}
"pivot" {return tt.getKeywordTokenType(264);}
"positive" {return tt.getKeywordTokenType(265);}
"positiven" {return tt.getKeywordTokenType(266);}
"power" {return tt.getKeywordTokenType(267);}
"pragma" {return tt.getKeywordTokenType(268);}
"preceding" {return tt.getKeywordTokenType(269);}
"present" {return tt.getKeywordTokenType(270);}
"prior" {return tt.getKeywordTokenType(271);}
"private" {return tt.getKeywordTokenType(272);}
"procedure" {return tt.getKeywordTokenType(273);}
"public" {return tt.getKeywordTokenType(274);}
"raise" {return tt.getKeywordTokenType(275);}
"range" {return tt.getKeywordTokenType(276);}
"read" {return tt.getKeywordTokenType(277);}
"record" {return tt.getKeywordTokenType(278);}
"ref" {return tt.getKeywordTokenType(279);}
"reference" {return tt.getKeywordTokenType(280);}
"referencing" {return tt.getKeywordTokenType(281);}
"regexp_like" {return tt.getKeywordTokenType(282);}
"reject" {return tt.getKeywordTokenType(283);}
"release" {return tt.getKeywordTokenType(284);}
"relies_on" {return tt.getKeywordTokenType(285);}
"remainder" {return tt.getKeywordTokenType(286);}
"rename" {return tt.getKeywordTokenType(287);}
"replace" {return tt.getKeywordTokenType(288);}
"restrict_references" {return tt.getKeywordTokenType(289);}
"result" {return tt.getKeywordTokenType(290);}
"result_cache" {return tt.getKeywordTokenType(291);}
"return" {return tt.getKeywordTokenType(292);}
"returning" {return tt.getKeywordTokenType(293);}
"reverse" {return tt.getKeywordTokenType(294);}
"revoke" {return tt.getKeywordTokenType(295);}
"right" {return tt.getKeywordTokenType(296);}
"rnds" {return tt.getKeywordTokenType(297);}
"rnps" {return tt.getKeywordTokenType(298);}
"rollback" {return tt.getKeywordTokenType(299);}
"rollup" {return tt.getKeywordTokenType(300);}
"row" {return tt.getKeywordTokenType(301);}
"rowcount" {return tt.getKeywordTokenType(302);}
"rownum" {return tt.getKeywordTokenType(303);}
"rows" {return tt.getKeywordTokenType(304);}
"rowtype" {return tt.getKeywordTokenType(305);}
"rules" {return tt.getKeywordTokenType(306);}
"sample" {return tt.getKeywordTokenType(307);}
"save" {return tt.getKeywordTokenType(308);}
"savepoint" {return tt.getKeywordTokenType(309);}
"schema" {return tt.getKeywordTokenType(310);}
"schemacheck" {return tt.getKeywordTokenType(311);}
"scn" {return tt.getKeywordTokenType(312);}
"second" {return tt.getKeywordTokenType(313);}
"seed" {return tt.getKeywordTokenType(314);}
"segment" {return tt.getKeywordTokenType(315);}
"select" {return tt.getKeywordTokenType(316);}
"self" {return tt.getKeywordTokenType(317);}
"separate" {return tt.getKeywordTokenType(318);}
"sequential" {return tt.getKeywordTokenType(319);}
"serializable" {return tt.getKeywordTokenType(320);}
"serially_reusable" {return tt.getKeywordTokenType(321);}
"servererror" {return tt.getKeywordTokenType(322);}
"set" {return tt.getKeywordTokenType(323);}
"sets" {return tt.getKeywordTokenType(324);}
"share" {return tt.getKeywordTokenType(325);}
"show" {return tt.getKeywordTokenType(326);}
"shutdown" {return tt.getKeywordTokenType(327);}
"siblings" {return tt.getKeywordTokenType(328);}
"sig" {return tt.getKeywordTokenType(329);}
"single" {return tt.getKeywordTokenType(330);}
"size" {return tt.getKeywordTokenType(331);}
"some" {return tt.getKeywordTokenType(332);}
"space" {return tt.getKeywordTokenType(333);}
"sql" {return tt.getKeywordTokenType(334);}
"sqlcode" {return tt.getKeywordTokenType(335);}
"sqlerrm" {return tt.getKeywordTokenType(336);}
"standalone" {return tt.getKeywordTokenType(337);}
"start" {return tt.getKeywordTokenType(338);}
"startup" {return tt.getKeywordTokenType(339);}
"statement" {return tt.getKeywordTokenType(340);}
"static" {return tt.getKeywordTokenType(341);}
"statistic" {return tt.getKeywordTokenType(342);}
"statistics" {return tt.getKeywordTokenType(343);}
"struct" {return tt.getKeywordTokenType(344);}
"submultiset" {return tt.getKeywordTokenType(345);}
"subpartition" {return tt.getKeywordTokenType(346);}
"subtype" {return tt.getKeywordTokenType(347);}
"successful" {return tt.getKeywordTokenType(348);}
"sum_squares_between" {return tt.getKeywordTokenType(349);}
"sum_squares_within" {return tt.getKeywordTokenType(350);}
"suspend" {return tt.getKeywordTokenType(351);}
"synonym" {return tt.getKeywordTokenType(352);}
"table" {return tt.getKeywordTokenType(353);}
"tdo" {return tt.getKeywordTokenType(354);}
"then" {return tt.getKeywordTokenType(355);}
"time" {return tt.getKeywordTokenType(356);}
"timezone_abbr" {return tt.getKeywordTokenType(357);}
"timezone_hour" {return tt.getKeywordTokenType(358);}
"timezone_minute" {return tt.getKeywordTokenType(359);}
"timezone_region" {return tt.getKeywordTokenType(360);}
"to" {return tt.getKeywordTokenType(361);}
"trailing" {return tt.getKeywordTokenType(362);}
"transaction" {return tt.getKeywordTokenType(363);}
"trigger" {return tt.getKeywordTokenType(364);}
"truncate" {return tt.getKeywordTokenType(365);}
"trust" {return tt.getKeywordTokenType(366);}
"two_sided_prob" {return tt.getKeywordTokenType(367);}
"two_sided_sig" {return tt.getKeywordTokenType(368);}
"type" {return tt.getKeywordTokenType(369);}
"u_statistic" {return tt.getKeywordTokenType(370);}
"unbounded" {return tt.getKeywordTokenType(371);}
"under" {return tt.getKeywordTokenType(372);}
"under_path" {return tt.getKeywordTokenType(373);}
"union" {return tt.getKeywordTokenType(374);}
"unique" {return tt.getKeywordTokenType(375);}
"unlimited" {return tt.getKeywordTokenType(376);}
"unpivot" {return tt.getKeywordTokenType(377);}
"until" {return tt.getKeywordTokenType(378);}
"update" {return tt.getKeywordTokenType(379);}
"updated" {return tt.getKeywordTokenType(380);}
"updating" {return tt.getKeywordTokenType(381);}
"upsert" {return tt.getKeywordTokenType(382);}
"use" {return tt.getKeywordTokenType(383);}
"user" {return tt.getKeywordTokenType(384);}
"using" {return tt.getKeywordTokenType(385);}
"validate" {return tt.getKeywordTokenType(386);}
"values" {return tt.getKeywordTokenType(387);}
"variable" {return tt.getKeywordTokenType(388);}
"varray" {return tt.getKeywordTokenType(389);}
"varying" {return tt.getKeywordTokenType(390);}
"version" {return tt.getKeywordTokenType(391);}
"versions" {return tt.getKeywordTokenType(392);}
"view" {return tt.getKeywordTokenType(393);}
"wait" {return tt.getKeywordTokenType(394);}
"wellformed" {return tt.getKeywordTokenType(395);}
"when" {return tt.getKeywordTokenType(396);}
"whenever" {return tt.getKeywordTokenType(397);}
"where" {return tt.getKeywordTokenType(398);}
"while" {return tt.getKeywordTokenType(399);}
"with" {return tt.getKeywordTokenType(400);}
"within" {return tt.getKeywordTokenType(401);}
"wnds" {return tt.getKeywordTokenType(402);}
"wnps" {return tt.getKeywordTokenType(403);}
"work" {return tt.getKeywordTokenType(404);}
"write" {return tt.getKeywordTokenType(405);}
"xml" {return tt.getKeywordTokenType(406);}
"xmlnamespaces" {return tt.getKeywordTokenType(407);}
"year" {return tt.getKeywordTokenType(408);}
"yes" {return tt.getKeywordTokenType(409);}
"zone" {return tt.getKeywordTokenType(410);}
"false" {return tt.getKeywordTokenType(411);}
"true" {return tt.getKeywordTokenType(412);}
