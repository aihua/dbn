...
public class FilterConditionJoinTypeSwitchAction extends AbstractObjectFilterAction {

    public FilterConditionJoinTypeSwitchAction(ObjectNameFilterSettingsForm settingsForm) {
