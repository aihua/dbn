...
"json_object" {return tt.getFunctionTokenType(66);}
"json_table" {return tt.getFunctionTokenType(67);}
...
"lateral" {return tt.getFunctionTokenType(71);}
...
"uid" {return tt.getFunctionTokenType(202);}
