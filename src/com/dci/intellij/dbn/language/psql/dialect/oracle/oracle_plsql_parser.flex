...
"overflow" {return tt.getKeywordTokenType(259);}
"overriding" {return tt.getKeywordTokenType(260);}
"package" {return tt.getKeywordTokenType(261);}
"parallel_enable" {return tt.getKeywordTokenType(262);}
"parameters" {return tt.getKeywordTokenType(263);}
"parent" {return tt.getKeywordTokenType(264);}
"partition" {return tt.getKeywordTokenType(265);}
"passing" {return tt.getKeywordTokenType(266);}
"path" {return tt.getKeywordTokenType(267);}
"pctfree" {return tt.getKeywordTokenType(268);}
"percent" {return tt.getKeywordTokenType(269);}
"phi_coefficient" {return tt.getKeywordTokenType(270);}
"pipe" {return tt.getKeywordTokenType(271);}
"pipelined" {return tt.getKeywordTokenType(272);}
"pivot" {return tt.getKeywordTokenType(273);}
"positive" {return tt.getKeywordTokenType(274);}
"positiven" {return tt.getKeywordTokenType(275);}
"power" {return tt.getKeywordTokenType(276);}
"pragma" {return tt.getKeywordTokenType(277);}
"preceding" {return tt.getKeywordTokenType(278);}
"present" {return tt.getKeywordTokenType(279);}
"prior" {return tt.getKeywordTokenType(280);}
"private" {return tt.getKeywordTokenType(281);}
"procedure" {return tt.getKeywordTokenType(282);}
"public" {return tt.getKeywordTokenType(283);}
"raise" {return tt.getKeywordTokenType(284);}
"range" {return tt.getKeywordTokenType(285);}
"read" {return tt.getKeywordTokenType(286);}
"record" {return tt.getKeywordTokenType(287);}
"ref" {return tt.getKeywordTokenType(288);}
"reference" {return tt.getKeywordTokenType(289);}
"referencing" {return tt.getKeywordTokenType(290);}
"regexp_like" {return tt.getKeywordTokenType(291);}
"reject" {return tt.getKeywordTokenType(292);}
"release" {return tt.getKeywordTokenType(293);}
"relies_on" {return tt.getKeywordTokenType(294);}
"remainder" {return tt.getKeywordTokenType(295);}
"rename" {return tt.getKeywordTokenType(296);}
"replace" {return tt.getKeywordTokenType(297);}
"restrict_references" {return tt.getKeywordTokenType(298);}
"result" {return tt.getKeywordTokenType(299);}
"result_cache" {return tt.getKeywordTokenType(300);}
"return" {return tt.getKeywordTokenType(301);}
"returning" {return tt.getKeywordTokenType(302);}
"reverse" {return tt.getKeywordTokenType(303);}
"revoke" {return tt.getKeywordTokenType(304);}
"right" {return tt.getKeywordTokenType(305);}
"rnds" {return tt.getKeywordTokenType(306);}
"rnps" {return tt.getKeywordTokenType(307);}
"rollback" {return tt.getKeywordTokenType(308);}
"rollup" {return tt.getKeywordTokenType(309);}
"row" {return tt.getKeywordTokenType(310);}
"rowcount" {return tt.getKeywordTokenType(311);}
"rownum" {return tt.getKeywordTokenType(312);}
"rows" {return tt.getKeywordTokenType(313);}
"rowtype" {return tt.getKeywordTokenType(314);}
"rules" {return tt.getKeywordTokenType(315);}
"sample" {return tt.getKeywordTokenType(316);}
"save" {return tt.getKeywordTokenType(317);}
"savepoint" {return tt.getKeywordTokenType(318);}
"schema" {return tt.getKeywordTokenType(319);}
"schemacheck" {return tt.getKeywordTokenType(320);}
"scn" {return tt.getKeywordTokenType(321);}
"second" {return tt.getKeywordTokenType(322);}
"seed" {return tt.getKeywordTokenType(323);}
"segment" {return tt.getKeywordTokenType(324);}
"select" {return tt.getKeywordTokenType(325);}
"self" {return tt.getKeywordTokenType(326);}
"separate" {return tt.getKeywordTokenType(327);}
"sequential" {return tt.getKeywordTokenType(328);}
"serializable" {return tt.getKeywordTokenType(329);}
"serially_reusable" {return tt.getKeywordTokenType(330);}
"servererror" {return tt.getKeywordTokenType(331);}
"set" {return tt.getKeywordTokenType(332);}
"sets" {return tt.getKeywordTokenType(333);}
"share" {return tt.getKeywordTokenType(334);}
"show" {return tt.getKeywordTokenType(335);}
"shutdown" {return tt.getKeywordTokenType(336);}
"siblings" {return tt.getKeywordTokenType(337);}
"sig" {return tt.getKeywordTokenType(338);}
"single" {return tt.getKeywordTokenType(339);}
"size" {return tt.getKeywordTokenType(340);}
"some" {return tt.getKeywordTokenType(341);}
"space" {return tt.getKeywordTokenType(342);}
"sql" {return tt.getKeywordTokenType(343);}
"sqlcode" {return tt.getKeywordTokenType(344);}
"sqlerrm" {return tt.getKeywordTokenType(345);}
"standalone" {return tt.getKeywordTokenType(346);}
"start" {return tt.getKeywordTokenType(347);}
"startup" {return tt.getKeywordTokenType(348);}
"statement" {return tt.getKeywordTokenType(349);}
"static" {return tt.getKeywordTokenType(350);}
"statistic" {return tt.getKeywordTokenType(351);}
"statistics" {return tt.getKeywordTokenType(352);}
"struct" {return tt.getKeywordTokenType(353);}
"submultiset" {return tt.getKeywordTokenType(354);}
"subpartition" {return tt.getKeywordTokenType(355);}
"subtype" {return tt.getKeywordTokenType(356);}
"successful" {return tt.getKeywordTokenType(357);}
"sum_squares_between" {return tt.getKeywordTokenType(358);}
"sum_squares_within" {return tt.getKeywordTokenType(359);}
"suspend" {return tt.getKeywordTokenType(360);}
"synonym" {return tt.getKeywordTokenType(361);}
"table" {return tt.getKeywordTokenType(362);}
"tdo" {return tt.getKeywordTokenType(363);}
"then" {return tt.getKeywordTokenType(364);}
"ties" {return tt.getKeywordTokenType(365);}
"time" {return tt.getKeywordTokenType(366);}
"timezone_abbr" {return tt.getKeywordTokenType(367);}
"timezone_hour" {return tt.getKeywordTokenType(368);}
"timezone_minute" {return tt.getKeywordTokenType(369);}
"timezone_region" {return tt.getKeywordTokenType(370);}
"to" {return tt.getKeywordTokenType(371);}
"trailing" {return tt.getKeywordTokenType(372);}
"transaction" {return tt.getKeywordTokenType(373);}
"trigger" {return tt.getKeywordTokenType(374);}
"truncate" {return tt.getKeywordTokenType(375);}
"trust" {return tt.getKeywordTokenType(376);}
"two_sided_prob" {return tt.getKeywordTokenType(377);}
"two_sided_sig" {return tt.getKeywordTokenType(378);}
"type" {return tt.getKeywordTokenType(379);}
"u_statistic" {return tt.getKeywordTokenType(380);}
"unbounded" {return tt.getKeywordTokenType(381);}
"unconditional" {return tt.getKeywordTokenType(382);}
"under" {return tt.getKeywordTokenType(383);}
"under_path" {return tt.getKeywordTokenType(384);}
"union" {return tt.getKeywordTokenType(385);}
"unique" {return tt.getKeywordTokenType(386);}
"unlimited" {return tt.getKeywordTokenType(387);}
"unpivot" {return tt.getKeywordTokenType(388);}
"until" {return tt.getKeywordTokenType(389);}
"update" {return tt.getKeywordTokenType(390);}
"updated" {return tt.getKeywordTokenType(391);}
"updating" {return tt.getKeywordTokenType(392);}
"upsert" {return tt.getKeywordTokenType(393);}
"use" {return tt.getKeywordTokenType(394);}
"user" {return tt.getKeywordTokenType(395);}
"using" {return tt.getKeywordTokenType(396);}
"validate" {return tt.getKeywordTokenType(397);}
"value" {return tt.getKeywordTokenType(398);}
"values" {return tt.getKeywordTokenType(399);}
"variable" {return tt.getKeywordTokenType(400);}
"varray" {return tt.getKeywordTokenType(401);}
"varying" {return tt.getKeywordTokenType(402);}
"version" {return tt.getKeywordTokenType(403);}
"versions" {return tt.getKeywordTokenType(404);}
"view" {return tt.getKeywordTokenType(405);}
"wait" {return tt.getKeywordTokenType(406);}
"wellformed" {return tt.getKeywordTokenType(407);}
"when" {return tt.getKeywordTokenType(408);}
"whenever" {return tt.getKeywordTokenType(409);}
"where" {return tt.getKeywordTokenType(410);}
"while" {return tt.getKeywordTokenType(411);}
"with" {return tt.getKeywordTokenType(412);}
"within" {return tt.getKeywordTokenType(413);}
"without" {return tt.getKeywordTokenType(414);}
"wnds" {return tt.getKeywordTokenType(415);}
"wnps" {return tt.getKeywordTokenType(416);}
"work" {return tt.getKeywordTokenType(417);}
"write" {return tt.getKeywordTokenType(418);}
"wrapped" {return tt.getKeywordTokenType(419);}
"wrapper" {return tt.getKeywordTokenType(420);}
"xml" {return tt.getKeywordTokenType(421);}
"xmlnamespaces" {return tt.getKeywordTokenType(422);}
"year" {return tt.getKeywordTokenType(423);}
"yes" {return tt.getKeywordTokenType(424);}
"zone" {return tt.getKeywordTokenType(425);}
"false" {return tt.getKeywordTokenType(426);}
"true" {return tt.getKeywordTokenType(427);}
