...
<YYINITIAL> {
    ...
    "json_table" {return tt.getFunctionTokenType(68);}
    "lag" {return tt.getFunctionTokenType(69);}
    "last_day" {return tt.getFunctionTokenType(70);}
    "last_value" {return tt.getFunctionTokenType(71);}
    "lead" {return tt.getFunctionTokenType(72);}
    "least" {return tt.getFunctionTokenType(73);}
    "length" {return tt.getFunctionTokenType(74);}
    "length2" {return tt.getFunctionTokenType(75);}
    "length4" {return tt.getFunctionTokenType(76);}
    "lengthb" {return tt.getFunctionTokenType(77);}
    "lengthc" {return tt.getFunctionTokenType(78);}
    "listagg" {return tt.getFunctionTokenType(79);}
    "ln" {return tt.getFunctionTokenType(80);}
    "lnnvl" {return tt.getFunctionTokenType(81);}
    "localtimestamp" {return tt.getFunctionTokenType(82);}
    "lower" {return tt.getFunctionTokenType(83);}
    "lpad" {return tt.getFunctionTokenType(84);}
    "ltrim" {return tt.getFunctionTokenType(85);}
    "make_ref" {return tt.getFunctionTokenType(86);}
    "max" {return tt.getFunctionTokenType(87);}
    "median" {return tt.getFunctionTokenType(88);}
    "min" {return tt.getFunctionTokenType(89);}
    "mod" {return tt.getFunctionTokenType(90);}
    "months_between" {return tt.getFunctionTokenType(91);}
    "nanvl" {return tt.getFunctionTokenType(92);}
    "nchr" {return tt.getFunctionTokenType(93);}
    "new_time" {return tt.getFunctionTokenType(94);}
    "next_day" {return tt.getFunctionTokenType(95);}
    "nls_charset_decl_len" {return tt.getFunctionTokenType(96);}
    "nls_charset_id" {return tt.getFunctionTokenType(97);}
    "nls_charset_name" {return tt.getFunctionTokenType(98);}
    "nls_initcap" {return tt.getFunctionTokenType(99);}
    "nls_lower" {return tt.getFunctionTokenType(100);}
    "nls_upper" {return tt.getFunctionTokenType(101);}
    "nlssort" {return tt.getFunctionTokenType(102);}
    "ntile" {return tt.getFunctionTokenType(103);}
    "nullif" {return tt.getFunctionTokenType(104);}
    "numtodsinterval" {return tt.getFunctionTokenType(105);}
    "numtoyminterval" {return tt.getFunctionTokenType(106);}
    "nvl" {return tt.getFunctionTokenType(107);}
    "nvl2" {return tt.getFunctionTokenType(108);}
    "ora_hash" {return tt.getFunctionTokenType(109);}
    "percent_rank" {return tt.getFunctionTokenType(110);}
    "percentile_cont" {return tt.getFunctionTokenType(111);}
    "percentile_disc" {return tt.getFunctionTokenType(112);}
    "powermultiset" {return tt.getFunctionTokenType(113);}
    "powermultiset_by_cardinality" {return tt.getFunctionTokenType(114);}
    "presentnnv" {return tt.getFunctionTokenType(115);}
    "presentv" {return tt.getFunctionTokenType(116);}
    "previous" {return tt.getFunctionTokenType(117);}
    "rank" {return tt.getFunctionTokenType(118);}
    "ratio_to_report" {return tt.getFunctionTokenType(119);}
    "rawtohex" {return tt.getFunctionTokenType(120);}
    "rawtonhex" {return tt.getFunctionTokenType(121);}
    "reftohex" {return tt.getFunctionTokenType(122);}
    "regexp_instr" {return tt.getFunctionTokenType(123);}
    "regexp_replace" {return tt.getFunctionTokenType(124);}
    "regexp_substr" {return tt.getFunctionTokenType(125);}
    "regr_avgx" {return tt.getFunctionTokenType(126);}
    "regr_avgy" {return tt.getFunctionTokenType(127);}
    "regr_count" {return tt.getFunctionTokenType(128);}
    "regr_intercept" {return tt.getFunctionTokenType(129);}
    "regr_r2" {return tt.getFunctionTokenType(130);}
    "regr_slope" {return tt.getFunctionTokenType(131);}
    "regr_sxx" {return tt.getFunctionTokenType(132);}
    "regr_sxy" {return tt.getFunctionTokenType(133);}
    "regr_syy" {return tt.getFunctionTokenType(134);}
    ...
    "sinh" {return tt.getFunctionTokenType(145);}
    "soundex" {return tt.getFunctionTokenType(146);}
    "sqrt" {return tt.getFunctionTokenType(147);}
    "stats_binomial_test" {return tt.getFunctionTokenType(148);}
    "stats_crosstab" {return tt.getFunctionTokenType(149);}
    "stats_f_test" {return tt.getFunctionTokenType(150);}
    "stats_ks_test" {return tt.getFunctionTokenType(151);}
    "stats_mode" {return tt.getFunctionTokenType(152);}
    "stats_mw_test" {return tt.getFunctionTokenType(153);}
    "stats_one_way_anova" {return tt.getFunctionTokenType(154);}
    "stats_t_test_indep" {return tt.getFunctionTokenType(155);}
    "stats_t_test_indepu" {return tt.getFunctionTokenType(156);}
    "stats_t_test_one" {return tt.getFunctionTokenType(157);}
    "stats_t_test_paired" {return tt.getFunctionTokenType(158);}
    "stats_wsr_test" {return tt.getFunctionTokenType(159);}
    "stddev" {return tt.getFunctionTokenType(160);}
    "stddev_pop" {return tt.getFunctionTokenType(161);}
    "stddev_samp" {return tt.getFunctionTokenType(162);}
    "substr" {return tt.getFunctionTokenType(163);}
    "substr2" {return tt.getFunctionTokenType(164);}
    "substr4" {return tt.getFunctionTokenType(165);}
    "substrb" {return tt.getFunctionTokenType(166);}
    "substrc" {return tt.getFunctionTokenType(167);}
    "sum" {return tt.getFunctionTokenType(168);}
    "sys_connect_by_path" {return tt.getFunctionTokenType(169);}
    "sys_context" {return tt.getFunctionTokenType(170);}
    "sys_dburigen" {return tt.getFunctionTokenType(171);}
    "sys_extract_utc" {return tt.getFunctionTokenType(172);}
    "sys_guid" {return tt.getFunctionTokenType(173);}
    "sys_typeid" {return tt.getFunctionTokenType(174);}
    "sys_xmlagg" {return tt.getFunctionTokenType(175);}
    "sys_xmlgen" {return tt.getFunctionTokenType(176);}
    "sysdate" {return tt.getFunctionTokenType(177);}
    "systimestamp" {return tt.getFunctionTokenType(178);}
    "tan" {return tt.getFunctionTokenType(179);}
    "tanh" {return tt.getFunctionTokenType(180);}
    "timestamp_to_scn" {return tt.getFunctionTokenType(181);}
    "to_binary_double" {return tt.getFunctionTokenType(182);}
    "to_binary_float" {return tt.getFunctionTokenType(183);}
    "to_char" {return tt.getFunctionTokenType(184);}
    "to_clob" {return tt.getFunctionTokenType(185);}
    "to_date" {return tt.getFunctionTokenType(186);}
    "to_dsinterval" {return tt.getFunctionTokenType(187);}
    "to_lob" {return tt.getFunctionTokenType(188);}
    "to_multi_byte" {return tt.getFunctionTokenType(189);}
    "to_nchar" {return tt.getFunctionTokenType(190);}
    "to_nclob" {return tt.getFunctionTokenType(191);}
    "to_number" {return tt.getFunctionTokenType(192);}
    "to_single_byte" {return tt.getFunctionTokenType(193);}
    "to_timestamp" {return tt.getFunctionTokenType(194);}
    "to_timestamp_tz" {return tt.getFunctionTokenType(195);}
    "to_yminterval" {return tt.getFunctionTokenType(196);}
    "translate" {return tt.getFunctionTokenType(197);}
    "treat" {return tt.getFunctionTokenType(198);}
    "trim" {return tt.getFunctionTokenType(199);}
    "trunc" {return tt.getFunctionTokenType(200);}
    "tz_offset" {return tt.getFunctionTokenType(201);}
    ...
    "value" {return tt.getFunctionTokenType(206);}
    "var_pop" {return tt.getFunctionTokenType(207);}
    "var_samp" {return tt.getFunctionTokenType(208);}
    "variance" {return tt.getFunctionTokenType(209);}
    "vsize" {return tt.getFunctionTokenType(210);}
    "width_bucket" {return tt.getFunctionTokenType(211);}
    "xmlagg" {return tt.getFunctionTokenType(212);}
    "xmlattributes" {return tt.getFunctionTokenType(213);}
    "xmlcast" {return tt.getFunctionTokenType(214);}
    "xmlcdata" {return tt.getFunctionTokenType(215);}
    "xmlcolattval" {return tt.getFunctionTokenType(216);}
    "xmlcomment" {return tt.getFunctionTokenType(217);}
    "xmlconcat" {return tt.getFunctionTokenType(218);}
    "xmldiff" {return tt.getFunctionTokenType(219);}
    "xmlelement" {return tt.getFunctionTokenType(220);}
    "xmlforest" {return tt.getFunctionTokenType(221);}
    "xmlisvalid" {return tt.getFunctionTokenType(222);}
    "xmlparse" {return tt.getFunctionTokenType(223);}
    "xmlpatch" {return tt.getFunctionTokenType(224);}
    "xmlpi" {return tt.getFunctionTokenType(225);}
    "xmlquery" {return tt.getFunctionTokenType(226);}
    "xmlroot" {return tt.getFunctionTokenType(227);}
    "xmlsequence" {return tt.getFunctionTokenType(228);}
    "xmlserialize" {return tt.getFunctionTokenType(229);}
    "xmltable" {return tt.getFunctionTokenType(230);}
    "xmltransform" {return tt.getFunctionTokenType(231);}
