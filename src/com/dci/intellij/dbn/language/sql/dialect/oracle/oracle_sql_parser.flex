...
<YYINITIAL> {
    ...
    "lateral" {return tt.getFunctionTokenType(72);}
    "lead" {return tt.getFunctionTokenType(73);}
    "least" {return tt.getFunctionTokenType(74);}
    "length" {return tt.getFunctionTokenType(75);}
    "length2" {return tt.getFunctionTokenType(76);}
    "length4" {return tt.getFunctionTokenType(77);}
    "lengthb" {return tt.getFunctionTokenType(78);}
    "lengthc" {return tt.getFunctionTokenType(79);}
    "listagg" {return tt.getFunctionTokenType(80);}
    "ln" {return tt.getFunctionTokenType(81);}
    "lnnvl" {return tt.getFunctionTokenType(82);}
    "localtimestamp" {return tt.getFunctionTokenType(83);}
    "lower" {return tt.getFunctionTokenType(84);}
    "lpad" {return tt.getFunctionTokenType(85);}
    "ltrim" {return tt.getFunctionTokenType(86);}
    "make_ref" {return tt.getFunctionTokenType(87);}
    "max" {return tt.getFunctionTokenType(88);}
    "median" {return tt.getFunctionTokenType(89);}
    "min" {return tt.getFunctionTokenType(90);}
    "mod" {return tt.getFunctionTokenType(91);}
    "months_between" {return tt.getFunctionTokenType(92);}
    "nanvl" {return tt.getFunctionTokenType(93);}
    "nchr" {return tt.getFunctionTokenType(94);}
    "new_time" {return tt.getFunctionTokenType(95);}
    "next_day" {return tt.getFunctionTokenType(96);}
    "nls_charset_decl_len" {return tt.getFunctionTokenType(97);}
    "nls_charset_id" {return tt.getFunctionTokenType(98);}
    "nls_charset_name" {return tt.getFunctionTokenType(99);}
    "nls_initcap" {return tt.getFunctionTokenType(100);}
    "nls_lower" {return tt.getFunctionTokenType(101);}
    "nls_upper" {return tt.getFunctionTokenType(102);}
    "nlssort" {return tt.getFunctionTokenType(103);}
    "ntile" {return tt.getFunctionTokenType(104);}
    "nullif" {return tt.getFunctionTokenType(105);}
    "numtodsinterval" {return tt.getFunctionTokenType(106);}
    "numtoyminterval" {return tt.getFunctionTokenType(107);}
    "nvl" {return tt.getFunctionTokenType(108);}
    "nvl2" {return tt.getFunctionTokenType(109);}
    "ora_hash" {return tt.getFunctionTokenType(110);}
    "percent_rank" {return tt.getFunctionTokenType(111);}
    "percentile_cont" {return tt.getFunctionTokenType(112);}
    "percentile_disc" {return tt.getFunctionTokenType(113);}
    "powermultiset" {return tt.getFunctionTokenType(114);}
    "powermultiset_by_cardinality" {return tt.getFunctionTokenType(115);}
    "presentnnv" {return tt.getFunctionTokenType(116);}
    "presentv" {return tt.getFunctionTokenType(117);}
    "previous" {return tt.getFunctionTokenType(118);}
    "rank" {return tt.getFunctionTokenType(119);}
    "ratio_to_report" {return tt.getFunctionTokenType(120);}
    "rawtohex" {return tt.getFunctionTokenType(121);}
    "rawtonhex" {return tt.getFunctionTokenType(122);}
    "reftohex" {return tt.getFunctionTokenType(123);}
    "regexp_instr" {return tt.getFunctionTokenType(124);}
    "regexp_replace" {return tt.getFunctionTokenType(125);}
    "regexp_substr" {return tt.getFunctionTokenType(126);}
    "regr_avgx" {return tt.getFunctionTokenType(127);}
    "regr_avgy" {return tt.getFunctionTokenType(128);}
    "regr_count" {return tt.getFunctionTokenType(129);}
    "regr_intercept" {return tt.getFunctionTokenType(130);}
    "regr_r2" {return tt.getFunctionTokenType(131);}
    "regr_slope" {return tt.getFunctionTokenType(132);}
    "regr_sxx" {return tt.getFunctionTokenType(133);}
    "regr_sxy" {return tt.getFunctionTokenType(134);}
    "regr_syy" {return tt.getFunctionTokenType(135);}
    "round" {return tt.getFunctionTokenType(136);}
    "row_number" {return tt.getFunctionTokenType(137);}
    "rowidtochar" {return tt.getFunctionTokenType(138);}
    "rowidtonchar" {return tt.getFunctionTokenType(139);}
    "rpad" {return tt.getFunctionTokenType(140);}
    "rtrim" {return tt.getFunctionTokenType(141);}
    "scn_to_timestamp" {return tt.getFunctionTokenType(142);}
    "sessiontimezone" {return tt.getFunctionTokenType(143);}
    ...
    "unistr" {return tt.getFunctionTokenType(203);}
    "updatexml" {return tt.getFunctionTokenType(204);}
    "upper" {return tt.getFunctionTokenType(205);}
    "userenv" {return tt.getFunctionTokenType(206);}
    "value" {return tt.getFunctionTokenType(207);}
    "var_pop" {return tt.getFunctionTokenType(208);}
    "var_samp" {return tt.getFunctionTokenType(209);}
    "variance" {return tt.getFunctionTokenType(210);}
    "vsize" {return tt.getFunctionTokenType(211);}
    "width_bucket" {return tt.getFunctionTokenType(212);}
    "xmlagg" {return tt.getFunctionTokenType(213);}
    "xmlattributes" {return tt.getFunctionTokenType(214);}
    "xmlcast" {return tt.getFunctionTokenType(215);}
    "xmlcdata" {return tt.getFunctionTokenType(216);}
    "xmlcolattval" {return tt.getFunctionTokenType(217);}
    "xmlcomment" {return tt.getFunctionTokenType(218);}
    "xmlconcat" {return tt.getFunctionTokenType(219);}
    "xmldiff" {return tt.getFunctionTokenType(220);}
    "xmlelement" {return tt.getFunctionTokenType(221);}
    "xmlforest" {return tt.getFunctionTokenType(222);}
    "xmlisvalid" {return tt.getFunctionTokenType(223);}
    "xmlparse" {return tt.getFunctionTokenType(224);}
    "xmlpatch" {return tt.getFunctionTokenType(225);}
    "xmlpi" {return tt.getFunctionTokenType(226);}
    "xmlquery" {return tt.getFunctionTokenType(227);}
    "xmlroot" {return tt.getFunctionTokenType(228);}
    "xmlsequence" {return tt.getFunctionTokenType(229);}
    "xmlserialize" {return tt.getFunctionTokenType(230);}
    "xmltable" {return tt.getFunctionTokenType(231);}
    "xmltransform" {return tt.getFunctionTokenType(232);}
