...
public enum DatabaseUrlPattern {
    ...
    REDSHIFT       ("jdbc:redshift://<HOST>:<PORT>/<DATABASE>",           "^(jdbc:redshift:\\/\\/)(?<HOST>[._\\-a-z0-9]{1,1000})(?<PORT>:[0-9]{1,100})?(?<DATABASE>\\/[\\-$_a-z0-9]{0,1000})?$",                 DatabaseInfo.Default.POSTGRES, DatabaseUrlType.DATABASE),
    SQLITE         ("jdbc:sqlite:<FILE>",                                 "^(jdbc:sqlite:)(?<FILE>([a-zA-Z]:)?((\\\\|\\/)[a-zA-Z0-9\\s\\/_\\.-]{1,2000}){1,2000})$",                                             DatabaseInfo.Default.SQLITE,   DatabaseUrlType.FILE),
