...
"pretty" {return tt.getKeywordTokenType(286);}
"prior" {return tt.getKeywordTokenType(287);}
"private" {return tt.getKeywordTokenType(288);}
"procedure" {return tt.getKeywordTokenType(289);}
"public" {return tt.getKeywordTokenType(290);}
"raise" {return tt.getKeywordTokenType(291);}
"range" {return tt.getKeywordTokenType(292);}
"read" {return tt.getKeywordTokenType(293);}
"record" {return tt.getKeywordTokenType(294);}
"ref" {return tt.getKeywordTokenType(295);}
"reference" {return tt.getKeywordTokenType(296);}
"referencing" {return tt.getKeywordTokenType(297);}
"regexp_like" {return tt.getKeywordTokenType(298);}
"reject" {return tt.getKeywordTokenType(299);}
"release" {return tt.getKeywordTokenType(300);}
"relies_on" {return tt.getKeywordTokenType(301);}
"remainder" {return tt.getKeywordTokenType(302);}
"rename" {return tt.getKeywordTokenType(303);}
"replace" {return tt.getKeywordTokenType(304);}
"restrict_references" {return tt.getKeywordTokenType(305);}
"result" {return tt.getKeywordTokenType(306);}
"result_cache" {return tt.getKeywordTokenType(307);}
"return" {return tt.getKeywordTokenType(308);}
"returning" {return tt.getKeywordTokenType(309);}
"reverse" {return tt.getKeywordTokenType(310);}
"revoke" {return tt.getKeywordTokenType(311);}
"right" {return tt.getKeywordTokenType(312);}
"rnds" {return tt.getKeywordTokenType(313);}
"rnps" {return tt.getKeywordTokenType(314);}
"rollback" {return tt.getKeywordTokenType(315);}
"rollup" {return tt.getKeywordTokenType(316);}
"row" {return tt.getKeywordTokenType(317);}
"rowcount" {return tt.getKeywordTokenType(318);}
"rownum" {return tt.getKeywordTokenType(319);}
"rows" {return tt.getKeywordTokenType(320);}
"rowtype" {return tt.getKeywordTokenType(321);}
"rules" {return tt.getKeywordTokenType(322);}
"sample" {return tt.getKeywordTokenType(323);}
"save" {return tt.getKeywordTokenType(324);}
"savepoint" {return tt.getKeywordTokenType(325);}
"schema" {return tt.getKeywordTokenType(326);}
"schemacheck" {return tt.getKeywordTokenType(327);}
"scn" {return tt.getKeywordTokenType(328);}
"second" {return tt.getKeywordTokenType(329);}
"seed" {return tt.getKeywordTokenType(330);}
"segment" {return tt.getKeywordTokenType(331);}
"select" {return tt.getKeywordTokenType(332);}
"self" {return tt.getKeywordTokenType(333);}
"separate" {return tt.getKeywordTokenType(334);}
"sequential" {return tt.getKeywordTokenType(335);}
"serializable" {return tt.getKeywordTokenType(336);}
"serially_reusable" {return tt.getKeywordTokenType(337);}
"servererror" {return tt.getKeywordTokenType(338);}
"set" {return tt.getKeywordTokenType(339);}
"sets" {return tt.getKeywordTokenType(340);}
"share" {return tt.getKeywordTokenType(341);}
"show" {return tt.getKeywordTokenType(342);}
"shutdown" {return tt.getKeywordTokenType(343);}
"siblings" {return tt.getKeywordTokenType(344);}
"sig" {return tt.getKeywordTokenType(345);}
"single" {return tt.getKeywordTokenType(346);}
"size" {return tt.getKeywordTokenType(347);}
"some" {return tt.getKeywordTokenType(348);}
"space" {return tt.getKeywordTokenType(349);}
"sql" {return tt.getKeywordTokenType(350);}
"sqlcode" {return tt.getKeywordTokenType(351);}
"sqlerrm" {return tt.getKeywordTokenType(352);}
"standalone" {return tt.getKeywordTokenType(353);}
"start" {return tt.getKeywordTokenType(354);}
"startup" {return tt.getKeywordTokenType(355);}
"statement" {return tt.getKeywordTokenType(356);}
"static" {return tt.getKeywordTokenType(357);}
"statistic" {return tt.getKeywordTokenType(358);}
"statistics" {return tt.getKeywordTokenType(359);}
"strict" {return tt.getKeywordTokenType(360);}
"struct" {return tt.getKeywordTokenType(361);}
"submultiset" {return tt.getKeywordTokenType(362);}
"subpartition" {return tt.getKeywordTokenType(363);}
"subtype" {return tt.getKeywordTokenType(364);}
"successful" {return tt.getKeywordTokenType(365);}
"sum_squares_between" {return tt.getKeywordTokenType(366);}
"sum_squares_within" {return tt.getKeywordTokenType(367);}
"suspend" {return tt.getKeywordTokenType(368);}
"synonym" {return tt.getKeywordTokenType(369);}
"table" {return tt.getKeywordTokenType(370);}
"tdo" {return tt.getKeywordTokenType(371);}
"then" {return tt.getKeywordTokenType(372);}
"ties" {return tt.getKeywordTokenType(373);}
"time" {return tt.getKeywordTokenType(374);}
"timezone_abbr" {return tt.getKeywordTokenType(375);}
"timezone_hour" {return tt.getKeywordTokenType(376);}
"timezone_minute" {return tt.getKeywordTokenType(377);}
"timezone_region" {return tt.getKeywordTokenType(378);}
"to" {return tt.getKeywordTokenType(379);}
"trailing" {return tt.getKeywordTokenType(380);}
"transaction" {return tt.getKeywordTokenType(381);}
"trigger" {return tt.getKeywordTokenType(382);}
"truncate" {return tt.getKeywordTokenType(383);}
"trust" {return tt.getKeywordTokenType(384);}
"two_sided_prob" {return tt.getKeywordTokenType(385);}
"two_sided_sig" {return tt.getKeywordTokenType(386);}
"type" {return tt.getKeywordTokenType(387);}
"u_statistic" {return tt.getKeywordTokenType(388);}
"unbounded" {return tt.getKeywordTokenType(389);}
"unconditional" {return tt.getKeywordTokenType(390);}
"under" {return tt.getKeywordTokenType(391);}
"under_path" {return tt.getKeywordTokenType(392);}
"union" {return tt.getKeywordTokenType(393);}
"unique" {return tt.getKeywordTokenType(394);}
"unlimited" {return tt.getKeywordTokenType(395);}
"unpivot" {return tt.getKeywordTokenType(396);}
"until" {return tt.getKeywordTokenType(397);}
"update" {return tt.getKeywordTokenType(398);}
"updated" {return tt.getKeywordTokenType(399);}
"updating" {return tt.getKeywordTokenType(400);}
"upsert" {return tt.getKeywordTokenType(401);}
"use" {return tt.getKeywordTokenType(402);}
"user" {return tt.getKeywordTokenType(403);}
"using" {return tt.getKeywordTokenType(404);}
"validate" {return tt.getKeywordTokenType(405);}
"value" {return tt.getKeywordTokenType(406);}
"values" {return tt.getKeywordTokenType(407);}
"variable" {return tt.getKeywordTokenType(408);}
"varray" {return tt.getKeywordTokenType(409);}
"varying" {return tt.getKeywordTokenType(410);}
"version" {return tt.getKeywordTokenType(411);}
"versions" {return tt.getKeywordTokenType(412);}
"view" {return tt.getKeywordTokenType(413);}
"wait" {return tt.getKeywordTokenType(414);}
"wellformed" {return tt.getKeywordTokenType(415);}
"when" {return tt.getKeywordTokenType(416);}
"whenever" {return tt.getKeywordTokenType(417);}
"where" {return tt.getKeywordTokenType(418);}
"while" {return tt.getKeywordTokenType(419);}
"with" {return tt.getKeywordTokenType(420);}
"within" {return tt.getKeywordTokenType(421);}
"without" {return tt.getKeywordTokenType(422);}
"wnds" {return tt.getKeywordTokenType(423);}
"wnps" {return tt.getKeywordTokenType(424);}
"work" {return tt.getKeywordTokenType(425);}
"write" {return tt.getKeywordTokenType(426);}
"wrapped" {return tt.getKeywordTokenType(427);}
"wrapper" {return tt.getKeywordTokenType(428);}
"xml" {return tt.getKeywordTokenType(429);}
"xmlnamespaces" {return tt.getKeywordTokenType(430);}
"year" {return tt.getKeywordTokenType(431);}
"yes" {return tt.getKeywordTokenType(432);}
"zone" {return tt.getKeywordTokenType(433);}
"false" {return tt.getKeywordTokenType(434);}
"true" {return tt.getKeywordTokenType(435);}
