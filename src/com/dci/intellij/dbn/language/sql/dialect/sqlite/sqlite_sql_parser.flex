...
"offset" {return tt.getKeywordTokenType(81);}
"on" {return tt.getKeywordTokenType(82);}
"or" {return tt.getKeywordTokenType(83);}
"order" {return tt.getKeywordTokenType(84);}
"outer" {return tt.getKeywordTokenType(85);}
"plan" {return tt.getKeywordTokenType(86);}
"pragma" {return tt.getKeywordTokenType(87);}
"primary" {return tt.getKeywordTokenType(88);}
"query" {return tt.getKeywordTokenType(89);}
"raise" {return tt.getKeywordTokenType(90);}
"recursive" {return tt.getKeywordTokenType(91);}
"references" {return tt.getKeywordTokenType(92);}
"regexp" {return tt.getKeywordTokenType(93);}
"reindex" {return tt.getKeywordTokenType(94);}
"release" {return tt.getKeywordTokenType(95);}
"rename" {return tt.getKeywordTokenType(96);}
"replace" {return tt.getKeywordTokenType(97);}
"restrict" {return tt.getKeywordTokenType(98);}
"right" {return tt.getKeywordTokenType(99);}
"rollback" {return tt.getKeywordTokenType(100);}
"row" {return tt.getKeywordTokenType(101);}
"savepoint" {return tt.getKeywordTokenType(102);}
"select" {return tt.getKeywordTokenType(103);}
"set" {return tt.getKeywordTokenType(104);}
"table" {return tt.getKeywordTokenType(105);}
"temp" {return tt.getKeywordTokenType(106);}
"temporary" {return tt.getKeywordTokenType(107);}
"then" {return tt.getKeywordTokenType(108);}
"to" {return tt.getKeywordTokenType(109);}
"transaction" {return tt.getKeywordTokenType(110);}
"trigger" {return tt.getKeywordTokenType(111);}
"union" {return tt.getKeywordTokenType(112);}
"unique" {return tt.getKeywordTokenType(113);}
"update" {return tt.getKeywordTokenType(114);}
"using" {return tt.getKeywordTokenType(115);}
"vacuum" {return tt.getKeywordTokenType(116);}
"values" {return tt.getKeywordTokenType(117);}
"view" {return tt.getKeywordTokenType(118);}
"virtual" {return tt.getKeywordTokenType(119);}
"when" {return tt.getKeywordTokenType(120);}
"where" {return tt.getKeywordTokenType(121);}
"with" {return tt.getKeywordTokenType(122);}
"without" {return tt.getKeywordTokenType(123);}
