...
"package" {return tt.getKeywordTokenType(430);}
"parallel" {return tt.getKeywordTokenType(431);}
"parameters" {return tt.getKeywordTokenType(432);}
"partial" {return tt.getKeywordTokenType(433);}
"partition" {return tt.getKeywordTokenType(434);}
"partitions" {return tt.getKeywordTokenType(435);}
"passing" {return tt.getKeywordTokenType(436);}
"password" {return tt.getKeywordTokenType(437);}
"path" {return tt.getKeywordTokenType(438);}
"pctfree" {return tt.getKeywordTokenType(439);}
"pctincrease" {return tt.getKeywordTokenType(440);}
"pctthreshold" {return tt.getKeywordTokenType(441);}
"pctused" {return tt.getKeywordTokenType(442);}
"pctversion" {return tt.getKeywordTokenType(443);}
"percent" {return tt.getKeywordTokenType(444);}
"performance" {return tt.getKeywordTokenType(445);}
"period" {return tt.getKeywordTokenType(446);}
"phi_coefficient" {return tt.getKeywordTokenType(447);}
"physical" {return tt.getKeywordTokenType(448);}
"pivot" {return tt.getKeywordTokenType(449);}
"plan" {return tt.getKeywordTokenType(450);}
"pluggable" {return tt.getKeywordTokenType(451);}
"policy" {return tt.getKeywordTokenType(452);}
"post_transaction" {return tt.getKeywordTokenType(453);}
"power" {return tt.getKeywordTokenType(454);}
"prebuilt" {return tt.getKeywordTokenType(455);}
"preceding" {return tt.getKeywordTokenType(456);}
"precision" {return tt.getKeywordTokenType(457);}
"prepare" {return tt.getKeywordTokenType(458);}
"present" {return tt.getKeywordTokenType(459);}
"preserve" {return tt.getKeywordTokenType(460);}
"pretty" {return tt.getKeywordTokenType(461);}
"primary" {return tt.getKeywordTokenType(462);}
"prior" {return tt.getKeywordTokenType(463);}
"priority" {return tt.getKeywordTokenType(464);}
"private" {return tt.getKeywordTokenType(465);}
"privilege" {return tt.getKeywordTokenType(466);}
"privileges" {return tt.getKeywordTokenType(467);}
"procedure" {return tt.getKeywordTokenType(468);}
"process" {return tt.getKeywordTokenType(469);}
"profile" {return tt.getKeywordTokenType(470);}
"program" {return tt.getKeywordTokenType(471);}
"protection" {return tt.getKeywordTokenType(472);}
"public" {return tt.getKeywordTokenType(473);}
"purge" {return tt.getKeywordTokenType(474);}
"query" {return tt.getKeywordTokenType(475);}
"queue" {return tt.getKeywordTokenType(476);}
"quiesce" {return tt.getKeywordTokenType(477);}
"quota" {return tt.getKeywordTokenType(478);}
"range" {return tt.getKeywordTokenType(479);}
"read" {return tt.getKeywordTokenType(480);}
"reads" {return tt.getKeywordTokenType(481);}
"rebalance" {return tt.getKeywordTokenType(482);}
"rebuild" {return tt.getKeywordTokenType(483);}
"recover" {return tt.getKeywordTokenType(484);}
"recovery" {return tt.getKeywordTokenType(485);}
"recycle" {return tt.getKeywordTokenType(486);}
"redefine" {return tt.getKeywordTokenType(487);}
"reduced" {return tt.getKeywordTokenType(488);}
"ref" {return tt.getKeywordTokenType(489);}
"reference" {return tt.getKeywordTokenType(490);}
"references" {return tt.getKeywordTokenType(491);}
"refresh" {return tt.getKeywordTokenType(492);}
"regexp_like" {return tt.getKeywordTokenType(493);}
"register" {return tt.getKeywordTokenType(494);}
"reject" {return tt.getKeywordTokenType(495);}
"rely" {return tt.getKeywordTokenType(496);}
"remainder" {return tt.getKeywordTokenType(497);}
"rename" {return tt.getKeywordTokenType(498);}
"repair" {return tt.getKeywordTokenType(499);}
"repeat" {return tt.getKeywordTokenType(500);}
"replace" {return tt.getKeywordTokenType(501);}
"reset" {return tt.getKeywordTokenType(502);}
"resetlogs" {return tt.getKeywordTokenType(503);}
"resize" {return tt.getKeywordTokenType(504);}
"resolve" {return tt.getKeywordTokenType(505);}
"resolver" {return tt.getKeywordTokenType(506);}
"resource" {return tt.getKeywordTokenType(507);}
"restrict" {return tt.getKeywordTokenType(508);}
"restricted" {return tt.getKeywordTokenType(509);}
"resumable" {return tt.getKeywordTokenType(510);}
"resume" {return tt.getKeywordTokenType(511);}
"retention" {return tt.getKeywordTokenType(512);}
"return" {return tt.getKeywordTokenType(513);}
"returning" {return tt.getKeywordTokenType(514);}
"reuse" {return tt.getKeywordTokenType(515);}
"reverse" {return tt.getKeywordTokenType(516);}
"revoke" {return tt.getKeywordTokenType(517);}
"rewrite" {return tt.getKeywordTokenType(518);}
"right" {return tt.getKeywordTokenType(519);}
"role" {return tt.getKeywordTokenType(520);}
"rollback" {return tt.getKeywordTokenType(521);}
"rollover" {return tt.getKeywordTokenType(522);}
"rollup" {return tt.getKeywordTokenType(523);}
"row" {return tt.getKeywordTokenType(524);}
"rownum" {return tt.getKeywordTokenType(525);}
"rows" {return tt.getKeywordTokenType(526);}
"rule" {return tt.getKeywordTokenType(527);}
"rules" {return tt.getKeywordTokenType(528);}
"salt" {return tt.getKeywordTokenType(529);}
"sample" {return tt.getKeywordTokenType(530);}
"savepoint" {return tt.getKeywordTokenType(531);}
"scan" {return tt.getKeywordTokenType(532);}
"scheduler" {return tt.getKeywordTokenType(533);}
"schemacheck" {return tt.getKeywordTokenType(534);}
"scn" {return tt.getKeywordTokenType(535);}
"scope" {return tt.getKeywordTokenType(536);}
"second" {return tt.getKeywordTokenType(537);}
"seed" {return tt.getKeywordTokenType(538);}
"segment" {return tt.getKeywordTokenType(539);}
"select" {return tt.getKeywordTokenType(540);}
"sequence" {return tt.getKeywordTokenType(541);}
"sequential" {return tt.getKeywordTokenType(542);}
"serializable" {return tt.getKeywordTokenType(543);}
"service" {return tt.getKeywordTokenType(544);}
"session" {return tt.getKeywordTokenType(545);}
"set" {return tt.getKeywordTokenType(546);}
"sets" {return tt.getKeywordTokenType(547);}
"settings" {return tt.getKeywordTokenType(548);}
"share" {return tt.getKeywordTokenType(549);}
"shared_pool" {return tt.getKeywordTokenType(550);}
"sharing" {return tt.getKeywordTokenType(551);}
"show" {return tt.getKeywordTokenType(552);}
"shrink" {return tt.getKeywordTokenType(553);}
"shutdown" {return tt.getKeywordTokenType(554);}
"siblings" {return tt.getKeywordTokenType(555);}
"sid" {return tt.getKeywordTokenType(556);}
"sig" {return tt.getKeywordTokenType(557);}
"single" {return tt.getKeywordTokenType(558);}
"size" {return tt.getKeywordTokenType(559);}
"skip" {return tt.getKeywordTokenType(560);}
"smallfile" {return tt.getKeywordTokenType(561);}
"snapshot" {return tt.getKeywordTokenType(562);}
"some" {return tt.getKeywordTokenType(563);}
"sort" {return tt.getKeywordTokenType(564);}
"source" {return tt.getKeywordTokenType(565);}
"space" {return tt.getKeywordTokenType(566);}
"specification" {return tt.getKeywordTokenType(567);}
"spfile" {return tt.getKeywordTokenType(568);}
"split" {return tt.getKeywordTokenType(569);}
"sql" {return tt.getKeywordTokenType(570);}
"standalone" {return tt.getKeywordTokenType(571);}
"standby" {return tt.getKeywordTokenType(572);}
"start" {return tt.getKeywordTokenType(573);}
"statement" {return tt.getKeywordTokenType(574);}
"statistic" {return tt.getKeywordTokenType(575);}
"statistics" {return tt.getKeywordTokenType(576);}
"stop" {return tt.getKeywordTokenType(577);}
"storage" {return tt.getKeywordTokenType(578);}
"store" {return tt.getKeywordTokenType(579);}
"strict" {return tt.getKeywordTokenType(580);}
"submultiset" {return tt.getKeywordTokenType(581);}
"subpartition" {return tt.getKeywordTokenType(582);}
"subpartitions" {return tt.getKeywordTokenType(583);}
"substitutable" {return tt.getKeywordTokenType(584);}
"successful" {return tt.getKeywordTokenType(585);}
"sum_squares_between" {return tt.getKeywordTokenType(586);}
"sum_squares_within" {return tt.getKeywordTokenType(587);}
"supplemental" {return tt.getKeywordTokenType(588);}
"suspend" {return tt.getKeywordTokenType(589);}
"switch" {return tt.getKeywordTokenType(590);}
"switchover" {return tt.getKeywordTokenType(591);}
"synchronous" {return tt.getKeywordTokenType(592);}
"synonym" {return tt.getKeywordTokenType(593);}
"sysbackup" {return tt.getKeywordTokenType(594);}
"sysdba" {return tt.getKeywordTokenType(595);}
"sysdg" {return tt.getKeywordTokenType(596);}
"syskm" {return tt.getKeywordTokenType(597);}
"sysoper" {return tt.getKeywordTokenType(598);}
"system" {return tt.getKeywordTokenType(599);}
"table" {return tt.getKeywordTokenType(600);}
"tables" {return tt.getKeywordTokenType(601);}
"tablespace" {return tt.getKeywordTokenType(602);}
"tempfile" {return tt.getKeywordTokenType(603);}
"template" {return tt.getKeywordTokenType(604);}
"temporary" {return tt.getKeywordTokenType(605);}
"test" {return tt.getKeywordTokenType(606);}
"than" {return tt.getKeywordTokenType(607);}
"then" {return tt.getKeywordTokenType(608);}
"thread" {return tt.getKeywordTokenType(609);}
"through" {return tt.getKeywordTokenType(610);}
"tier" {return tt.getKeywordTokenType(611);}
"ties" {return tt.getKeywordTokenType(612);}
"time" {return tt.getKeywordTokenType(613);}
"time_zone" {return tt.getKeywordTokenType(614);}
"timeout" {return tt.getKeywordTokenType(615);}
"timezone_abbr" {return tt.getKeywordTokenType(616);}
"timezone_hour" {return tt.getKeywordTokenType(617);}
"timezone_minute" {return tt.getKeywordTokenType(618);}
"timezone_region" {return tt.getKeywordTokenType(619);}
"to" {return tt.getKeywordTokenType(620);}
"trace" {return tt.getKeywordTokenType(621);}
"tracking" {return tt.getKeywordTokenType(622);}
"trailing" {return tt.getKeywordTokenType(623);}
"transaction" {return tt.getKeywordTokenType(624);}
"translation" {return tt.getKeywordTokenType(625);}
"trigger" {return tt.getKeywordTokenType(626);}
"truncate" {return tt.getKeywordTokenType(627);}
"trusted" {return tt.getKeywordTokenType(628);}
"tuning" {return tt.getKeywordTokenType(629);}
"two_sided_prob" {return tt.getKeywordTokenType(630);}
"two_sided_sig" {return tt.getKeywordTokenType(631);}
"type" {return tt.getKeywordTokenType(632);}
"u_statistic" {return tt.getKeywordTokenType(633);}
"uid" {return tt.getKeywordTokenType(634);}
"unarchived" {return tt.getKeywordTokenType(635);}
"unbounded" {return tt.getKeywordTokenType(636);}
"unconditional" {return tt.getKeywordTokenType(637);}
"under" {return tt.getKeywordTokenType(638);}
"under_path" {return tt.getKeywordTokenType(639);}
"undrop" {return tt.getKeywordTokenType(640);}
"union" {return tt.getKeywordTokenType(641);}
"unique" {return tt.getKeywordTokenType(642);}
"unlimited" {return tt.getKeywordTokenType(643);}
"unlock" {return tt.getKeywordTokenType(644);}
"unpivot" {return tt.getKeywordTokenType(645);}
"unprotected" {return tt.getKeywordTokenType(646);}
"unquiesce" {return tt.getKeywordTokenType(647);}
"unrecoverable" {return tt.getKeywordTokenType(648);}
"until" {return tt.getKeywordTokenType(649);}
"unusable" {return tt.getKeywordTokenType(650);}
"unused" {return tt.getKeywordTokenType(651);}
"update" {return tt.getKeywordTokenType(652);}
"updated" {return tt.getKeywordTokenType(653);}
"upgrade" {return tt.getKeywordTokenType(654);}
"upsert" {return tt.getKeywordTokenType(655);}
"usage" {return tt.getKeywordTokenType(656);}
"use" {return tt.getKeywordTokenType(657);}
"user" {return tt.getKeywordTokenType(658);}
"using" {return tt.getKeywordTokenType(659);}
"validate" {return tt.getKeywordTokenType(660);}
"validation" {return tt.getKeywordTokenType(661);}
"value" {return tt.getKeywordTokenType(662);}
"values" {return tt.getKeywordTokenType(663);}
"varray" {return tt.getKeywordTokenType(664);}
"version" {return tt.getKeywordTokenType(665);}
"versions" {return tt.getKeywordTokenType(666);}
"view" {return tt.getKeywordTokenType(667);}
"visible" {return tt.getKeywordTokenType(668);}
"wait" {return tt.getKeywordTokenType(669);}
"wellformed" {return tt.getKeywordTokenType(670);}
"when" {return tt.getKeywordTokenType(671);}
"whenever" {return tt.getKeywordTokenType(672);}
"where" {return tt.getKeywordTokenType(673);}
"with" {return tt.getKeywordTokenType(674);}
"within" {return tt.getKeywordTokenType(675);}
"without" {return tt.getKeywordTokenType(676);}
"work" {return tt.getKeywordTokenType(677);}
"wrapper" {return tt.getKeywordTokenType(678);}
"write" {return tt.getKeywordTokenType(679);}
"xml" {return tt.getKeywordTokenType(680);}
"xmlnamespaces" {return tt.getKeywordTokenType(681);}
"xmlschema" {return tt.getKeywordTokenType(682);}
"xmltype" {return tt.getKeywordTokenType(683);}
"year" {return tt.getKeywordTokenType(684);}
"years" {return tt.getKeywordTokenType(685);}
"yes" {return tt.getKeywordTokenType(686);}
"zone" {return tt.getKeywordTokenType(687);}
"false" {return tt.getKeywordTokenType(688);}
"true" {return tt.getKeywordTokenType(689);}
