...
abstract class DBNPreparedStatementBase<T extends PreparedStatement> extends DBNStatement<T> implements PreparedStatement{

    public DBNPreparedStatementBase(T inner, DBNConnection connection) {
