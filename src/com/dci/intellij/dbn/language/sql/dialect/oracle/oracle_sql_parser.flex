...
<YYINITIAL> {
    ...
    "kill" {return tt.getKeywordTokenType(254);}
    "last" {return tt.getKeywordTokenType(255);}
    "leading" {return tt.getKeywordTokenType(256);}
    "left" {return tt.getKeywordTokenType(257);}
    "less" {return tt.getKeywordTokenType(258);}
    "level" {return tt.getKeywordTokenType(259);}
    "levels" {return tt.getKeywordTokenType(260);}
    "library" {return tt.getKeywordTokenType(261);}
    "like" {return tt.getKeywordTokenType(262);}
    "like2" {return tt.getKeywordTokenType(263);}
    "like4" {return tt.getKeywordTokenType(264);}
    "likec" {return tt.getKeywordTokenType(265);}
    "limit" {return tt.getKeywordTokenType(266);}
    "link" {return tt.getKeywordTokenType(267);}
    "lob" {return tt.getKeywordTokenType(268);}
    "local" {return tt.getKeywordTokenType(269);}
    "locator" {return tt.getKeywordTokenType(270);}
    "lock" {return tt.getKeywordTokenType(271);}
    "log" {return tt.getKeywordTokenType(272);}
    "logfile" {return tt.getKeywordTokenType(273);}
    "logging" {return tt.getKeywordTokenType(274);}
    "logical" {return tt.getKeywordTokenType(275);}
    "main" {return tt.getKeywordTokenType(276);}
    "manage" {return tt.getKeywordTokenType(277);}
    "managed" {return tt.getKeywordTokenType(278);}
    "manager" {return tt.getKeywordTokenType(279);}
    "management" {return tt.getKeywordTokenType(280);}
    "manual" {return tt.getKeywordTokenType(281);}
    "mapping" {return tt.getKeywordTokenType(282);}
    "master" {return tt.getKeywordTokenType(283);}
    "matched" {return tt.getKeywordTokenType(284);}
    "materialized" {return tt.getKeywordTokenType(285);}
    "maxextents" {return tt.getKeywordTokenType(286);}
    "maximize" {return tt.getKeywordTokenType(287);}
    "maxsize" {return tt.getKeywordTokenType(288);}
    "maxvalue" {return tt.getKeywordTokenType(289);}
    "mean_squares_between" {return tt.getKeywordTokenType(290);}
    "mean_squares_within" {return tt.getKeywordTokenType(291);}
    "measure" {return tt.getKeywordTokenType(292);}
    "measures" {return tt.getKeywordTokenType(293);}
    "member" {return tt.getKeywordTokenType(294);}
    "memory" {return tt.getKeywordTokenType(295);}
    "merge" {return tt.getKeywordTokenType(296);}
    "minextents" {return tt.getKeywordTokenType(297);}
    "mining" {return tt.getKeywordTokenType(298);}
    "minus" {return tt.getKeywordTokenType(299);}
    "minute" {return tt.getKeywordTokenType(300);}
    "minutes" {return tt.getKeywordTokenType(301);}
    "minvalue" {return tt.getKeywordTokenType(302);}
    "mirror" {return tt.getKeywordTokenType(303);}
    "mlslabel" {return tt.getKeywordTokenType(304);}
    "mode" {return tt.getKeywordTokenType(305);}
    "model" {return tt.getKeywordTokenType(306);}
    "modify" {return tt.getKeywordTokenType(307);}
    "monitoring" {return tt.getKeywordTokenType(308);}
    "month" {return tt.getKeywordTokenType(309);}
    "mount" {return tt.getKeywordTokenType(310);}
    "move" {return tt.getKeywordTokenType(311);}
    "multiset" {return tt.getKeywordTokenType(312);}
    "name" {return tt.getKeywordTokenType(313);}
    "nan" {return tt.getKeywordTokenType(314);}
    "natural" {return tt.getKeywordTokenType(315);}
    "nav" {return tt.getKeywordTokenType(316);}
    "nchar_cs" {return tt.getKeywordTokenType(317);}
    "nested" {return tt.getKeywordTokenType(318);}
    "new" {return tt.getKeywordTokenType(319);}
    "next" {return tt.getKeywordTokenType(320);}
    "nextval" {return tt.getKeywordTokenType(321);}
    "no" {return tt.getKeywordTokenType(322);}
    "noarchivelog" {return tt.getKeywordTokenType(323);}
    "noaudit" {return tt.getKeywordTokenType(324);}
    "nocache" {return tt.getKeywordTokenType(325);}
    "nocompress" {return tt.getKeywordTokenType(326);}
    "nocycle" {return tt.getKeywordTokenType(327);}
    "nodelay" {return tt.getKeywordTokenType(328);}
    "noentityescaping" {return tt.getKeywordTokenType(329);}
    "noforce" {return tt.getKeywordTokenType(330);}
    "nologging" {return tt.getKeywordTokenType(331);}
    "nomapping" {return tt.getKeywordTokenType(332);}
    "nomaxvalue" {return tt.getKeywordTokenType(333);}
    "nominvalue" {return tt.getKeywordTokenType(334);}
    "nomonitoring" {return tt.getKeywordTokenType(335);}
    "none" {return tt.getKeywordTokenType(336);}
    "noorder" {return tt.getKeywordTokenType(337);}
    "noparallel" {return tt.getKeywordTokenType(338);}
    "norely" {return tt.getKeywordTokenType(339);}
    "norepair" {return tt.getKeywordTokenType(340);}
    "noresetlogs" {return tt.getKeywordTokenType(341);}
    "noreverse" {return tt.getKeywordTokenType(342);}
    "noschemacheck" {return tt.getKeywordTokenType(343);}
    "noswitch" {return tt.getKeywordTokenType(344);}
    "not" {return tt.getKeywordTokenType(345);}
    "nothing" {return tt.getKeywordTokenType(346);}
    "notification" {return tt.getKeywordTokenType(347);}
    "notimeout" {return tt.getKeywordTokenType(348);}
    "novalidate" {return tt.getKeywordTokenType(349);}
    "nowait" {return tt.getKeywordTokenType(350);}
    "null" {return tt.getKeywordTokenType(351);}
    "nulls" {return tt.getKeywordTokenType(352);}
    "object" {return tt.getKeywordTokenType(353);}
    "of" {return tt.getKeywordTokenType(354);}
    "off" {return tt.getKeywordTokenType(355);}
    "offline" {return tt.getKeywordTokenType(356);}
    "offset" {return tt.getKeywordTokenType(357);}
    "on" {return tt.getKeywordTokenType(358);}
    "one_sided_prob_or_less" {return tt.getKeywordTokenType(359);}
    "one_sided_prob_or_more" {return tt.getKeywordTokenType(360);}
    "one_sided_sig" {return tt.getKeywordTokenType(361);}
    "online" {return tt.getKeywordTokenType(362);}
    "only" {return tt.getKeywordTokenType(363);}
    "open" {return tt.getKeywordTokenType(364);}
    "operator" {return tt.getKeywordTokenType(365);}
    "optimal" {return tt.getKeywordTokenType(366);}
    "option" {return tt.getKeywordTokenType(367);}
    "or" {return tt.getKeywordTokenType(368);}
    "order" {return tt.getKeywordTokenType(369);}
    "ordinality" {return tt.getKeywordTokenType(370);}
    "outer" {return tt.getKeywordTokenType(371);}
    "outline" {return tt.getKeywordTokenType(372);}
    "over" {return tt.getKeywordTokenType(373);}
    "overflow" {return tt.getKeywordTokenType(374);}
    "package" {return tt.getKeywordTokenType(375);}
    "parallel" {return tt.getKeywordTokenType(376);}
    "parameters" {return tt.getKeywordTokenType(377);}
    "partition" {return tt.getKeywordTokenType(378);}
    "partitions" {return tt.getKeywordTokenType(379);}
    "passing" {return tt.getKeywordTokenType(380);}
    "path" {return tt.getKeywordTokenType(381);}
    "pctfree" {return tt.getKeywordTokenType(382);}
    "pctincrease" {return tt.getKeywordTokenType(383);}
    "pctthreshold" {return tt.getKeywordTokenType(384);}
    "pctused" {return tt.getKeywordTokenType(385);}
    "pctversion" {return tt.getKeywordTokenType(386);}
    "percent" {return tt.getKeywordTokenType(387);}
    "performance" {return tt.getKeywordTokenType(388);}
    "phi_coefficient" {return tt.getKeywordTokenType(389);}
    "physical" {return tt.getKeywordTokenType(390);}
    "pivot" {return tt.getKeywordTokenType(391);}
    "plan" {return tt.getKeywordTokenType(392);}
    "policy" {return tt.getKeywordTokenType(393);}
    "post_transaction" {return tt.getKeywordTokenType(394);}
    "power" {return tt.getKeywordTokenType(395);}
    "preceding" {return tt.getKeywordTokenType(396);}
    "prepare" {return tt.getKeywordTokenType(397);}
    "present" {return tt.getKeywordTokenType(398);}
    "preserve" {return tt.getKeywordTokenType(399);}
    "primary" {return tt.getKeywordTokenType(400);}
    "prior" {return tt.getKeywordTokenType(401);}
    "private" {return tt.getKeywordTokenType(402);}
    "privilege" {return tt.getKeywordTokenType(403);}
    "privileges" {return tt.getKeywordTokenType(404);}
    "procedure" {return tt.getKeywordTokenType(405);}
    "process" {return tt.getKeywordTokenType(406);}
    "profile" {return tt.getKeywordTokenType(407);}
    "program" {return tt.getKeywordTokenType(408);}
    "protection" {return tt.getKeywordTokenType(409);}
    "public" {return tt.getKeywordTokenType(410);}
    "purge" {return tt.getKeywordTokenType(411);}
    "query" {return tt.getKeywordTokenType(412);}
    "queue" {return tt.getKeywordTokenType(413);}
    "quiesce" {return tt.getKeywordTokenType(414);}
    "range" {return tt.getKeywordTokenType(415);}
    "read" {return tt.getKeywordTokenType(416);}
    "reads" {return tt.getKeywordTokenType(417);}
    "rebalance" {return tt.getKeywordTokenType(418);}
    "rebuild" {return tt.getKeywordTokenType(419);}
    "recover" {return tt.getKeywordTokenType(420);}
    "recovery" {return tt.getKeywordTokenType(421);}
    "recycle" {return tt.getKeywordTokenType(422);}
    "ref" {return tt.getKeywordTokenType(423);}
    "reference" {return tt.getKeywordTokenType(424);}
    "references" {return tt.getKeywordTokenType(425);}
    "refresh" {return tt.getKeywordTokenType(426);}
    "regexp_like" {return tt.getKeywordTokenType(427);}
    "register" {return tt.getKeywordTokenType(428);}
    "reject" {return tt.getKeywordTokenType(429);}
    "rely" {return tt.getKeywordTokenType(430);}
    "remainder" {return tt.getKeywordTokenType(431);}
    "rename" {return tt.getKeywordTokenType(432);}
    "repair" {return tt.getKeywordTokenType(433);}
    "replace" {return tt.getKeywordTokenType(434);}
    "reset" {return tt.getKeywordTokenType(435);}
    "resetlogs" {return tt.getKeywordTokenType(436);}
    "resize" {return tt.getKeywordTokenType(437);}
    "resolve" {return tt.getKeywordTokenType(438);}
    "resolver" {return tt.getKeywordTokenType(439);}
    "resource" {return tt.getKeywordTokenType(440);}
    "restrict" {return tt.getKeywordTokenType(441);}
    "restricted" {return tt.getKeywordTokenType(442);}
    "resumable" {return tt.getKeywordTokenType(443);}
    "resume" {return tt.getKeywordTokenType(444);}
    "retention" {return tt.getKeywordTokenType(445);}
    "return" {return tt.getKeywordTokenType(446);}
    "returning" {return tt.getKeywordTokenType(447);}
    "reuse" {return tt.getKeywordTokenType(448);}
    "reverse" {return tt.getKeywordTokenType(449);}
    "revoke" {return tt.getKeywordTokenType(450);}
    "rewrite" {return tt.getKeywordTokenType(451);}
    "right" {return tt.getKeywordTokenType(452);}
    "role" {return tt.getKeywordTokenType(453);}
    "rollback" {return tt.getKeywordTokenType(454);}
    "rollup" {return tt.getKeywordTokenType(455);}
    "row" {return tt.getKeywordTokenType(456);}
    "rownum" {return tt.getKeywordTokenType(457);}
    "rows" {return tt.getKeywordTokenType(458);}
    "rule" {return tt.getKeywordTokenType(459);}
    "rules" {return tt.getKeywordTokenType(460);}
    "salt" {return tt.getKeywordTokenType(461);}
    "sample" {return tt.getKeywordTokenType(462);}
    "savepoint" {return tt.getKeywordTokenType(463);}
    "scan" {return tt.getKeywordTokenType(464);}
    "scheduler" {return tt.getKeywordTokenType(465);}
    "schemacheck" {return tt.getKeywordTokenType(466);}
    "scn" {return tt.getKeywordTokenType(467);}
    "scope" {return tt.getKeywordTokenType(468);}
    "second" {return tt.getKeywordTokenType(469);}
    "seed" {return tt.getKeywordTokenType(470);}
    "segment" {return tt.getKeywordTokenType(471);}
    "select" {return tt.getKeywordTokenType(472);}
    "sequence" {return tt.getKeywordTokenType(473);}
    "sequential" {return tt.getKeywordTokenType(474);}
    "serializable" {return tt.getKeywordTokenType(475);}
    "session" {return tt.getKeywordTokenType(476);}
    "set" {return tt.getKeywordTokenType(477);}
    "sets" {return tt.getKeywordTokenType(478);}
    "settings" {return tt.getKeywordTokenType(479);}
    "share" {return tt.getKeywordTokenType(480);}
    "shared_pool" {return tt.getKeywordTokenType(481);}
    "show" {return tt.getKeywordTokenType(482);}
    "shrink" {return tt.getKeywordTokenType(483);}
    "shutdown" {return tt.getKeywordTokenType(484);}
    "siblings" {return tt.getKeywordTokenType(485);}
    "sid" {return tt.getKeywordTokenType(486);}
    "sig" {return tt.getKeywordTokenType(487);}
    "single" {return tt.getKeywordTokenType(488);}
    "size" {return tt.getKeywordTokenType(489);}
    "skip" {return tt.getKeywordTokenType(490);}
    "smallfile" {return tt.getKeywordTokenType(491);}
    "some" {return tt.getKeywordTokenType(492);}
    "sort" {return tt.getKeywordTokenType(493);}
    "source" {return tt.getKeywordTokenType(494);}
    "space" {return tt.getKeywordTokenType(495);}
    "specification" {return tt.getKeywordTokenType(496);}
    "spfile" {return tt.getKeywordTokenType(497);}
    "split" {return tt.getKeywordTokenType(498);}
    "sql" {return tt.getKeywordTokenType(499);}
    "standalone" {return tt.getKeywordTokenType(500);}
    "standby" {return tt.getKeywordTokenType(501);}
    "start" {return tt.getKeywordTokenType(502);}
    "statistic" {return tt.getKeywordTokenType(503);}
    "statistics" {return tt.getKeywordTokenType(504);}
    "stop" {return tt.getKeywordTokenType(505);}
    "storage" {return tt.getKeywordTokenType(506);}
    "store" {return tt.getKeywordTokenType(507);}
    "submultiset" {return tt.getKeywordTokenType(508);}
    "subpartition" {return tt.getKeywordTokenType(509);}
    "subpartitions" {return tt.getKeywordTokenType(510);}
    "substitutable" {return tt.getKeywordTokenType(511);}
    "successful" {return tt.getKeywordTokenType(512);}
    "sum_squares_between" {return tt.getKeywordTokenType(513);}
    "sum_squares_within" {return tt.getKeywordTokenType(514);}
    "supplemental" {return tt.getKeywordTokenType(515);}
    "suspend" {return tt.getKeywordTokenType(516);}
    "switch" {return tt.getKeywordTokenType(517);}
    "switchover" {return tt.getKeywordTokenType(518);}
    "synonym" {return tt.getKeywordTokenType(519);}
    "system" {return tt.getKeywordTokenType(520);}
    "table" {return tt.getKeywordTokenType(521);}
    "tables" {return tt.getKeywordTokenType(522);}
    "tablespace" {return tt.getKeywordTokenType(523);}
    "tempfile" {return tt.getKeywordTokenType(524);}
    "template" {return tt.getKeywordTokenType(525);}
    "temporary" {return tt.getKeywordTokenType(526);}
    "test" {return tt.getKeywordTokenType(527);}
    "than" {return tt.getKeywordTokenType(528);}
    "then" {return tt.getKeywordTokenType(529);}
    "thread" {return tt.getKeywordTokenType(530);}
    "through" {return tt.getKeywordTokenType(531);}
    "ties" {return tt.getKeywordTokenType(532);}
    "time" {return tt.getKeywordTokenType(533);}
    "time_zone" {return tt.getKeywordTokenType(534);}
    "timeout" {return tt.getKeywordTokenType(535);}
    "timezone_abbr" {return tt.getKeywordTokenType(536);}
    "timezone_hour" {return tt.getKeywordTokenType(537);}
    "timezone_minute" {return tt.getKeywordTokenType(538);}
    "timezone_region" {return tt.getKeywordTokenType(539);}
    "to" {return tt.getKeywordTokenType(540);}
    "trace" {return tt.getKeywordTokenType(541);}
    "tracking" {return tt.getKeywordTokenType(542);}
    "trailing" {return tt.getKeywordTokenType(543);}
    "transaction" {return tt.getKeywordTokenType(544);}
    "trigger" {return tt.getKeywordTokenType(545);}
    "truncate" {return tt.getKeywordTokenType(546);}
    "trusted" {return tt.getKeywordTokenType(547);}
    "tuning" {return tt.getKeywordTokenType(548);}
    "two_sided_prob" {return tt.getKeywordTokenType(549);}
    "two_sided_sig" {return tt.getKeywordTokenType(550);}
    "type" {return tt.getKeywordTokenType(551);}
    "u_statistic" {return tt.getKeywordTokenType(552);}
    "uid" {return tt.getKeywordTokenType(553);}
    "unarchived" {return tt.getKeywordTokenType(554);}
    "unbounded" {return tt.getKeywordTokenType(555);}
    "unconditional" {return tt.getKeywordTokenType(556);}
    "under" {return tt.getKeywordTokenType(557);}
    "under_path" {return tt.getKeywordTokenType(558);}
    "undrop" {return tt.getKeywordTokenType(559);}
    "union" {return tt.getKeywordTokenType(560);}
    "unique" {return tt.getKeywordTokenType(561);}
    "unlimited" {return tt.getKeywordTokenType(562);}
    "unpivot" {return tt.getKeywordTokenType(563);}
    "unprotected" {return tt.getKeywordTokenType(564);}
    "unquiesce" {return tt.getKeywordTokenType(565);}
    "unrecoverable" {return tt.getKeywordTokenType(566);}
    "until" {return tt.getKeywordTokenType(567);}
    "unusable" {return tt.getKeywordTokenType(568);}
    "unused" {return tt.getKeywordTokenType(569);}
    "update" {return tt.getKeywordTokenType(570);}
    "updated" {return tt.getKeywordTokenType(571);}
    "upgrade" {return tt.getKeywordTokenType(572);}
    "upsert" {return tt.getKeywordTokenType(573);}
    "usage" {return tt.getKeywordTokenType(574);}
    "use" {return tt.getKeywordTokenType(575);}
    "user" {return tt.getKeywordTokenType(576);}
    "using" {return tt.getKeywordTokenType(577);}
    "validate" {return tt.getKeywordTokenType(578);}
    "validation" {return tt.getKeywordTokenType(579);}
    "value" {return tt.getKeywordTokenType(580);}
    "values" {return tt.getKeywordTokenType(581);}
    "varray" {return tt.getKeywordTokenType(582);}
    "version" {return tt.getKeywordTokenType(583);}
    "versions" {return tt.getKeywordTokenType(584);}
    "view" {return tt.getKeywordTokenType(585);}
    "wait" {return tt.getKeywordTokenType(586);}
    "wellformed" {return tt.getKeywordTokenType(587);}
    "when" {return tt.getKeywordTokenType(588);}
    "whenever" {return tt.getKeywordTokenType(589);}
    "where" {return tt.getKeywordTokenType(590);}
    "with" {return tt.getKeywordTokenType(591);}
    "within" {return tt.getKeywordTokenType(592);}
    "without" {return tt.getKeywordTokenType(593);}
    "work" {return tt.getKeywordTokenType(594);}
    "wrapper" {return tt.getKeywordTokenType(595);}
    "write" {return tt.getKeywordTokenType(596);}
    "xml" {return tt.getKeywordTokenType(597);}
    "xmlnamespaces" {return tt.getKeywordTokenType(598);}
    "xmlschema" {return tt.getKeywordTokenType(599);}
    "xmltype" {return tt.getKeywordTokenType(600);}
    "year" {return tt.getKeywordTokenType(601);}
    "yes" {return tt.getKeywordTokenType(602);}
    "zone" {return tt.getKeywordTokenType(603);}
    "false" {return tt.getKeywordTokenType(604);}
    "true" {return tt.getKeywordTokenType(605);}
    ...
    "json_table" {return tt.getFunctionTokenType(69);}
    "lag" {return tt.getFunctionTokenType(70);}
    "last_day" {return tt.getFunctionTokenType(71);}
    "last_value" {return tt.getFunctionTokenType(72);}
    "lateral" {return tt.getFunctionTokenType(73);}
    "lead" {return tt.getFunctionTokenType(74);}
    "least" {return tt.getFunctionTokenType(75);}
    "length" {return tt.getFunctionTokenType(76);}
    "length2" {return tt.getFunctionTokenType(77);}
    "length4" {return tt.getFunctionTokenType(78);}
    "lengthb" {return tt.getFunctionTokenType(79);}
    "lengthc" {return tt.getFunctionTokenType(80);}
    "listagg" {return tt.getFunctionTokenType(81);}
    "ln" {return tt.getFunctionTokenType(82);}
    "lnnvl" {return tt.getFunctionTokenType(83);}
    "localtimestamp" {return tt.getFunctionTokenType(84);}
    "lower" {return tt.getFunctionTokenType(85);}
    "lpad" {return tt.getFunctionTokenType(86);}
    "ltrim" {return tt.getFunctionTokenType(87);}
    "make_ref" {return tt.getFunctionTokenType(88);}
    "max" {return tt.getFunctionTokenType(89);}
    "median" {return tt.getFunctionTokenType(90);}
    "min" {return tt.getFunctionTokenType(91);}
    "mod" {return tt.getFunctionTokenType(92);}
    "months_between" {return tt.getFunctionTokenType(93);}
    "nanvl" {return tt.getFunctionTokenType(94);}
    "nchr" {return tt.getFunctionTokenType(95);}
    "new_time" {return tt.getFunctionTokenType(96);}
    "next_day" {return tt.getFunctionTokenType(97);}
    "nls_charset_decl_len" {return tt.getFunctionTokenType(98);}
    "nls_charset_id" {return tt.getFunctionTokenType(99);}
    "nls_charset_name" {return tt.getFunctionTokenType(100);}
    "nls_initcap" {return tt.getFunctionTokenType(101);}
    "nls_lower" {return tt.getFunctionTokenType(102);}
    "nls_upper" {return tt.getFunctionTokenType(103);}
    "nlssort" {return tt.getFunctionTokenType(104);}
    "ntile" {return tt.getFunctionTokenType(105);}
    "nullif" {return tt.getFunctionTokenType(106);}
    "numtodsinterval" {return tt.getFunctionTokenType(107);}
    "numtoyminterval" {return tt.getFunctionTokenType(108);}
    "nvl" {return tt.getFunctionTokenType(109);}
    "nvl2" {return tt.getFunctionTokenType(110);}
    "ora_hash" {return tt.getFunctionTokenType(111);}
    "percent_rank" {return tt.getFunctionTokenType(112);}
    "percentile_cont" {return tt.getFunctionTokenType(113);}
    "percentile_disc" {return tt.getFunctionTokenType(114);}
    "powermultiset" {return tt.getFunctionTokenType(115);}
    "powermultiset_by_cardinality" {return tt.getFunctionTokenType(116);}
    "presentnnv" {return tt.getFunctionTokenType(117);}
    "presentv" {return tt.getFunctionTokenType(118);}
    "previous" {return tt.getFunctionTokenType(119);}
    "rank" {return tt.getFunctionTokenType(120);}
    "ratio_to_report" {return tt.getFunctionTokenType(121);}
    "rawtohex" {return tt.getFunctionTokenType(122);}
    "rawtonhex" {return tt.getFunctionTokenType(123);}
    "reftohex" {return tt.getFunctionTokenType(124);}
    "regexp_instr" {return tt.getFunctionTokenType(125);}
    "regexp_replace" {return tt.getFunctionTokenType(126);}
    "regexp_substr" {return tt.getFunctionTokenType(127);}
    "regr_avgx" {return tt.getFunctionTokenType(128);}
    "regr_avgy" {return tt.getFunctionTokenType(129);}
    "regr_count" {return tt.getFunctionTokenType(130);}
    "regr_intercept" {return tt.getFunctionTokenType(131);}
    "regr_r2" {return tt.getFunctionTokenType(132);}
    "regr_slope" {return tt.getFunctionTokenType(133);}
    "regr_sxx" {return tt.getFunctionTokenType(134);}
    "regr_sxy" {return tt.getFunctionTokenType(135);}
    "regr_syy" {return tt.getFunctionTokenType(136);}
    "round" {return tt.getFunctionTokenType(137);}
    "row_number" {return tt.getFunctionTokenType(138);}
    "rowidtochar" {return tt.getFunctionTokenType(139);}
    "rowidtonchar" {return tt.getFunctionTokenType(140);}
    "rpad" {return tt.getFunctionTokenType(141);}
    "rtrim" {return tt.getFunctionTokenType(142);}
    "scn_to_timestamp" {return tt.getFunctionTokenType(143);}
    "sessiontimezone" {return tt.getFunctionTokenType(144);}
    "sign" {return tt.getFunctionTokenType(145);}
    "sin" {return tt.getFunctionTokenType(146);}
    "sinh" {return tt.getFunctionTokenType(147);}
    "soundex" {return tt.getFunctionTokenType(148);}
    "sqrt" {return tt.getFunctionTokenType(149);}
    "stats_binomial_test" {return tt.getFunctionTokenType(150);}
    "stats_crosstab" {return tt.getFunctionTokenType(151);}
    "stats_f_test" {return tt.getFunctionTokenType(152);}
    "stats_ks_test" {return tt.getFunctionTokenType(153);}
    "stats_mode" {return tt.getFunctionTokenType(154);}
    "stats_mw_test" {return tt.getFunctionTokenType(155);}
    "stats_one_way_anova" {return tt.getFunctionTokenType(156);}
    "stats_t_test_indep" {return tt.getFunctionTokenType(157);}
    "stats_t_test_indepu" {return tt.getFunctionTokenType(158);}
    "stats_t_test_one" {return tt.getFunctionTokenType(159);}
    "stats_t_test_paired" {return tt.getFunctionTokenType(160);}
    "stats_wsr_test" {return tt.getFunctionTokenType(161);}
    "stddev" {return tt.getFunctionTokenType(162);}
    "stddev_pop" {return tt.getFunctionTokenType(163);}
    "stddev_samp" {return tt.getFunctionTokenType(164);}
    "substr" {return tt.getFunctionTokenType(165);}
    "substr2" {return tt.getFunctionTokenType(166);}
    "substr4" {return tt.getFunctionTokenType(167);}
    "substrb" {return tt.getFunctionTokenType(168);}
    "substrc" {return tt.getFunctionTokenType(169);}
    "sum" {return tt.getFunctionTokenType(170);}
    "sys_connect_by_path" {return tt.getFunctionTokenType(171);}
    "sys_context" {return tt.getFunctionTokenType(172);}
    "sys_dburigen" {return tt.getFunctionTokenType(173);}
    "sys_extract_utc" {return tt.getFunctionTokenType(174);}
    "sys_guid" {return tt.getFunctionTokenType(175);}
    "sys_typeid" {return tt.getFunctionTokenType(176);}
    "sys_xmlagg" {return tt.getFunctionTokenType(177);}
    "sys_xmlgen" {return tt.getFunctionTokenType(178);}
    "sysdate" {return tt.getFunctionTokenType(179);}
    "systimestamp" {return tt.getFunctionTokenType(180);}
    "tan" {return tt.getFunctionTokenType(181);}
    "tanh" {return tt.getFunctionTokenType(182);}
    "timestamp_to_scn" {return tt.getFunctionTokenType(183);}
    "to_binary_double" {return tt.getFunctionTokenType(184);}
    "to_binary_float" {return tt.getFunctionTokenType(185);}
    "to_char" {return tt.getFunctionTokenType(186);}
    "to_clob" {return tt.getFunctionTokenType(187);}
    "to_date" {return tt.getFunctionTokenType(188);}
    "to_dsinterval" {return tt.getFunctionTokenType(189);}
    "to_lob" {return tt.getFunctionTokenType(190);}
    "to_multi_byte" {return tt.getFunctionTokenType(191);}
    "to_nchar" {return tt.getFunctionTokenType(192);}
    "to_nclob" {return tt.getFunctionTokenType(193);}
    "to_number" {return tt.getFunctionTokenType(194);}
    "to_single_byte" {return tt.getFunctionTokenType(195);}
    "to_timestamp" {return tt.getFunctionTokenType(196);}
    "to_timestamp_tz" {return tt.getFunctionTokenType(197);}
    "to_yminterval" {return tt.getFunctionTokenType(198);}
    "translate" {return tt.getFunctionTokenType(199);}
    "treat" {return tt.getFunctionTokenType(200);}
    "trim" {return tt.getFunctionTokenType(201);}
    "trunc" {return tt.getFunctionTokenType(202);}
    "tz_offset" {return tt.getFunctionTokenType(203);}
    ...
    "userenv" {return tt.getFunctionTokenType(207);}
    "value" {return tt.getFunctionTokenType(208);}
    "var_pop" {return tt.getFunctionTokenType(209);}
    "var_samp" {return tt.getFunctionTokenType(210);}
    "variance" {return tt.getFunctionTokenType(211);}
    "vsize" {return tt.getFunctionTokenType(212);}
    "width_bucket" {return tt.getFunctionTokenType(213);}
    "xmlagg" {return tt.getFunctionTokenType(214);}
    "xmlattributes" {return tt.getFunctionTokenType(215);}
    "xmlcast" {return tt.getFunctionTokenType(216);}
    "xmlcdata" {return tt.getFunctionTokenType(217);}
    "xmlcolattval" {return tt.getFunctionTokenType(218);}
    "xmlcomment" {return tt.getFunctionTokenType(219);}
    "xmlconcat" {return tt.getFunctionTokenType(220);}
    "xmldiff" {return tt.getFunctionTokenType(221);}
    "xmlelement" {return tt.getFunctionTokenType(222);}
    "xmlforest" {return tt.getFunctionTokenType(223);}
    "xmlisvalid" {return tt.getFunctionTokenType(224);}
    "xmlparse" {return tt.getFunctionTokenType(225);}
    "xmlpatch" {return tt.getFunctionTokenType(226);}
    "xmlpi" {return tt.getFunctionTokenType(227);}
    "xmlquery" {return tt.getFunctionTokenType(228);}
    "xmlroot" {return tt.getFunctionTokenType(229);}
    "xmlsequence" {return tt.getFunctionTokenType(230);}
    "xmlserialize" {return tt.getFunctionTokenType(231);}
    "xmltable" {return tt.getFunctionTokenType(232);}
    "xmltransform" {return tt.getFunctionTokenType(233);}
