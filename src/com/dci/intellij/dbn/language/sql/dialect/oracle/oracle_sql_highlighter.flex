...
PLSQL_KEYWORD     = "a set"|"after"|"agent"|"all"|"alter"|"analyze"|"and"|"any"|"array"|"as"|"asc"|"associate"|"at"|"audit"|"authid"|"automatic"|"autonomous_transaction"|"before"|"begin"|"between"|"block"|"body"|"both"|"bulk"|"bulk_exceptions"|"bulk_rowcount"|"by"|"c"|"call"|"canonical"|"case"|"char_base"|"char_cs"|"charsetform"|"charsetid"|"check"|"chisq_df"|"chisq_obs"|"chisq_sig"|"close"|"cluster"|"coalesce"|"coefficient"|"cohens_k"|"collect"|"comment"|"commit"|"committed"|"compatibility"|"compound"|"compress"|"connect"|"constant"|"constraint"|"constructor"|"cont_coefficient"|"context"|"count"|"cramers_v"|"create"|"cross"|"cube"|"current"|"current_user"|"currval"|"cursor"|"database"|"day"|"db_role_change"|"ddl"|"declare"|"decrement"|"default"|"definer"|"delete"|"deleting"|"dense_rank"|"desc"|"deterministic"|"df"|"df_between"|"df_den"|"df_num"|"df_within"|"dimension"|"disable"|"disassociate"|"distinct"|"do"|"drop"|"dump"|"duration"|"each"|"else"|"elsif"|"empty"|"enable"|"end"|"equals_path"|"error_code"|"error_index"|"errors"|"escape"|"exact_prob"|"exception"|"exception_init"|"exceptions"|"exclusive"|"execute"|"exists"|"exit"|"extend"|"extends"|"external"|"f_ratio"|"fetch"|"final"|"first"|"following"|"follows"|"for"|"forall"|"force"|"found"|"from"|"full"|"function"|"goto"|"grant"|"group"|"having"|"heap"|"hour"|"if"|"ignore"|"immediate"|"in"|"in"{ws}"out"|"increment"|"index"|"indicator"|"indices"|"infinite"|"inner"|"insert"|"inserting"|"instantiable"|"instead"|"interface"|"intersect"|"interval"|"into"|"is"|"isolation"|"isopen"|"iterate"|"java"|"join"|"keep"|"language"|"last"|"leading"|"left"|"level"|"library"|"like"|"like2"|"like4"|"likec"|"limit"|"limited"|"local"|"lock"|"log"|"logoff"|"logon"|"loop"|"main"|"map"|"matched"|"maxlen"|"maxvalue"|"mean_squares_between"|"mean_squares_within"|"measures"|"member"|"merge"|"minus"|"minute"|"minvalue"|"mlslabel"|"mode"|"model"|"month"|"multiset"|"name"|"nan"|"natural"|"naturaln"|"nav"|"nchar_cs"|"nested"|"new"|"next"|"nextval"|"noaudit"|"nocopy"|"nocycle"|"not"|"notfound"|"nowait"|"null"|"nulls"|"number_base"|"object"|"ocirowid"|"of"|"oid"|"old"|"on"|"one_sided_prob_or_less"|"one_sided_prob_or_more"|"one_sided_sig"|"only"|"opaque"|"open"|"operator"|"option"|"or"|"order"|"organization"|"others"|"out"|"outer"|"over"|"overriding"|"package"|"parallel_enable"|"parameters"|"parent"|"partition"|"pctfree"|"phi_coefficient"|"positive"|"positiven"|"power"|"pragma"|"preceding"|"present"|"prior"|"private"|"procedure"|"public"|"raise"|"range"|"rank"|"read"|"record"|"ref"|"reference"|"referencing"|"regexp_like"|"reject"|"release"|"remainder"|"rename"|"replace"|"restrict_references"|"result"|"return"|"returning"|"reverse"|"revoke"|"right"|"rnds"|"rnps"|"rollback"|"rollup"|"row"|"rowcount"|"rownum"|"rows"|"rowtype"|"rules"|"sample"|"save"|"savepoint"|"schema"|"scn"|"second"|"seed"|"segment"|"select"|"self"|"separate"|"sequential"|"serializable"|"serially_reusable"|"servererror"|"set"|"sets"|"share"|"shutdown"|"siblings"|"sig"|"single"|"some"|"space"|"sql"|"sqlcode"|"sqlerrm"|"start"|"startup"|"statement"|"static"|"statistic"|"statistics"|"struct"|"submultiset"|"subpartition"|"subtype"|"successful"|"sum_squares_between"|"sum_squares_within"|"suspend"|"synonym"|"table"|"tdo"|"then"|"time"|"timezone_abbr"|"timezone_hour"|"timezone_minute"|"timezone_region"|"to"|"trailing"|"transaction"|"trigger"|"truncate"|"trust"|"two_sided_prob"|"two_sided_sig"|"type"|"u_statistic"|"unbounded"|"under"|"under_path"|"union"|"unique"|"unlimited"|"until"|"update"|"updated"|"updating"|"upsert"|"use"|"user"|"using"|"validate"|"value"|"values"|"variable"|"varray"|"varying"|"versions"|"view"|"wait"|"when"|"whenever"|"where"|"while"|"with"|"within"|"wnds"|"wnps"|"work"|"write"|"year"|"zone"|"false"|"true"
