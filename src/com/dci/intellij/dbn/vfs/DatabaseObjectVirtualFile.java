...
public class DatabaseObjectVirtualFile<T extends DBObject> extends VirtualFile implements DBVirtualFile, Disposable {
    ...
    public DatabaseObjectVirtualFile(T object) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DatabaseObjectVirtualFile) {
            DatabaseObjectVirtualFile objectFile = (DatabaseObjectVirtualFile) obj;
