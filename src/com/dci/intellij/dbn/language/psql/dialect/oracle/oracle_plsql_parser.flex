...
"overriding" {return tt.getKeywordTokenType(277);}
"package" {return tt.getKeywordTokenType(278);}
"parallel_enable" {return tt.getKeywordTokenType(279);}
"parameters" {return tt.getKeywordTokenType(280);}
"parent" {return tt.getKeywordTokenType(281);}
"partition" {return tt.getKeywordTokenType(282);}
"passing" {return tt.getKeywordTokenType(283);}
"path" {return tt.getKeywordTokenType(284);}
"pctfree" {return tt.getKeywordTokenType(285);}
"percent" {return tt.getKeywordTokenType(286);}
"phi_coefficient" {return tt.getKeywordTokenType(287);}
"pipe" {return tt.getKeywordTokenType(288);}
"pipelined" {return tt.getKeywordTokenType(289);}
"pivot" {return tt.getKeywordTokenType(290);}
"pluggable" {return tt.getKeywordTokenType(291);}
"positive" {return tt.getKeywordTokenType(292);}
"positiven" {return tt.getKeywordTokenType(293);}
"power" {return tt.getKeywordTokenType(294);}
"pragma" {return tt.getKeywordTokenType(295);}
"preceding" {return tt.getKeywordTokenType(296);}
"precedes" {return tt.getKeywordTokenType(297);}
"present" {return tt.getKeywordTokenType(298);}
"pretty" {return tt.getKeywordTokenType(299);}
"prior" {return tt.getKeywordTokenType(300);}
"private" {return tt.getKeywordTokenType(301);}
"procedure" {return tt.getKeywordTokenType(302);}
"public" {return tt.getKeywordTokenType(303);}
"raise" {return tt.getKeywordTokenType(304);}
"range" {return tt.getKeywordTokenType(305);}
"read" {return tt.getKeywordTokenType(306);}
"record" {return tt.getKeywordTokenType(307);}
"ref" {return tt.getKeywordTokenType(308);}
"reference" {return tt.getKeywordTokenType(309);}
"referencing" {return tt.getKeywordTokenType(310);}
"regexp_like" {return tt.getKeywordTokenType(311);}
"reject" {return tt.getKeywordTokenType(312);}
"release" {return tt.getKeywordTokenType(313);}
"relies_on" {return tt.getKeywordTokenType(314);}
"remainder" {return tt.getKeywordTokenType(315);}
"rename" {return tt.getKeywordTokenType(316);}
"replace" {return tt.getKeywordTokenType(317);}
"restrict_references" {return tt.getKeywordTokenType(318);}
"result" {return tt.getKeywordTokenType(319);}
"result_cache" {return tt.getKeywordTokenType(320);}
"return" {return tt.getKeywordTokenType(321);}
"returning" {return tt.getKeywordTokenType(322);}
"reverse" {return tt.getKeywordTokenType(323);}
"revoke" {return tt.getKeywordTokenType(324);}
"right" {return tt.getKeywordTokenType(325);}
"rnds" {return tt.getKeywordTokenType(326);}
"rnps" {return tt.getKeywordTokenType(327);}
"rollback" {return tt.getKeywordTokenType(328);}
"rollup" {return tt.getKeywordTokenType(329);}
"row" {return tt.getKeywordTokenType(330);}
"rowcount" {return tt.getKeywordTokenType(331);}
"rownum" {return tt.getKeywordTokenType(332);}
"rows" {return tt.getKeywordTokenType(333);}
"rowtype" {return tt.getKeywordTokenType(334);}
"rules" {return tt.getKeywordTokenType(335);}
"sample" {return tt.getKeywordTokenType(336);}
"save" {return tt.getKeywordTokenType(337);}
"savepoint" {return tt.getKeywordTokenType(338);}
"schema" {return tt.getKeywordTokenType(339);}
"schemacheck" {return tt.getKeywordTokenType(340);}
"scn" {return tt.getKeywordTokenType(341);}
"second" {return tt.getKeywordTokenType(342);}
"seed" {return tt.getKeywordTokenType(343);}
"segment" {return tt.getKeywordTokenType(344);}
"select" {return tt.getKeywordTokenType(345);}
"self" {return tt.getKeywordTokenType(346);}
"separate" {return tt.getKeywordTokenType(347);}
"sequential" {return tt.getKeywordTokenType(348);}
"serializable" {return tt.getKeywordTokenType(349);}
"serially_reusable" {return tt.getKeywordTokenType(350);}
"servererror" {return tt.getKeywordTokenType(351);}
"set" {return tt.getKeywordTokenType(352);}
"sets" {return tt.getKeywordTokenType(353);}
"share" {return tt.getKeywordTokenType(354);}
"sharing" {return tt.getKeywordTokenType(355);}
"show" {return tt.getKeywordTokenType(356);}
"shutdown" {return tt.getKeywordTokenType(357);}
"siblings" {return tt.getKeywordTokenType(358);}
"sig" {return tt.getKeywordTokenType(359);}
"single" {return tt.getKeywordTokenType(360);}
"size" {return tt.getKeywordTokenType(361);}
"skip" {return tt.getKeywordTokenType(362);}
"some" {return tt.getKeywordTokenType(363);}
"space" {return tt.getKeywordTokenType(364);}
"sql" {return tt.getKeywordTokenType(365);}
"sqlcode" {return tt.getKeywordTokenType(366);}
"sqlerrm" {return tt.getKeywordTokenType(367);}
"standalone" {return tt.getKeywordTokenType(368);}
"start" {return tt.getKeywordTokenType(369);}
"startup" {return tt.getKeywordTokenType(370);}
"statement" {return tt.getKeywordTokenType(371);}
"static" {return tt.getKeywordTokenType(372);}
"statistic" {return tt.getKeywordTokenType(373);}
"statistics" {return tt.getKeywordTokenType(374);}
"strict" {return tt.getKeywordTokenType(375);}
"struct" {return tt.getKeywordTokenType(376);}
"submultiset" {return tt.getKeywordTokenType(377);}
"subpartition" {return tt.getKeywordTokenType(378);}
"subtype" {return tt.getKeywordTokenType(379);}
"successful" {return tt.getKeywordTokenType(380);}
"sum_squares_between" {return tt.getKeywordTokenType(381);}
"sum_squares_within" {return tt.getKeywordTokenType(382);}
"suspend" {return tt.getKeywordTokenType(383);}
"synonym" {return tt.getKeywordTokenType(384);}
"table" {return tt.getKeywordTokenType(385);}
"tdo" {return tt.getKeywordTokenType(386);}
"then" {return tt.getKeywordTokenType(387);}
"ties" {return tt.getKeywordTokenType(388);}
"time" {return tt.getKeywordTokenType(389);}
"timezone_abbr" {return tt.getKeywordTokenType(390);}
"timezone_hour" {return tt.getKeywordTokenType(391);}
"timezone_minute" {return tt.getKeywordTokenType(392);}
"timezone_region" {return tt.getKeywordTokenType(393);}
"to" {return tt.getKeywordTokenType(394);}
"trailing" {return tt.getKeywordTokenType(395);}
"transaction" {return tt.getKeywordTokenType(396);}
"trigger" {return tt.getKeywordTokenType(397);}
"truncate" {return tt.getKeywordTokenType(398);}
"trust" {return tt.getKeywordTokenType(399);}
"two_sided_prob" {return tt.getKeywordTokenType(400);}
"two_sided_sig" {return tt.getKeywordTokenType(401);}
"type" {return tt.getKeywordTokenType(402);}
"u_statistic" {return tt.getKeywordTokenType(403);}
"unbounded" {return tt.getKeywordTokenType(404);}
"unconditional" {return tt.getKeywordTokenType(405);}
"under" {return tt.getKeywordTokenType(406);}
"under_path" {return tt.getKeywordTokenType(407);}
"union" {return tt.getKeywordTokenType(408);}
"unique" {return tt.getKeywordTokenType(409);}
"unlimited" {return tt.getKeywordTokenType(410);}
"unpivot" {return tt.getKeywordTokenType(411);}
"unplug" {return tt.getKeywordTokenType(412);}
"until" {return tt.getKeywordTokenType(413);}
"update" {return tt.getKeywordTokenType(414);}
"updated" {return tt.getKeywordTokenType(415);}
"updating" {return tt.getKeywordTokenType(416);}
"upsert" {return tt.getKeywordTokenType(417);}
"use" {return tt.getKeywordTokenType(418);}
"user" {return tt.getKeywordTokenType(419);}
"using" {return tt.getKeywordTokenType(420);}
"validate" {return tt.getKeywordTokenType(421);}
"value" {return tt.getKeywordTokenType(422);}
"values" {return tt.getKeywordTokenType(423);}
"variable" {return tt.getKeywordTokenType(424);}
"varray" {return tt.getKeywordTokenType(425);}
"varying" {return tt.getKeywordTokenType(426);}
"version" {return tt.getKeywordTokenType(427);}
"versions" {return tt.getKeywordTokenType(428);}
"view" {return tt.getKeywordTokenType(429);}
"wait" {return tt.getKeywordTokenType(430);}
"wellformed" {return tt.getKeywordTokenType(431);}
"when" {return tt.getKeywordTokenType(432);}
"whenever" {return tt.getKeywordTokenType(433);}
"where" {return tt.getKeywordTokenType(434);}
"while" {return tt.getKeywordTokenType(435);}
"with" {return tt.getKeywordTokenType(436);}
"within" {return tt.getKeywordTokenType(437);}
"without" {return tt.getKeywordTokenType(438);}
"wnds" {return tt.getKeywordTokenType(439);}
"wnps" {return tt.getKeywordTokenType(440);}
"work" {return tt.getKeywordTokenType(441);}
"write" {return tt.getKeywordTokenType(442);}
"wrapped" {return tt.getKeywordTokenType(443);}
"wrapper" {return tt.getKeywordTokenType(444);}
"xml" {return tt.getKeywordTokenType(445);}
"xmlnamespaces" {return tt.getKeywordTokenType(446);}
"year" {return tt.getKeywordTokenType(447);}
"yes" {return tt.getKeywordTokenType(448);}
"zone" {return tt.getKeywordTokenType(449);}
"false" {return tt.getKeywordTokenType(450);}
"true" {return tt.getKeywordTokenType(451);}
