...
public class FilterConditionRemoveAction extends AbstractObjectFilterAction {

    public FilterConditionRemoveAction(ObjectNameFilterSettingsForm settingsForm) {
