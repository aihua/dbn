...
"json_object" {return tt.getFunctionTokenType(69);}
"json_table" {return tt.getFunctionTokenType(70);}
"lag" {return tt.getFunctionTokenType(71);}
"last_day" {return tt.getFunctionTokenType(72);}
"last_value" {return tt.getFunctionTokenType(73);}
"lateral" {return tt.getFunctionTokenType(74);}
"lead" {return tt.getFunctionTokenType(75);}
"least" {return tt.getFunctionTokenType(76);}
"length" {return tt.getFunctionTokenType(77);}
"length2" {return tt.getFunctionTokenType(78);}
"length4" {return tt.getFunctionTokenType(79);}
"lengthb" {return tt.getFunctionTokenType(80);}
"lengthc" {return tt.getFunctionTokenType(81);}
"listagg" {return tt.getFunctionTokenType(82);}
"ln" {return tt.getFunctionTokenType(83);}
"lnnvl" {return tt.getFunctionTokenType(84);}
"localtimestamp" {return tt.getFunctionTokenType(85);}
"lower" {return tt.getFunctionTokenType(86);}
"lpad" {return tt.getFunctionTokenType(87);}
"ltrim" {return tt.getFunctionTokenType(88);}
"make_ref" {return tt.getFunctionTokenType(89);}
"max" {return tt.getFunctionTokenType(90);}
"median" {return tt.getFunctionTokenType(91);}
"min" {return tt.getFunctionTokenType(92);}
"mod" {return tt.getFunctionTokenType(93);}
"months_between" {return tt.getFunctionTokenType(94);}
"nanvl" {return tt.getFunctionTokenType(95);}
"nchr" {return tt.getFunctionTokenType(96);}
"new_time" {return tt.getFunctionTokenType(97);}
"next_day" {return tt.getFunctionTokenType(98);}
"nls_charset_decl_len" {return tt.getFunctionTokenType(99);}
"nls_charset_id" {return tt.getFunctionTokenType(100);}
"nls_charset_name" {return tt.getFunctionTokenType(101);}
"nls_initcap" {return tt.getFunctionTokenType(102);}
"nls_lower" {return tt.getFunctionTokenType(103);}
"nls_upper" {return tt.getFunctionTokenType(104);}
"nlssort" {return tt.getFunctionTokenType(105);}
"ntile" {return tt.getFunctionTokenType(106);}
"nullif" {return tt.getFunctionTokenType(107);}
"numtodsinterval" {return tt.getFunctionTokenType(108);}
"numtoyminterval" {return tt.getFunctionTokenType(109);}
"nvl" {return tt.getFunctionTokenType(110);}
"nvl2" {return tt.getFunctionTokenType(111);}
"ora_hash" {return tt.getFunctionTokenType(112);}
"percent_rank" {return tt.getFunctionTokenType(113);}
"percentile_cont" {return tt.getFunctionTokenType(114);}
"percentile_disc" {return tt.getFunctionTokenType(115);}
"powermultiset" {return tt.getFunctionTokenType(116);}
"powermultiset_by_cardinality" {return tt.getFunctionTokenType(117);}
"presentnnv" {return tt.getFunctionTokenType(118);}
"presentv" {return tt.getFunctionTokenType(119);}
"previous" {return tt.getFunctionTokenType(120);}
"rank" {return tt.getFunctionTokenType(121);}
"ratio_to_report" {return tt.getFunctionTokenType(122);}
"rawtohex" {return tt.getFunctionTokenType(123);}
"rawtonhex" {return tt.getFunctionTokenType(124);}
"reftohex" {return tt.getFunctionTokenType(125);}
"regexp_instr" {return tt.getFunctionTokenType(126);}
"regexp_replace" {return tt.getFunctionTokenType(127);}
"regexp_substr" {return tt.getFunctionTokenType(128);}
"regr_avgx" {return tt.getFunctionTokenType(129);}
"regr_avgy" {return tt.getFunctionTokenType(130);}
"regr_count" {return tt.getFunctionTokenType(131);}
"regr_intercept" {return tt.getFunctionTokenType(132);}
"regr_r2" {return tt.getFunctionTokenType(133);}
"regr_slope" {return tt.getFunctionTokenType(134);}
"regr_sxx" {return tt.getFunctionTokenType(135);}
"regr_sxy" {return tt.getFunctionTokenType(136);}
"regr_syy" {return tt.getFunctionTokenType(137);}
"round" {return tt.getFunctionTokenType(138);}
"row_number" {return tt.getFunctionTokenType(139);}
"rowidtochar" {return tt.getFunctionTokenType(140);}
"rowidtonchar" {return tt.getFunctionTokenType(141);}
"rpad" {return tt.getFunctionTokenType(142);}
"rtrim" {return tt.getFunctionTokenType(143);}
"scn_to_timestamp" {return tt.getFunctionTokenType(144);}
"sessiontimezone" {return tt.getFunctionTokenType(145);}
"sign" {return tt.getFunctionTokenType(146);}
"sin" {return tt.getFunctionTokenType(147);}
"sinh" {return tt.getFunctionTokenType(148);}
"soundex" {return tt.getFunctionTokenType(149);}
"sqrt" {return tt.getFunctionTokenType(150);}
"stats_binomial_test" {return tt.getFunctionTokenType(151);}
"stats_crosstab" {return tt.getFunctionTokenType(152);}
"stats_f_test" {return tt.getFunctionTokenType(153);}
"stats_ks_test" {return tt.getFunctionTokenType(154);}
"stats_mode" {return tt.getFunctionTokenType(155);}
"stats_mw_test" {return tt.getFunctionTokenType(156);}
"stats_one_way_anova" {return tt.getFunctionTokenType(157);}
"stats_t_test_indep" {return tt.getFunctionTokenType(158);}
"stats_t_test_indepu" {return tt.getFunctionTokenType(159);}
"stats_t_test_one" {return tt.getFunctionTokenType(160);}
"stats_t_test_paired" {return tt.getFunctionTokenType(161);}
"stats_wsr_test" {return tt.getFunctionTokenType(162);}
"stddev" {return tt.getFunctionTokenType(163);}
"stddev_pop" {return tt.getFunctionTokenType(164);}
"stddev_samp" {return tt.getFunctionTokenType(165);}
"substr" {return tt.getFunctionTokenType(166);}
"substr2" {return tt.getFunctionTokenType(167);}
"substr4" {return tt.getFunctionTokenType(168);}
"substrb" {return tt.getFunctionTokenType(169);}
"substrc" {return tt.getFunctionTokenType(170);}
"sum" {return tt.getFunctionTokenType(171);}
"sys_connect_by_path" {return tt.getFunctionTokenType(172);}
"sys_context" {return tt.getFunctionTokenType(173);}
"sys_dburigen" {return tt.getFunctionTokenType(174);}
"sys_extract_utc" {return tt.getFunctionTokenType(175);}
"sys_guid" {return tt.getFunctionTokenType(176);}
"sys_typeid" {return tt.getFunctionTokenType(177);}
"sys_xmlagg" {return tt.getFunctionTokenType(178);}
"sys_xmlgen" {return tt.getFunctionTokenType(179);}
"sysdate" {return tt.getFunctionTokenType(180);}
"systimestamp" {return tt.getFunctionTokenType(181);}
"tan" {return tt.getFunctionTokenType(182);}
"tanh" {return tt.getFunctionTokenType(183);}
"timestamp_to_scn" {return tt.getFunctionTokenType(184);}
"to_binary_double" {return tt.getFunctionTokenType(185);}
"to_binary_float" {return tt.getFunctionTokenType(186);}
"to_char" {return tt.getFunctionTokenType(187);}
"to_clob" {return tt.getFunctionTokenType(188);}
"to_date" {return tt.getFunctionTokenType(189);}
"to_dsinterval" {return tt.getFunctionTokenType(190);}
"to_lob" {return tt.getFunctionTokenType(191);}
"to_multi_byte" {return tt.getFunctionTokenType(192);}
"to_nchar" {return tt.getFunctionTokenType(193);}
"to_nclob" {return tt.getFunctionTokenType(194);}
"to_number" {return tt.getFunctionTokenType(195);}
"to_single_byte" {return tt.getFunctionTokenType(196);}
"to_timestamp" {return tt.getFunctionTokenType(197);}
"to_timestamp_tz" {return tt.getFunctionTokenType(198);}
"to_yminterval" {return tt.getFunctionTokenType(199);}
"translate" {return tt.getFunctionTokenType(200);}
"treat" {return tt.getFunctionTokenType(201);}
"trim" {return tt.getFunctionTokenType(202);}
"trunc" {return tt.getFunctionTokenType(203);}
"tz_offset" {return tt.getFunctionTokenType(204);}
"unistr" {return tt.getFunctionTokenType(205);}
"updatexml" {return tt.getFunctionTokenType(206);}
"upper" {return tt.getFunctionTokenType(207);}
"userenv" {return tt.getFunctionTokenType(208);}
"value" {return tt.getFunctionTokenType(209);}
...
"xmlattributes" {return tt.getFunctionTokenType(216);}
"xmlcast" {return tt.getFunctionTokenType(217);}
"xmlcdata" {return tt.getFunctionTokenType(218);}
"xmlcolattval" {return tt.getFunctionTokenType(219);}
"xmlcomment" {return tt.getFunctionTokenType(220);}
"xmlconcat" {return tt.getFunctionTokenType(221);}
"xmldiff" {return tt.getFunctionTokenType(222);}
"xmlelement" {return tt.getFunctionTokenType(223);}
"xmlforest" {return tt.getFunctionTokenType(224);}
"xmlisvalid" {return tt.getFunctionTokenType(225);}
"xmlparse" {return tt.getFunctionTokenType(226);}
"xmlpatch" {return tt.getFunctionTokenType(227);}
"xmlpi" {return tt.getFunctionTokenType(228);}
"xmlquery" {return tt.getFunctionTokenType(229);}
"xmlroot" {return tt.getFunctionTokenType(230);}
"xmlsequence" {return tt.getFunctionTokenType(231);}
"xmlserialize" {return tt.getFunctionTokenType(232);}
"xmltable" {return tt.getFunctionTokenType(233);}
"xmltransform" {return tt.getFunctionTokenType(234);}
