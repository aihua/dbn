...
PSQL_BLOCK_END_IGNORE = "end"{ws}("if"|"loop")({ws}({IDENTIFIER}|{QUOTED_IDENTIFIER}))*{wso}";"
...
<YYINITIAL> {
    ...
    "exceptions" {return tt.getKeywordTokenType(166);}
    "exchange" {return tt.getKeywordTokenType(167);}
    "exclude" {return tt.getKeywordTokenType(168);}
    "excluding" {return tt.getKeywordTokenType(169);}
    "exclusive" {return tt.getKeywordTokenType(170);}
    "execute" {return tt.getKeywordTokenType(171);}
    "exempt" {return tt.getKeywordTokenType(172);}
    "exists" {return tt.getKeywordTokenType(173);}
    "expire" {return tt.getKeywordTokenType(174);}
    "explain" {return tt.getKeywordTokenType(175);}
    "export" {return tt.getKeywordTokenType(176);}
    "extent" {return tt.getKeywordTokenType(177);}
    "external" {return tt.getKeywordTokenType(178);}
    "externally" {return tt.getKeywordTokenType(179);}
    "f_ratio" {return tt.getKeywordTokenType(180);}
    "failed" {return tt.getKeywordTokenType(181);}
    "failgroup" {return tt.getKeywordTokenType(182);}
    "fast" {return tt.getKeywordTokenType(183);}
    "file" {return tt.getKeywordTokenType(184);}
    "fine" {return tt.getKeywordTokenType(185);}
    "finish" {return tt.getKeywordTokenType(186);}
    "first" {return tt.getKeywordTokenType(187);}
    "flashback" {return tt.getKeywordTokenType(188);}
    "flush" {return tt.getKeywordTokenType(189);}
    "folder" {return tt.getKeywordTokenType(190);}
    "following" {return tt.getKeywordTokenType(191);}
    "for" {return tt.getKeywordTokenType(192);}
    "force" {return tt.getKeywordTokenType(193);}
    "foreign" {return tt.getKeywordTokenType(194);}
    "freelist" {return tt.getKeywordTokenType(195);}
    "freelists" {return tt.getKeywordTokenType(196);}
    "freepools" {return tt.getKeywordTokenType(197);}
    "fresh" {return tt.getKeywordTokenType(198);}
    "from" {return tt.getKeywordTokenType(199);}
    "full" {return tt.getKeywordTokenType(200);}
    "function" {return tt.getKeywordTokenType(201);}
    "global" {return tt.getKeywordTokenType(202);}
    "global_name" {return tt.getKeywordTokenType(203);}
    "globally" {return tt.getKeywordTokenType(204);}
    "grant" {return tt.getKeywordTokenType(205);}
    "group" {return tt.getKeywordTokenType(206);}
    "groups" {return tt.getKeywordTokenType(207);}
    "guard" {return tt.getKeywordTokenType(208);}
    "hash" {return tt.getKeywordTokenType(209);}
    "having" {return tt.getKeywordTokenType(210);}
    "hide" {return tt.getKeywordTokenType(211);}
    "hierarchy" {return tt.getKeywordTokenType(212);}
    "history" {return tt.getKeywordTokenType(213);}
    "hour" {return tt.getKeywordTokenType(214);}
    "id" {return tt.getKeywordTokenType(215);}
    "identified" {return tt.getKeywordTokenType(216);}
    "identifier" {return tt.getKeywordTokenType(217);}
    "ignore" {return tt.getKeywordTokenType(218);}
    "immediate" {return tt.getKeywordTokenType(219);}
    "import" {return tt.getKeywordTokenType(220);}
    "in" {return tt.getKeywordTokenType(221);}
    "include" {return tt.getKeywordTokenType(222);}
    "including" {return tt.getKeywordTokenType(223);}
    "increment" {return tt.getKeywordTokenType(224);}
    "indent" {return tt.getKeywordTokenType(225);}
    "index" {return tt.getKeywordTokenType(226);}
    "indexes" {return tt.getKeywordTokenType(227);}
    "indextype" {return tt.getKeywordTokenType(228);}
    "infinite" {return tt.getKeywordTokenType(229);}
    "initial" {return tt.getKeywordTokenType(230);}
    "initially" {return tt.getKeywordTokenType(231);}
    "initrans" {return tt.getKeywordTokenType(232);}
    "inner" {return tt.getKeywordTokenType(233);}
    "insert" {return tt.getKeywordTokenType(234);}
    "instance" {return tt.getKeywordTokenType(235);}
    "intermediate" {return tt.getKeywordTokenType(236);}
    "intersect" {return tt.getKeywordTokenType(237);}
    "into" {return tt.getKeywordTokenType(238);}
    "invalidate" {return tt.getKeywordTokenType(239);}
    "is" {return tt.getKeywordTokenType(240);}
    "iterate" {return tt.getKeywordTokenType(241);}
    "java" {return tt.getKeywordTokenType(242);}
    "job" {return tt.getKeywordTokenType(243);}
    "join" {return tt.getKeywordTokenType(244);}
    "keep" {return tt.getKeywordTokenType(245);}
    "key" {return tt.getKeywordTokenType(246);}
    "kill" {return tt.getKeywordTokenType(247);}
    "last" {return tt.getKeywordTokenType(248);}
    "leading" {return tt.getKeywordTokenType(249);}
    "left" {return tt.getKeywordTokenType(250);}
    "less" {return tt.getKeywordTokenType(251);}
    "level" {return tt.getKeywordTokenType(252);}
    "levels" {return tt.getKeywordTokenType(253);}
    "library" {return tt.getKeywordTokenType(254);}
    "like" {return tt.getKeywordTokenType(255);}
    "like2" {return tt.getKeywordTokenType(256);}
    "like4" {return tt.getKeywordTokenType(257);}
    "likec" {return tt.getKeywordTokenType(258);}
    "limit" {return tt.getKeywordTokenType(259);}
    "link" {return tt.getKeywordTokenType(260);}
    "lob" {return tt.getKeywordTokenType(261);}
    "local" {return tt.getKeywordTokenType(262);}
    "locator" {return tt.getKeywordTokenType(263);}
    "lock" {return tt.getKeywordTokenType(264);}
    "log" {return tt.getKeywordTokenType(265);}
    "logfile" {return tt.getKeywordTokenType(266);}
    "logging" {return tt.getKeywordTokenType(267);}
    "logical" {return tt.getKeywordTokenType(268);}
    "main" {return tt.getKeywordTokenType(269);}
    "manage" {return tt.getKeywordTokenType(270);}
    "managed" {return tt.getKeywordTokenType(271);}
    "manager" {return tt.getKeywordTokenType(272);}
    "management" {return tt.getKeywordTokenType(273);}
    "manual" {return tt.getKeywordTokenType(274);}
    "mapping" {return tt.getKeywordTokenType(275);}
    "master" {return tt.getKeywordTokenType(276);}
    "matched" {return tt.getKeywordTokenType(277);}
    "materialized" {return tt.getKeywordTokenType(278);}
    "maxextents" {return tt.getKeywordTokenType(279);}
    "maximize" {return tt.getKeywordTokenType(280);}
    "maxsize" {return tt.getKeywordTokenType(281);}
    "maxvalue" {return tt.getKeywordTokenType(282);}
    "mean_squares_between" {return tt.getKeywordTokenType(283);}
    "mean_squares_within" {return tt.getKeywordTokenType(284);}
    "measure" {return tt.getKeywordTokenType(285);}
    "measures" {return tt.getKeywordTokenType(286);}
    "member" {return tt.getKeywordTokenType(287);}
    "memory" {return tt.getKeywordTokenType(288);}
    "merge" {return tt.getKeywordTokenType(289);}
    "minextents" {return tt.getKeywordTokenType(290);}
    "mining" {return tt.getKeywordTokenType(291);}
    "minus" {return tt.getKeywordTokenType(292);}
    "minute" {return tt.getKeywordTokenType(293);}
    "minutes" {return tt.getKeywordTokenType(294);}
    "minvalue" {return tt.getKeywordTokenType(295);}
    "mirror" {return tt.getKeywordTokenType(296);}
    "mlslabel" {return tt.getKeywordTokenType(297);}
    "mode" {return tt.getKeywordTokenType(298);}
    "model" {return tt.getKeywordTokenType(299);}
    "modify" {return tt.getKeywordTokenType(300);}
    "monitoring" {return tt.getKeywordTokenType(301);}
    "month" {return tt.getKeywordTokenType(302);}
    "mount" {return tt.getKeywordTokenType(303);}
    "move" {return tt.getKeywordTokenType(304);}
    "multiset" {return tt.getKeywordTokenType(305);}
    "name" {return tt.getKeywordTokenType(306);}
    "nan" {return tt.getKeywordTokenType(307);}
    "natural" {return tt.getKeywordTokenType(308);}
    "nav" {return tt.getKeywordTokenType(309);}
    "nchar_cs" {return tt.getKeywordTokenType(310);}
    "nested" {return tt.getKeywordTokenType(311);}
    "new" {return tt.getKeywordTokenType(312);}
    "next" {return tt.getKeywordTokenType(313);}
    "nextval" {return tt.getKeywordTokenType(314);}
    "no" {return tt.getKeywordTokenType(315);}
    "noarchivelog" {return tt.getKeywordTokenType(316);}
    "noaudit" {return tt.getKeywordTokenType(317);}
    "nocache" {return tt.getKeywordTokenType(318);}
    "nocompress" {return tt.getKeywordTokenType(319);}
    "nocycle" {return tt.getKeywordTokenType(320);}
    "nodelay" {return tt.getKeywordTokenType(321);}
    "noentityescaping" {return tt.getKeywordTokenType(322);}
    "noforce" {return tt.getKeywordTokenType(323);}
    "nologging" {return tt.getKeywordTokenType(324);}
    "nomapping" {return tt.getKeywordTokenType(325);}
    "nomaxvalue" {return tt.getKeywordTokenType(326);}
    "nominvalue" {return tt.getKeywordTokenType(327);}
    "nomonitoring" {return tt.getKeywordTokenType(328);}
    "none" {return tt.getKeywordTokenType(329);}
    "noorder" {return tt.getKeywordTokenType(330);}
    "noparallel" {return tt.getKeywordTokenType(331);}
    "norely" {return tt.getKeywordTokenType(332);}
    "norepair" {return tt.getKeywordTokenType(333);}
    "noresetlogs" {return tt.getKeywordTokenType(334);}
    "noreverse" {return tt.getKeywordTokenType(335);}
    "noschemacheck" {return tt.getKeywordTokenType(336);}
    "noswitch" {return tt.getKeywordTokenType(337);}
    "not" {return tt.getKeywordTokenType(338);}
    "nothing" {return tt.getKeywordTokenType(339);}
    "notification" {return tt.getKeywordTokenType(340);}
    "notimeout" {return tt.getKeywordTokenType(341);}
    "novalidate" {return tt.getKeywordTokenType(342);}
    "nowait" {return tt.getKeywordTokenType(343);}
    "null" {return tt.getKeywordTokenType(344);}
    "nulls" {return tt.getKeywordTokenType(345);}
    "object" {return tt.getKeywordTokenType(346);}
    "of" {return tt.getKeywordTokenType(347);}
    "off" {return tt.getKeywordTokenType(348);}
    "offline" {return tt.getKeywordTokenType(349);}
    "on" {return tt.getKeywordTokenType(350);}
    "one_sided_prob_or_less" {return tt.getKeywordTokenType(351);}
    "one_sided_prob_or_more" {return tt.getKeywordTokenType(352);}
    "one_sided_sig" {return tt.getKeywordTokenType(353);}
    "online" {return tt.getKeywordTokenType(354);}
    "only" {return tt.getKeywordTokenType(355);}
    "open" {return tt.getKeywordTokenType(356);}
    "operator" {return tt.getKeywordTokenType(357);}
    "optimal" {return tt.getKeywordTokenType(358);}
    "option" {return tt.getKeywordTokenType(359);}
    "or" {return tt.getKeywordTokenType(360);}
    "order" {return tt.getKeywordTokenType(361);}
    "ordinality" {return tt.getKeywordTokenType(362);}
    "outer" {return tt.getKeywordTokenType(363);}
    "outline" {return tt.getKeywordTokenType(364);}
    "over" {return tt.getKeywordTokenType(365);}
    "overflow" {return tt.getKeywordTokenType(366);}
    "package" {return tt.getKeywordTokenType(367);}
    "parallel" {return tt.getKeywordTokenType(368);}
    "parameters" {return tt.getKeywordTokenType(369);}
    "partition" {return tt.getKeywordTokenType(370);}
    "partitions" {return tt.getKeywordTokenType(371);}
    "passing" {return tt.getKeywordTokenType(372);}
    "path" {return tt.getKeywordTokenType(373);}
    "pctfree" {return tt.getKeywordTokenType(374);}
    "pctincrease" {return tt.getKeywordTokenType(375);}
    "pctthreshold" {return tt.getKeywordTokenType(376);}
    "pctused" {return tt.getKeywordTokenType(377);}
    "pctversion" {return tt.getKeywordTokenType(378);}
    "performance" {return tt.getKeywordTokenType(379);}
    "phi_coefficient" {return tt.getKeywordTokenType(380);}
    "physical" {return tt.getKeywordTokenType(381);}
    "pivot" {return tt.getKeywordTokenType(382);}
    "plan" {return tt.getKeywordTokenType(383);}
    "policy" {return tt.getKeywordTokenType(384);}
    "post_transaction" {return tt.getKeywordTokenType(385);}
    "power" {return tt.getKeywordTokenType(386);}
    "preceding" {return tt.getKeywordTokenType(387);}
    "prepare" {return tt.getKeywordTokenType(388);}
    "present" {return tt.getKeywordTokenType(389);}
    "preserve" {return tt.getKeywordTokenType(390);}
    "primary" {return tt.getKeywordTokenType(391);}
    "prior" {return tt.getKeywordTokenType(392);}
    "private" {return tt.getKeywordTokenType(393);}
    "privilege" {return tt.getKeywordTokenType(394);}
    "privileges" {return tt.getKeywordTokenType(395);}
    "procedure" {return tt.getKeywordTokenType(396);}
    "process" {return tt.getKeywordTokenType(397);}
    "profile" {return tt.getKeywordTokenType(398);}
    "program" {return tt.getKeywordTokenType(399);}
    "protection" {return tt.getKeywordTokenType(400);}
    "public" {return tt.getKeywordTokenType(401);}
    "purge" {return tt.getKeywordTokenType(402);}
    "query" {return tt.getKeywordTokenType(403);}
    "queue" {return tt.getKeywordTokenType(404);}
    "quiesce" {return tt.getKeywordTokenType(405);}
    "range" {return tt.getKeywordTokenType(406);}
    "read" {return tt.getKeywordTokenType(407);}
    "reads" {return tt.getKeywordTokenType(408);}
    "rebalance" {return tt.getKeywordTokenType(409);}
    "rebuild" {return tt.getKeywordTokenType(410);}
    "recover" {return tt.getKeywordTokenType(411);}
    "recovery" {return tt.getKeywordTokenType(412);}
    "recycle" {return tt.getKeywordTokenType(413);}
    "ref" {return tt.getKeywordTokenType(414);}
    "reference" {return tt.getKeywordTokenType(415);}
    "references" {return tt.getKeywordTokenType(416);}
    "refresh" {return tt.getKeywordTokenType(417);}
    "regexp_like" {return tt.getKeywordTokenType(418);}
    "register" {return tt.getKeywordTokenType(419);}
    "reject" {return tt.getKeywordTokenType(420);}
    "rely" {return tt.getKeywordTokenType(421);}
    "remainder" {return tt.getKeywordTokenType(422);}
    "rename" {return tt.getKeywordTokenType(423);}
    "repair" {return tt.getKeywordTokenType(424);}
    "replace" {return tt.getKeywordTokenType(425);}
    "reset" {return tt.getKeywordTokenType(426);}
    "resetlogs" {return tt.getKeywordTokenType(427);}
    "resize" {return tt.getKeywordTokenType(428);}
    "resolve" {return tt.getKeywordTokenType(429);}
    "resolver" {return tt.getKeywordTokenType(430);}
    "resource" {return tt.getKeywordTokenType(431);}
    "restrict" {return tt.getKeywordTokenType(432);}
    "restricted" {return tt.getKeywordTokenType(433);}
    "resumable" {return tt.getKeywordTokenType(434);}
    "resume" {return tt.getKeywordTokenType(435);}
    "retention" {return tt.getKeywordTokenType(436);}
    "return" {return tt.getKeywordTokenType(437);}
    "returning" {return tt.getKeywordTokenType(438);}
    "reuse" {return tt.getKeywordTokenType(439);}
    "reverse" {return tt.getKeywordTokenType(440);}
    "revoke" {return tt.getKeywordTokenType(441);}
    "rewrite" {return tt.getKeywordTokenType(442);}
    "right" {return tt.getKeywordTokenType(443);}
    "role" {return tt.getKeywordTokenType(444);}
    "rollback" {return tt.getKeywordTokenType(445);}
    "rollup" {return tt.getKeywordTokenType(446);}
    "row" {return tt.getKeywordTokenType(447);}
    "rownum" {return tt.getKeywordTokenType(448);}
    "rows" {return tt.getKeywordTokenType(449);}
    "rule" {return tt.getKeywordTokenType(450);}
    "rules" {return tt.getKeywordTokenType(451);}
    "salt" {return tt.getKeywordTokenType(452);}
    "sample" {return tt.getKeywordTokenType(453);}
    "savepoint" {return tt.getKeywordTokenType(454);}
    "scan" {return tt.getKeywordTokenType(455);}
    "scheduler" {return tt.getKeywordTokenType(456);}
    "schemacheck" {return tt.getKeywordTokenType(457);}
    "scn" {return tt.getKeywordTokenType(458);}
    "scope" {return tt.getKeywordTokenType(459);}
    "second" {return tt.getKeywordTokenType(460);}
    "seed" {return tt.getKeywordTokenType(461);}
    "segment" {return tt.getKeywordTokenType(462);}
    "select" {return tt.getKeywordTokenType(463);}
    "sequence" {return tt.getKeywordTokenType(464);}
    "sequential" {return tt.getKeywordTokenType(465);}
    "serializable" {return tt.getKeywordTokenType(466);}
    "session" {return tt.getKeywordTokenType(467);}
    "set" {return tt.getKeywordTokenType(468);}
    "sets" {return tt.getKeywordTokenType(469);}
    "settings" {return tt.getKeywordTokenType(470);}
    "share" {return tt.getKeywordTokenType(471);}
    "shared_pool" {return tt.getKeywordTokenType(472);}
    "show" {return tt.getKeywordTokenType(473);}
    "shrink" {return tt.getKeywordTokenType(474);}
    "shutdown" {return tt.getKeywordTokenType(475);}
    "siblings" {return tt.getKeywordTokenType(476);}
    "sid" {return tt.getKeywordTokenType(477);}
    "sig" {return tt.getKeywordTokenType(478);}
    "single" {return tt.getKeywordTokenType(479);}
    "size" {return tt.getKeywordTokenType(480);}
    "skip" {return tt.getKeywordTokenType(481);}
    "smallfile" {return tt.getKeywordTokenType(482);}
    "some" {return tt.getKeywordTokenType(483);}
    "sort" {return tt.getKeywordTokenType(484);}
    "source" {return tt.getKeywordTokenType(485);}
    "space" {return tt.getKeywordTokenType(486);}
    "specification" {return tt.getKeywordTokenType(487);}
    "spfile" {return tt.getKeywordTokenType(488);}
    "split" {return tt.getKeywordTokenType(489);}
    "sql" {return tt.getKeywordTokenType(490);}
    "standalone" {return tt.getKeywordTokenType(491);}
    "standby" {return tt.getKeywordTokenType(492);}
    "start" {return tt.getKeywordTokenType(493);}
    "statistic" {return tt.getKeywordTokenType(494);}
    "statistics" {return tt.getKeywordTokenType(495);}
    "stop" {return tt.getKeywordTokenType(496);}
    "storage" {return tt.getKeywordTokenType(497);}
    "store" {return tt.getKeywordTokenType(498);}
    "submultiset" {return tt.getKeywordTokenType(499);}
    "subpartition" {return tt.getKeywordTokenType(500);}
    "subpartitions" {return tt.getKeywordTokenType(501);}
    "substitutable" {return tt.getKeywordTokenType(502);}
    "successful" {return tt.getKeywordTokenType(503);}
    "sum_squares_between" {return tt.getKeywordTokenType(504);}
    "sum_squares_within" {return tt.getKeywordTokenType(505);}
    "supplemental" {return tt.getKeywordTokenType(506);}
    "suspend" {return tt.getKeywordTokenType(507);}
    "switch" {return tt.getKeywordTokenType(508);}
    "switchover" {return tt.getKeywordTokenType(509);}
    "synonym" {return tt.getKeywordTokenType(510);}
    "system" {return tt.getKeywordTokenType(511);}
    "table" {return tt.getKeywordTokenType(512);}
    "tables" {return tt.getKeywordTokenType(513);}
    "tablespace" {return tt.getKeywordTokenType(514);}
    "tempfile" {return tt.getKeywordTokenType(515);}
    "template" {return tt.getKeywordTokenType(516);}
    "temporary" {return tt.getKeywordTokenType(517);}
    "test" {return tt.getKeywordTokenType(518);}
    "than" {return tt.getKeywordTokenType(519);}
    "then" {return tt.getKeywordTokenType(520);}
    "thread" {return tt.getKeywordTokenType(521);}
    "through" {return tt.getKeywordTokenType(522);}
    "time" {return tt.getKeywordTokenType(523);}
    "time_zone" {return tt.getKeywordTokenType(524);}
    "timeout" {return tt.getKeywordTokenType(525);}
    "timezone_abbr" {return tt.getKeywordTokenType(526);}
    "timezone_hour" {return tt.getKeywordTokenType(527);}
    "timezone_minute" {return tt.getKeywordTokenType(528);}
    "timezone_region" {return tt.getKeywordTokenType(529);}
    "to" {return tt.getKeywordTokenType(530);}
    "trace" {return tt.getKeywordTokenType(531);}
    "tracking" {return tt.getKeywordTokenType(532);}
    "trailing" {return tt.getKeywordTokenType(533);}
    "transaction" {return tt.getKeywordTokenType(534);}
    "trigger" {return tt.getKeywordTokenType(535);}
    "truncate" {return tt.getKeywordTokenType(536);}
    "trusted" {return tt.getKeywordTokenType(537);}
    "tuning" {return tt.getKeywordTokenType(538);}
    "two_sided_prob" {return tt.getKeywordTokenType(539);}
    "two_sided_sig" {return tt.getKeywordTokenType(540);}
    "type" {return tt.getKeywordTokenType(541);}
    "u_statistic" {return tt.getKeywordTokenType(542);}
    "uid" {return tt.getKeywordTokenType(543);}
    "unarchived" {return tt.getKeywordTokenType(544);}
    "unbounded" {return tt.getKeywordTokenType(545);}
    "under" {return tt.getKeywordTokenType(546);}
    "under_path" {return tt.getKeywordTokenType(547);}
    "undrop" {return tt.getKeywordTokenType(548);}
    "union" {return tt.getKeywordTokenType(549);}
    "unique" {return tt.getKeywordTokenType(550);}
    "unlimited" {return tt.getKeywordTokenType(551);}
    "unpivot" {return tt.getKeywordTokenType(552);}
    "unprotected" {return tt.getKeywordTokenType(553);}
    "unquiesce" {return tt.getKeywordTokenType(554);}
    "unrecoverable" {return tt.getKeywordTokenType(555);}
    "until" {return tt.getKeywordTokenType(556);}
    "unusable" {return tt.getKeywordTokenType(557);}
    "unused" {return tt.getKeywordTokenType(558);}
    "update" {return tt.getKeywordTokenType(559);}
    "updated" {return tt.getKeywordTokenType(560);}
    "upgrade" {return tt.getKeywordTokenType(561);}
    "upsert" {return tt.getKeywordTokenType(562);}
    "usage" {return tt.getKeywordTokenType(563);}
    "use" {return tt.getKeywordTokenType(564);}
    "user" {return tt.getKeywordTokenType(565);}
    "using" {return tt.getKeywordTokenType(566);}
    "validate" {return tt.getKeywordTokenType(567);}
    "validation" {return tt.getKeywordTokenType(568);}
    "values" {return tt.getKeywordTokenType(569);}
    "varray" {return tt.getKeywordTokenType(570);}
    "version" {return tt.getKeywordTokenType(571);}
    "versions" {return tt.getKeywordTokenType(572);}
    "view" {return tt.getKeywordTokenType(573);}
    "wait" {return tt.getKeywordTokenType(574);}
    "wellformed" {return tt.getKeywordTokenType(575);}
    "when" {return tt.getKeywordTokenType(576);}
    "whenever" {return tt.getKeywordTokenType(577);}
    "where" {return tt.getKeywordTokenType(578);}
    "with" {return tt.getKeywordTokenType(579);}
    "within" {return tt.getKeywordTokenType(580);}
    "without" {return tt.getKeywordTokenType(581);}
    "work" {return tt.getKeywordTokenType(582);}
    "write" {return tt.getKeywordTokenType(583);}
    "xml" {return tt.getKeywordTokenType(584);}
    "xmlnamespaces" {return tt.getKeywordTokenType(585);}
    "xmlschema" {return tt.getKeywordTokenType(586);}
    "xmltype" {return tt.getKeywordTokenType(587);}
    "year" {return tt.getKeywordTokenType(588);}
    "yes" {return tt.getKeywordTokenType(589);}
    "zone" {return tt.getKeywordTokenType(590);}
    "false" {return tt.getKeywordTokenType(591);}
    "true" {return tt.getKeywordTokenType(592);}
