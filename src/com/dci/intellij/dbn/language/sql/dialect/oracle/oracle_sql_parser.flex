...
<YYINITIAL> {
    ...
    "advise" {return tt.getKeywordTokenType(6);}
    "alias" {return tt.getKeywordTokenType(7);}
    "all" {return tt.getKeywordTokenType(8);}
    "allocate" {return tt.getKeywordTokenType(9);}
    "allow" {return tt.getKeywordTokenType(10);}
    "alter" {return tt.getKeywordTokenType(11);}
    "always" {return tt.getKeywordTokenType(12);}
    "ancillary" {return tt.getKeywordTokenType(13);}
    "and" {return tt.getKeywordTokenType(14);}
    "any" {return tt.getKeywordTokenType(15);}
    "apply" {return tt.getKeywordTokenType(16);}
    "archive" {return tt.getKeywordTokenType(17);}
    "archivelog" {return tt.getKeywordTokenType(18);}
    "array" {return tt.getKeywordTokenType(19);}
    "as" {return tt.getKeywordTokenType(20);}
    "asc" {return tt.getKeywordTokenType(21);}
    "at" {return tt.getKeywordTokenType(22);}
    "attribute" {return tt.getKeywordTokenType(23);}
    "attributes" {return tt.getKeywordTokenType(24);}
    "authid" {return tt.getKeywordTokenType(25);}
    "autoextend" {return tt.getKeywordTokenType(26);}
    "automatic" {return tt.getKeywordTokenType(27);}
    "availability" {return tt.getKeywordTokenType(28);}
    "backup" {return tt.getKeywordTokenType(29);}
    "begin" {return tt.getKeywordTokenType(30);}
    "between" {return tt.getKeywordTokenType(31);}
    "bigfile" {return tt.getKeywordTokenType(32);}
    "binding" {return tt.getKeywordTokenType(33);}
    "block" {return tt.getKeywordTokenType(34);}
    "body" {return tt.getKeywordTokenType(35);}
    "both" {return tt.getKeywordTokenType(36);}
    "buffer_cache" {return tt.getKeywordTokenType(37);}
    "buffer_pool" {return tt.getKeywordTokenType(38);}
    "by" {return tt.getKeywordTokenType(39);}
    "cache" {return tt.getKeywordTokenType(40);}
    "cancel" {return tt.getKeywordTokenType(41);}
    "canonical" {return tt.getKeywordTokenType(42);}
    "cascade" {return tt.getKeywordTokenType(43);}
    "case" {return tt.getKeywordTokenType(44);}
    "category" {return tt.getKeywordTokenType(45);}
    "change" {return tt.getKeywordTokenType(46);}
    "char_cs" {return tt.getKeywordTokenType(47);}
    "check" {return tt.getKeywordTokenType(48);}
    "checkpoint" {return tt.getKeywordTokenType(49);}
    "child" {return tt.getKeywordTokenType(50);}
    "chisq_df" {return tt.getKeywordTokenType(51);}
    "chisq_obs" {return tt.getKeywordTokenType(52);}
    "chisq_sig" {return tt.getKeywordTokenType(53);}
    "chunk" {return tt.getKeywordTokenType(54);}
    "class" {return tt.getKeywordTokenType(55);}
    "clear" {return tt.getKeywordTokenType(56);}
    "clone" {return tt.getKeywordTokenType(57);}
    "close" {return tt.getKeywordTokenType(58);}
    "cluster" {return tt.getKeywordTokenType(59);}
    "coalesce" {return tt.getKeywordTokenType(60);}
    "coarse" {return tt.getKeywordTokenType(61);}
    "coefficient" {return tt.getKeywordTokenType(62);}
    "cohens_k" {return tt.getKeywordTokenType(63);}
    "column" {return tt.getKeywordTokenType(64);}
    "column_value" {return tt.getKeywordTokenType(65);}
    "columns" {return tt.getKeywordTokenType(66);}
    "comment" {return tt.getKeywordTokenType(67);}
    "commit" {return tt.getKeywordTokenType(68);}
    "committed" {return tt.getKeywordTokenType(69);}
    "compact" {return tt.getKeywordTokenType(70);}
    "compatibility" {return tt.getKeywordTokenType(71);}
    "compile" {return tt.getKeywordTokenType(72);}
    "complete" {return tt.getKeywordTokenType(73);}
    "compress" {return tt.getKeywordTokenType(74);}
    "compute" {return tt.getKeywordTokenType(75);}
    "connect" {return tt.getKeywordTokenType(76);}
    "consider" {return tt.getKeywordTokenType(77);}
    "consistent" {return tt.getKeywordTokenType(78);}
    "constraint" {return tt.getKeywordTokenType(79);}
    "constraints" {return tt.getKeywordTokenType(80);}
    "cont_coefficient" {return tt.getKeywordTokenType(81);}
    "content" {return tt.getKeywordTokenType(82);}
    "contents" {return tt.getKeywordTokenType(83);}
    "context" {return tt.getKeywordTokenType(84);}
    "continue" {return tt.getKeywordTokenType(85);}
    "controlfile" {return tt.getKeywordTokenType(86);}
    "corruption" {return tt.getKeywordTokenType(87);}
    "cost" {return tt.getKeywordTokenType(88);}
    "cramers_v" {return tt.getKeywordTokenType(89);}
    "create" {return tt.getKeywordTokenType(90);}
    "cross" {return tt.getKeywordTokenType(91);}
    "cube" {return tt.getKeywordTokenType(92);}
    "current" {return tt.getKeywordTokenType(93);}
    "current_user" {return tt.getKeywordTokenType(94);}
    "currval" {return tt.getKeywordTokenType(95);}
    "cursor" {return tt.getKeywordTokenType(96);}
    "cycle" {return tt.getKeywordTokenType(97);}
    "data" {return tt.getKeywordTokenType(98);}
    "database" {return tt.getKeywordTokenType(99);}
    "datafile" {return tt.getKeywordTokenType(100);}
    "datafiles" {return tt.getKeywordTokenType(101);}
    "day" {return tt.getKeywordTokenType(102);}
    "ddl" {return tt.getKeywordTokenType(103);}
    "deallocate" {return tt.getKeywordTokenType(104);}
    "debug" {return tt.getKeywordTokenType(105);}
    "decrement" {return tt.getKeywordTokenType(106);}
    "default" {return tt.getKeywordTokenType(107);}
    "defaults" {return tt.getKeywordTokenType(108);}
    "deferrable" {return tt.getKeywordTokenType(109);}
    "deferred" {return tt.getKeywordTokenType(110);}
    "definer" {return tt.getKeywordTokenType(111);}
    "delay" {return tt.getKeywordTokenType(112);}
    "delete" {return tt.getKeywordTokenType(113);}
    "demand" {return tt.getKeywordTokenType(114);}
    "dense_rank" {return tt.getKeywordTokenType(115);}
    "desc" {return tt.getKeywordTokenType(116);}
    "determines" {return tt.getKeywordTokenType(117);}
    "df" {return tt.getKeywordTokenType(118);}
    "df_between" {return tt.getKeywordTokenType(119);}
    "df_den" {return tt.getKeywordTokenType(120);}
    "df_num" {return tt.getKeywordTokenType(121);}
    "df_within" {return tt.getKeywordTokenType(122);}
    "dimension" {return tt.getKeywordTokenType(123);}
    "directory" {return tt.getKeywordTokenType(124);}
    "disable" {return tt.getKeywordTokenType(125);}
    "disconnect" {return tt.getKeywordTokenType(126);}
    "disk" {return tt.getKeywordTokenType(127);}
    "diskgroup" {return tt.getKeywordTokenType(128);}
    "disks" {return tt.getKeywordTokenType(129);}
    "dismount" {return tt.getKeywordTokenType(130);}
    "distinct" {return tt.getKeywordTokenType(131);}
    "distributed" {return tt.getKeywordTokenType(132);}
    "dml" {return tt.getKeywordTokenType(133);}
    "document" {return tt.getKeywordTokenType(134);}
    "downgrade" {return tt.getKeywordTokenType(135);}
    "drop" {return tt.getKeywordTokenType(136);}
    "dump" {return tt.getKeywordTokenType(137);}
    "editioning" {return tt.getKeywordTokenType(138);}
    "element" {return tt.getKeywordTokenType(139);}
    "else" {return tt.getKeywordTokenType(140);}
    "empty" {return tt.getKeywordTokenType(141);}
    "enable" {return tt.getKeywordTokenType(142);}
    "encoding" {return tt.getKeywordTokenType(143);}
    "encrypt" {return tt.getKeywordTokenType(144);}
    "end" {return tt.getKeywordTokenType(145);}
    "enforced" {return tt.getKeywordTokenType(146);}
    "entityescaping" {return tt.getKeywordTokenType(147);}
    "entry" {return tt.getKeywordTokenType(148);}
    "equals_path" {return tt.getKeywordTokenType(149);}
    "errors" {return tt.getKeywordTokenType(150);}
    "escape" {return tt.getKeywordTokenType(151);}
    "evalname" {return tt.getKeywordTokenType(152);}
    "exact_prob" {return tt.getKeywordTokenType(153);}
    "exceptions" {return tt.getKeywordTokenType(154);}
    "exchange" {return tt.getKeywordTokenType(155);}
    "exclude" {return tt.getKeywordTokenType(156);}
    "excluding" {return tt.getKeywordTokenType(157);}
    "exclusive" {return tt.getKeywordTokenType(158);}
    "exists" {return tt.getKeywordTokenType(159);}
    "expire" {return tt.getKeywordTokenType(160);}
    "explain" {return tt.getKeywordTokenType(161);}
    "extent" {return tt.getKeywordTokenType(162);}
    "externally" {return tt.getKeywordTokenType(163);}
    "f_ratio" {return tt.getKeywordTokenType(164);}
    "failed" {return tt.getKeywordTokenType(165);}
    "failgroup" {return tt.getKeywordTokenType(166);}
    "fast" {return tt.getKeywordTokenType(167);}
    "file" {return tt.getKeywordTokenType(168);}
    "fine" {return tt.getKeywordTokenType(169);}
    "finish" {return tt.getKeywordTokenType(170);}
    "first" {return tt.getKeywordTokenType(171);}
    "flashback" {return tt.getKeywordTokenType(172);}
    "flush" {return tt.getKeywordTokenType(173);}
    "following" {return tt.getKeywordTokenType(174);}
    "for" {return tt.getKeywordTokenType(175);}
    "force" {return tt.getKeywordTokenType(176);}
    "foreign" {return tt.getKeywordTokenType(177);}
    "freelist" {return tt.getKeywordTokenType(178);}
    "freelists" {return tt.getKeywordTokenType(179);}
    "freepools" {return tt.getKeywordTokenType(180);}
    "fresh" {return tt.getKeywordTokenType(181);}
    "from" {return tt.getKeywordTokenType(182);}
    "full" {return tt.getKeywordTokenType(183);}
    "function" {return tt.getKeywordTokenType(184);}
    "global" {return tt.getKeywordTokenType(185);}
    "global_name" {return tt.getKeywordTokenType(186);}
    "globally" {return tt.getKeywordTokenType(187);}
    "grant" {return tt.getKeywordTokenType(188);}
    "group" {return tt.getKeywordTokenType(189);}
    "groups" {return tt.getKeywordTokenType(190);}
    "guard" {return tt.getKeywordTokenType(191);}
    "hash" {return tt.getKeywordTokenType(192);}
    "having" {return tt.getKeywordTokenType(193);}
    "hide" {return tt.getKeywordTokenType(194);}
    "hierarchy" {return tt.getKeywordTokenType(195);}
    "history" {return tt.getKeywordTokenType(196);}
    "hour" {return tt.getKeywordTokenType(197);}
    "id" {return tt.getKeywordTokenType(198);}
    "identified" {return tt.getKeywordTokenType(199);}
    "identifier" {return tt.getKeywordTokenType(200);}
    "ignore" {return tt.getKeywordTokenType(201);}
    "immediate" {return tt.getKeywordTokenType(202);}
    "in" {return tt.getKeywordTokenType(203);}
    "include" {return tt.getKeywordTokenType(204);}
    "including" {return tt.getKeywordTokenType(205);}
    "increment" {return tt.getKeywordTokenType(206);}
    "indent" {return tt.getKeywordTokenType(207);}
    "index" {return tt.getKeywordTokenType(208);}
    "indexes" {return tt.getKeywordTokenType(209);}
    "indextype" {return tt.getKeywordTokenType(210);}
    "infinite" {return tt.getKeywordTokenType(211);}
    "initial" {return tt.getKeywordTokenType(212);}
    "initially" {return tt.getKeywordTokenType(213);}
    "initrans" {return tt.getKeywordTokenType(214);}
    "inner" {return tt.getKeywordTokenType(215);}
    "insert" {return tt.getKeywordTokenType(216);}
    "instance" {return tt.getKeywordTokenType(217);}
    "intermediate" {return tt.getKeywordTokenType(218);}
    "intersect" {return tt.getKeywordTokenType(219);}
    "into" {return tt.getKeywordTokenType(220);}
    "invalidate" {return tt.getKeywordTokenType(221);}
    "is" {return tt.getKeywordTokenType(222);}
    "iterate" {return tt.getKeywordTokenType(223);}
    "java" {return tt.getKeywordTokenType(224);}
    "join" {return tt.getKeywordTokenType(225);}
    "keep" {return tt.getKeywordTokenType(226);}
    "key" {return tt.getKeywordTokenType(227);}
    "kill" {return tt.getKeywordTokenType(228);}
    "last" {return tt.getKeywordTokenType(229);}
    "leading" {return tt.getKeywordTokenType(230);}
    "left" {return tt.getKeywordTokenType(231);}
    "less" {return tt.getKeywordTokenType(232);}
    "level" {return tt.getKeywordTokenType(233);}
    "levels" {return tt.getKeywordTokenType(234);}
    "library" {return tt.getKeywordTokenType(235);}
    "like" {return tt.getKeywordTokenType(236);}
    "like2" {return tt.getKeywordTokenType(237);}
    "like4" {return tt.getKeywordTokenType(238);}
    "likec" {return tt.getKeywordTokenType(239);}
    "limit" {return tt.getKeywordTokenType(240);}
    "link" {return tt.getKeywordTokenType(241);}
    "lob" {return tt.getKeywordTokenType(242);}
    "local" {return tt.getKeywordTokenType(243);}
    "locator" {return tt.getKeywordTokenType(244);}
    "lock" {return tt.getKeywordTokenType(245);}
    "log" {return tt.getKeywordTokenType(246);}
    "logfile" {return tt.getKeywordTokenType(247);}
    "logging" {return tt.getKeywordTokenType(248);}
    "logical" {return tt.getKeywordTokenType(249);}
    "main" {return tt.getKeywordTokenType(250);}
    "managed" {return tt.getKeywordTokenType(251);}
    "manual" {return tt.getKeywordTokenType(252);}
    "mapping" {return tt.getKeywordTokenType(253);}
    "master" {return tt.getKeywordTokenType(254);}
    "matched" {return tt.getKeywordTokenType(255);}
    "materialized" {return tt.getKeywordTokenType(256);}
    "maxextents" {return tt.getKeywordTokenType(257);}
    "maximize" {return tt.getKeywordTokenType(258);}
    "maxsize" {return tt.getKeywordTokenType(259);}
    "maxvalue" {return tt.getKeywordTokenType(260);}
    "mean_squares_between" {return tt.getKeywordTokenType(261);}
    "mean_squares_within" {return tt.getKeywordTokenType(262);}
    "measures" {return tt.getKeywordTokenType(263);}
    "member" {return tt.getKeywordTokenType(264);}
    "memory" {return tt.getKeywordTokenType(265);}
    "merge" {return tt.getKeywordTokenType(266);}
    "minextents" {return tt.getKeywordTokenType(267);}
    "minus" {return tt.getKeywordTokenType(268);}
    "minute" {return tt.getKeywordTokenType(269);}
    "minutes" {return tt.getKeywordTokenType(270);}
    "minvalue" {return tt.getKeywordTokenType(271);}
    "mirror" {return tt.getKeywordTokenType(272);}
    "mlslabel" {return tt.getKeywordTokenType(273);}
    "mode" {return tt.getKeywordTokenType(274);}
    "model" {return tt.getKeywordTokenType(275);}
    "modify" {return tt.getKeywordTokenType(276);}
    "monitoring" {return tt.getKeywordTokenType(277);}
    "month" {return tt.getKeywordTokenType(278);}
    "mount" {return tt.getKeywordTokenType(279);}
    "move" {return tt.getKeywordTokenType(280);}
    "multiset" {return tt.getKeywordTokenType(281);}
    "name" {return tt.getKeywordTokenType(282);}
    "nan" {return tt.getKeywordTokenType(283);}
    "natural" {return tt.getKeywordTokenType(284);}
    "nav" {return tt.getKeywordTokenType(285);}
    "nchar_cs" {return tt.getKeywordTokenType(286);}
    "nested" {return tt.getKeywordTokenType(287);}
    "new" {return tt.getKeywordTokenType(288);}
    "next" {return tt.getKeywordTokenType(289);}
    "nextval" {return tt.getKeywordTokenType(290);}
    "no" {return tt.getKeywordTokenType(291);}
    "noarchivelog" {return tt.getKeywordTokenType(292);}
    "noaudit" {return tt.getKeywordTokenType(293);}
    "nocache" {return tt.getKeywordTokenType(294);}
    "nocompress" {return tt.getKeywordTokenType(295);}
    "nocycle" {return tt.getKeywordTokenType(296);}
    "nodelay" {return tt.getKeywordTokenType(297);}
    "noentityescaping" {return tt.getKeywordTokenType(298);}
    "noforce" {return tt.getKeywordTokenType(299);}
    "nologging" {return tt.getKeywordTokenType(300);}
    "nomapping" {return tt.getKeywordTokenType(301);}
    "nomaxvalue" {return tt.getKeywordTokenType(302);}
    "nominvalue" {return tt.getKeywordTokenType(303);}
    "nomonitoring" {return tt.getKeywordTokenType(304);}
    "none" {return tt.getKeywordTokenType(305);}
    "noorder" {return tt.getKeywordTokenType(306);}
    "noparallel" {return tt.getKeywordTokenType(307);}
    "norely" {return tt.getKeywordTokenType(308);}
    "norepair" {return tt.getKeywordTokenType(309);}
    "noresetlogs" {return tt.getKeywordTokenType(310);}
    "noreverse" {return tt.getKeywordTokenType(311);}
    "noschemacheck" {return tt.getKeywordTokenType(312);}
    "noswitch" {return tt.getKeywordTokenType(313);}
    "not" {return tt.getKeywordTokenType(314);}
    "nothing" {return tt.getKeywordTokenType(315);}
    "notimeout" {return tt.getKeywordTokenType(316);}
    "novalidate" {return tt.getKeywordTokenType(317);}
    "nowait" {return tt.getKeywordTokenType(318);}
    "null" {return tt.getKeywordTokenType(319);}
    "nulls" {return tt.getKeywordTokenType(320);}
    "object" {return tt.getKeywordTokenType(321);}
    "of" {return tt.getKeywordTokenType(322);}
    "off" {return tt.getKeywordTokenType(323);}
    "offline" {return tt.getKeywordTokenType(324);}
    "on" {return tt.getKeywordTokenType(325);}
    "one_sided_prob_or_less" {return tt.getKeywordTokenType(326);}
    "one_sided_prob_or_more" {return tt.getKeywordTokenType(327);}
    "one_sided_sig" {return tt.getKeywordTokenType(328);}
    "online" {return tt.getKeywordTokenType(329);}
    "only" {return tt.getKeywordTokenType(330);}
    "open" {return tt.getKeywordTokenType(331);}
    "operator" {return tt.getKeywordTokenType(332);}
    "optimal" {return tt.getKeywordTokenType(333);}
    "option" {return tt.getKeywordTokenType(334);}
    "or" {return tt.getKeywordTokenType(335);}
    "order" {return tt.getKeywordTokenType(336);}
    "ordinality" {return tt.getKeywordTokenType(337);}
    "outer" {return tt.getKeywordTokenType(338);}
    "outline" {return tt.getKeywordTokenType(339);}
    "over" {return tt.getKeywordTokenType(340);}
    "overflow" {return tt.getKeywordTokenType(341);}
    "package" {return tt.getKeywordTokenType(342);}
    "parallel" {return tt.getKeywordTokenType(343);}
    "parameters" {return tt.getKeywordTokenType(344);}
    "partition" {return tt.getKeywordTokenType(345);}
    "partitions" {return tt.getKeywordTokenType(346);}
    "passing" {return tt.getKeywordTokenType(347);}
    "path" {return tt.getKeywordTokenType(348);}
    "pctfree" {return tt.getKeywordTokenType(349);}
    "pctincrease" {return tt.getKeywordTokenType(350);}
    "pctthreshold" {return tt.getKeywordTokenType(351);}
    "pctused" {return tt.getKeywordTokenType(352);}
    "pctversion" {return tt.getKeywordTokenType(353);}
    "performance" {return tt.getKeywordTokenType(354);}
    "phi_coefficient" {return tt.getKeywordTokenType(355);}
    "physical" {return tt.getKeywordTokenType(356);}
    "pivot" {return tt.getKeywordTokenType(357);}
    "plan" {return tt.getKeywordTokenType(358);}
    "post_transaction" {return tt.getKeywordTokenType(359);}
    "power" {return tt.getKeywordTokenType(360);}
    "preceding" {return tt.getKeywordTokenType(361);}
    "prepare" {return tt.getKeywordTokenType(362);}
    "present" {return tt.getKeywordTokenType(363);}
    "preserve" {return tt.getKeywordTokenType(364);}
    "primary" {return tt.getKeywordTokenType(365);}
    "prior" {return tt.getKeywordTokenType(366);}
    "private" {return tt.getKeywordTokenType(367);}
    "privileges" {return tt.getKeywordTokenType(368);}
    "procedure" {return tt.getKeywordTokenType(369);}
    "profile" {return tt.getKeywordTokenType(370);}
    "protection" {return tt.getKeywordTokenType(371);}
    "public" {return tt.getKeywordTokenType(372);}
    "purge" {return tt.getKeywordTokenType(373);}
    "query" {return tt.getKeywordTokenType(374);}
    "quiesce" {return tt.getKeywordTokenType(375);}
    "range" {return tt.getKeywordTokenType(376);}
    "read" {return tt.getKeywordTokenType(377);}
    "reads" {return tt.getKeywordTokenType(378);}
    "rebalance" {return tt.getKeywordTokenType(379);}
    "rebuild" {return tt.getKeywordTokenType(380);}
    "recover" {return tt.getKeywordTokenType(381);}
    "recovery" {return tt.getKeywordTokenType(382);}
    "recycle" {return tt.getKeywordTokenType(383);}
    "ref" {return tt.getKeywordTokenType(384);}
    "reference" {return tt.getKeywordTokenType(385);}
    "references" {return tt.getKeywordTokenType(386);}
    "refresh" {return tt.getKeywordTokenType(387);}
    "regexp_like" {return tt.getKeywordTokenType(388);}
    "register" {return tt.getKeywordTokenType(389);}
    "reject" {return tt.getKeywordTokenType(390);}
    "rely" {return tt.getKeywordTokenType(391);}
    "remainder" {return tt.getKeywordTokenType(392);}
    "rename" {return tt.getKeywordTokenType(393);}
    "repair" {return tt.getKeywordTokenType(394);}
    "replace" {return tt.getKeywordTokenType(395);}
    "reset" {return tt.getKeywordTokenType(396);}
    "resetlogs" {return tt.getKeywordTokenType(397);}
    "resize" {return tt.getKeywordTokenType(398);}
    "resolve" {return tt.getKeywordTokenType(399);}
    "resolver" {return tt.getKeywordTokenType(400);}
    "resource" {return tt.getKeywordTokenType(401);}
    "restrict" {return tt.getKeywordTokenType(402);}
    "restricted" {return tt.getKeywordTokenType(403);}
    "resumable" {return tt.getKeywordTokenType(404);}
    "resume" {return tt.getKeywordTokenType(405);}
    "retention" {return tt.getKeywordTokenType(406);}
    "return" {return tt.getKeywordTokenType(407);}
    "returning" {return tt.getKeywordTokenType(408);}
    "reuse" {return tt.getKeywordTokenType(409);}
    "reverse" {return tt.getKeywordTokenType(410);}
    "revoke" {return tt.getKeywordTokenType(411);}
    "rewrite" {return tt.getKeywordTokenType(412);}
    "right" {return tt.getKeywordTokenType(413);}
    "role" {return tt.getKeywordTokenType(414);}
    "rollback" {return tt.getKeywordTokenType(415);}
    "rollup" {return tt.getKeywordTokenType(416);}
    "row" {return tt.getKeywordTokenType(417);}
    "rownum" {return tt.getKeywordTokenType(418);}
    "rows" {return tt.getKeywordTokenType(419);}
    "rules" {return tt.getKeywordTokenType(420);}
    "salt" {return tt.getKeywordTokenType(421);}
    "sample" {return tt.getKeywordTokenType(422);}
    "savepoint" {return tt.getKeywordTokenType(423);}
    "scan" {return tt.getKeywordTokenType(424);}
    "schemacheck" {return tt.getKeywordTokenType(425);}
    "scn" {return tt.getKeywordTokenType(426);}
    "scope" {return tt.getKeywordTokenType(427);}
    "second" {return tt.getKeywordTokenType(428);}
    "seed" {return tt.getKeywordTokenType(429);}
    "segment" {return tt.getKeywordTokenType(430);}
    "select" {return tt.getKeywordTokenType(431);}
    "sequence" {return tt.getKeywordTokenType(432);}
    "sequential" {return tt.getKeywordTokenType(433);}
    "serializable" {return tt.getKeywordTokenType(434);}
    "session" {return tt.getKeywordTokenType(435);}
    "set" {return tt.getKeywordTokenType(436);}
    "sets" {return tt.getKeywordTokenType(437);}
    "settings" {return tt.getKeywordTokenType(438);}
    "share" {return tt.getKeywordTokenType(439);}
    "shared_pool" {return tt.getKeywordTokenType(440);}
    "show" {return tt.getKeywordTokenType(441);}
    "shrink" {return tt.getKeywordTokenType(442);}
    "shutdown" {return tt.getKeywordTokenType(443);}
    "siblings" {return tt.getKeywordTokenType(444);}
    "sid" {return tt.getKeywordTokenType(445);}
    "sig" {return tt.getKeywordTokenType(446);}
    "single" {return tt.getKeywordTokenType(447);}
    "size" {return tt.getKeywordTokenType(448);}
    "skip" {return tt.getKeywordTokenType(449);}
    "smallfile" {return tt.getKeywordTokenType(450);}
    "some" {return tt.getKeywordTokenType(451);}
    "sort" {return tt.getKeywordTokenType(452);}
    "source" {return tt.getKeywordTokenType(453);}
    "space" {return tt.getKeywordTokenType(454);}
    "specification" {return tt.getKeywordTokenType(455);}
    "spfile" {return tt.getKeywordTokenType(456);}
    "split" {return tt.getKeywordTokenType(457);}
    "standalone" {return tt.getKeywordTokenType(458);}
    "standby" {return tt.getKeywordTokenType(459);}
    "start" {return tt.getKeywordTokenType(460);}
    "statistic" {return tt.getKeywordTokenType(461);}
    "statistics" {return tt.getKeywordTokenType(462);}
    "stop" {return tt.getKeywordTokenType(463);}
    "storage" {return tt.getKeywordTokenType(464);}
    "store" {return tt.getKeywordTokenType(465);}
    "submultiset" {return tt.getKeywordTokenType(466);}
    "subpartition" {return tt.getKeywordTokenType(467);}
    "subpartitions" {return tt.getKeywordTokenType(468);}
    "substitutable" {return tt.getKeywordTokenType(469);}
    "successful" {return tt.getKeywordTokenType(470);}
    "sum_squares_between" {return tt.getKeywordTokenType(471);}
    "sum_squares_within" {return tt.getKeywordTokenType(472);}
    "supplemental" {return tt.getKeywordTokenType(473);}
    "suspend" {return tt.getKeywordTokenType(474);}
    "switch" {return tt.getKeywordTokenType(475);}
    "switchover" {return tt.getKeywordTokenType(476);}
    "synonym" {return tt.getKeywordTokenType(477);}
    "system" {return tt.getKeywordTokenType(478);}
    "table" {return tt.getKeywordTokenType(479);}
    "tables" {return tt.getKeywordTokenType(480);}
    "tablespace" {return tt.getKeywordTokenType(481);}
    "tempfile" {return tt.getKeywordTokenType(482);}
    "template" {return tt.getKeywordTokenType(483);}
    "temporary" {return tt.getKeywordTokenType(484);}
    "test" {return tt.getKeywordTokenType(485);}
    "than" {return tt.getKeywordTokenType(486);}
    "then" {return tt.getKeywordTokenType(487);}
    "thread" {return tt.getKeywordTokenType(488);}
    "through" {return tt.getKeywordTokenType(489);}
    "time" {return tt.getKeywordTokenType(490);}
    "time_zone" {return tt.getKeywordTokenType(491);}
    "timeout" {return tt.getKeywordTokenType(492);}
    "timezone_abbr" {return tt.getKeywordTokenType(493);}
    "timezone_hour" {return tt.getKeywordTokenType(494);}
    "timezone_minute" {return tt.getKeywordTokenType(495);}
    "timezone_region" {return tt.getKeywordTokenType(496);}
    "to" {return tt.getKeywordTokenType(497);}
    "trace" {return tt.getKeywordTokenType(498);}
    "tracking" {return tt.getKeywordTokenType(499);}
    "trailing" {return tt.getKeywordTokenType(500);}
    "transaction" {return tt.getKeywordTokenType(501);}
    "trigger" {return tt.getKeywordTokenType(502);}
    "truncate" {return tt.getKeywordTokenType(503);}
    "trusted" {return tt.getKeywordTokenType(504);}
    "two_sided_prob" {return tt.getKeywordTokenType(505);}
    "two_sided_sig" {return tt.getKeywordTokenType(506);}
    "type" {return tt.getKeywordTokenType(507);}
    "u_statistic" {return tt.getKeywordTokenType(508);}
    "uid" {return tt.getKeywordTokenType(509);}
    "unarchived" {return tt.getKeywordTokenType(510);}
    "unbounded" {return tt.getKeywordTokenType(511);}
    "under" {return tt.getKeywordTokenType(512);}
    "under_path" {return tt.getKeywordTokenType(513);}
    "undrop" {return tt.getKeywordTokenType(514);}
    "union" {return tt.getKeywordTokenType(515);}
    "unique" {return tt.getKeywordTokenType(516);}
    "unlimited" {return tt.getKeywordTokenType(517);}
    "unpivot" {return tt.getKeywordTokenType(518);}
    "unprotected" {return tt.getKeywordTokenType(519);}
    "unquiesce" {return tt.getKeywordTokenType(520);}
    "unrecoverable" {return tt.getKeywordTokenType(521);}
    "until" {return tt.getKeywordTokenType(522);}
    "unusable" {return tt.getKeywordTokenType(523);}
    "unused" {return tt.getKeywordTokenType(524);}
    "update" {return tt.getKeywordTokenType(525);}
    "updated" {return tt.getKeywordTokenType(526);}
    "upgrade" {return tt.getKeywordTokenType(527);}
    "upsert" {return tt.getKeywordTokenType(528);}
    "usage" {return tt.getKeywordTokenType(529);}
    "user" {return tt.getKeywordTokenType(530);}
    "using" {return tt.getKeywordTokenType(531);}
    "validate" {return tt.getKeywordTokenType(532);}
    "validation" {return tt.getKeywordTokenType(533);}
    "values" {return tt.getKeywordTokenType(534);}
    "varray" {return tt.getKeywordTokenType(535);}
    "version" {return tt.getKeywordTokenType(536);}
    "versions" {return tt.getKeywordTokenType(537);}
    "view" {return tt.getKeywordTokenType(538);}
    "wait" {return tt.getKeywordTokenType(539);}
    "wellformed" {return tt.getKeywordTokenType(540);}
    "when" {return tt.getKeywordTokenType(541);}
    "whenever" {return tt.getKeywordTokenType(542);}
    "where" {return tt.getKeywordTokenType(543);}
    "with" {return tt.getKeywordTokenType(544);}
    "within" {return tt.getKeywordTokenType(545);}
    "without" {return tt.getKeywordTokenType(546);}
    "work" {return tt.getKeywordTokenType(547);}
    "write" {return tt.getKeywordTokenType(548);}
