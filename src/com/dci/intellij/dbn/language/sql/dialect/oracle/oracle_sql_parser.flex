...
"pretty" {return tt.getKeywordTokenType(401);}
"primary" {return tt.getKeywordTokenType(402);}
"prior" {return tt.getKeywordTokenType(403);}
"private" {return tt.getKeywordTokenType(404);}
"privilege" {return tt.getKeywordTokenType(405);}
"privileges" {return tt.getKeywordTokenType(406);}
"procedure" {return tt.getKeywordTokenType(407);}
"process" {return tt.getKeywordTokenType(408);}
"profile" {return tt.getKeywordTokenType(409);}
"program" {return tt.getKeywordTokenType(410);}
"protection" {return tt.getKeywordTokenType(411);}
"public" {return tt.getKeywordTokenType(412);}
"purge" {return tt.getKeywordTokenType(413);}
"query" {return tt.getKeywordTokenType(414);}
"queue" {return tt.getKeywordTokenType(415);}
"quiesce" {return tt.getKeywordTokenType(416);}
"range" {return tt.getKeywordTokenType(417);}
"read" {return tt.getKeywordTokenType(418);}
"reads" {return tt.getKeywordTokenType(419);}
"rebalance" {return tt.getKeywordTokenType(420);}
"rebuild" {return tt.getKeywordTokenType(421);}
"recover" {return tt.getKeywordTokenType(422);}
"recovery" {return tt.getKeywordTokenType(423);}
"recycle" {return tt.getKeywordTokenType(424);}
"ref" {return tt.getKeywordTokenType(425);}
"reference" {return tt.getKeywordTokenType(426);}
"references" {return tt.getKeywordTokenType(427);}
"refresh" {return tt.getKeywordTokenType(428);}
"regexp_like" {return tt.getKeywordTokenType(429);}
"register" {return tt.getKeywordTokenType(430);}
"reject" {return tt.getKeywordTokenType(431);}
"rely" {return tt.getKeywordTokenType(432);}
"remainder" {return tt.getKeywordTokenType(433);}
"rename" {return tt.getKeywordTokenType(434);}
"repair" {return tt.getKeywordTokenType(435);}
"replace" {return tt.getKeywordTokenType(436);}
"reset" {return tt.getKeywordTokenType(437);}
"resetlogs" {return tt.getKeywordTokenType(438);}
"resize" {return tt.getKeywordTokenType(439);}
"resolve" {return tt.getKeywordTokenType(440);}
"resolver" {return tt.getKeywordTokenType(441);}
"resource" {return tt.getKeywordTokenType(442);}
"restrict" {return tt.getKeywordTokenType(443);}
"restricted" {return tt.getKeywordTokenType(444);}
"resumable" {return tt.getKeywordTokenType(445);}
"resume" {return tt.getKeywordTokenType(446);}
"retention" {return tt.getKeywordTokenType(447);}
"return" {return tt.getKeywordTokenType(448);}
"returning" {return tt.getKeywordTokenType(449);}
"reuse" {return tt.getKeywordTokenType(450);}
"reverse" {return tt.getKeywordTokenType(451);}
"revoke" {return tt.getKeywordTokenType(452);}
"rewrite" {return tt.getKeywordTokenType(453);}
"right" {return tt.getKeywordTokenType(454);}
"role" {return tt.getKeywordTokenType(455);}
"rollback" {return tt.getKeywordTokenType(456);}
"rollup" {return tt.getKeywordTokenType(457);}
"row" {return tt.getKeywordTokenType(458);}
"rownum" {return tt.getKeywordTokenType(459);}
"rows" {return tt.getKeywordTokenType(460);}
"rule" {return tt.getKeywordTokenType(461);}
"rules" {return tt.getKeywordTokenType(462);}
"salt" {return tt.getKeywordTokenType(463);}
"sample" {return tt.getKeywordTokenType(464);}
"savepoint" {return tt.getKeywordTokenType(465);}
"scan" {return tt.getKeywordTokenType(466);}
"scheduler" {return tt.getKeywordTokenType(467);}
"schemacheck" {return tt.getKeywordTokenType(468);}
"scn" {return tt.getKeywordTokenType(469);}
"scope" {return tt.getKeywordTokenType(470);}
"second" {return tt.getKeywordTokenType(471);}
"seed" {return tt.getKeywordTokenType(472);}
"segment" {return tt.getKeywordTokenType(473);}
"select" {return tt.getKeywordTokenType(474);}
"sequence" {return tt.getKeywordTokenType(475);}
"sequential" {return tt.getKeywordTokenType(476);}
"serializable" {return tt.getKeywordTokenType(477);}
"session" {return tt.getKeywordTokenType(478);}
"set" {return tt.getKeywordTokenType(479);}
"sets" {return tt.getKeywordTokenType(480);}
"settings" {return tt.getKeywordTokenType(481);}
"share" {return tt.getKeywordTokenType(482);}
"shared_pool" {return tt.getKeywordTokenType(483);}
"show" {return tt.getKeywordTokenType(484);}
"shrink" {return tt.getKeywordTokenType(485);}
"shutdown" {return tt.getKeywordTokenType(486);}
"siblings" {return tt.getKeywordTokenType(487);}
"sid" {return tt.getKeywordTokenType(488);}
"sig" {return tt.getKeywordTokenType(489);}
"single" {return tt.getKeywordTokenType(490);}
"size" {return tt.getKeywordTokenType(491);}
"skip" {return tt.getKeywordTokenType(492);}
"smallfile" {return tt.getKeywordTokenType(493);}
"some" {return tt.getKeywordTokenType(494);}
"sort" {return tt.getKeywordTokenType(495);}
"source" {return tt.getKeywordTokenType(496);}
"space" {return tt.getKeywordTokenType(497);}
"specification" {return tt.getKeywordTokenType(498);}
"spfile" {return tt.getKeywordTokenType(499);}
"split" {return tt.getKeywordTokenType(500);}
"sql" {return tt.getKeywordTokenType(501);}
"standalone" {return tt.getKeywordTokenType(502);}
"standby" {return tt.getKeywordTokenType(503);}
"start" {return tt.getKeywordTokenType(504);}
"statistic" {return tt.getKeywordTokenType(505);}
"statistics" {return tt.getKeywordTokenType(506);}
"stop" {return tt.getKeywordTokenType(507);}
"storage" {return tt.getKeywordTokenType(508);}
"store" {return tt.getKeywordTokenType(509);}
"strict" {return tt.getKeywordTokenType(510);}
"submultiset" {return tt.getKeywordTokenType(511);}
"subpartition" {return tt.getKeywordTokenType(512);}
"subpartitions" {return tt.getKeywordTokenType(513);}
"substitutable" {return tt.getKeywordTokenType(514);}
"successful" {return tt.getKeywordTokenType(515);}
"sum_squares_between" {return tt.getKeywordTokenType(516);}
"sum_squares_within" {return tt.getKeywordTokenType(517);}
"supplemental" {return tt.getKeywordTokenType(518);}
"suspend" {return tt.getKeywordTokenType(519);}
"switch" {return tt.getKeywordTokenType(520);}
"switchover" {return tt.getKeywordTokenType(521);}
"synonym" {return tt.getKeywordTokenType(522);}
"system" {return tt.getKeywordTokenType(523);}
"table" {return tt.getKeywordTokenType(524);}
"tables" {return tt.getKeywordTokenType(525);}
"tablespace" {return tt.getKeywordTokenType(526);}
"tempfile" {return tt.getKeywordTokenType(527);}
"template" {return tt.getKeywordTokenType(528);}
"temporary" {return tt.getKeywordTokenType(529);}
"test" {return tt.getKeywordTokenType(530);}
"than" {return tt.getKeywordTokenType(531);}
"then" {return tt.getKeywordTokenType(532);}
"thread" {return tt.getKeywordTokenType(533);}
"through" {return tt.getKeywordTokenType(534);}
"ties" {return tt.getKeywordTokenType(535);}
"time" {return tt.getKeywordTokenType(536);}
"time_zone" {return tt.getKeywordTokenType(537);}
"timeout" {return tt.getKeywordTokenType(538);}
"timezone_abbr" {return tt.getKeywordTokenType(539);}
"timezone_hour" {return tt.getKeywordTokenType(540);}
"timezone_minute" {return tt.getKeywordTokenType(541);}
"timezone_region" {return tt.getKeywordTokenType(542);}
"to" {return tt.getKeywordTokenType(543);}
"trace" {return tt.getKeywordTokenType(544);}
"tracking" {return tt.getKeywordTokenType(545);}
"trailing" {return tt.getKeywordTokenType(546);}
"transaction" {return tt.getKeywordTokenType(547);}
"trigger" {return tt.getKeywordTokenType(548);}
"truncate" {return tt.getKeywordTokenType(549);}
"trusted" {return tt.getKeywordTokenType(550);}
"tuning" {return tt.getKeywordTokenType(551);}
"two_sided_prob" {return tt.getKeywordTokenType(552);}
"two_sided_sig" {return tt.getKeywordTokenType(553);}
"type" {return tt.getKeywordTokenType(554);}
"u_statistic" {return tt.getKeywordTokenType(555);}
"uid" {return tt.getKeywordTokenType(556);}
"unarchived" {return tt.getKeywordTokenType(557);}
"unbounded" {return tt.getKeywordTokenType(558);}
"unconditional" {return tt.getKeywordTokenType(559);}
"under" {return tt.getKeywordTokenType(560);}
"under_path" {return tt.getKeywordTokenType(561);}
"undrop" {return tt.getKeywordTokenType(562);}
"union" {return tt.getKeywordTokenType(563);}
"unique" {return tt.getKeywordTokenType(564);}
"unlimited" {return tt.getKeywordTokenType(565);}
"unpivot" {return tt.getKeywordTokenType(566);}
"unprotected" {return tt.getKeywordTokenType(567);}
"unquiesce" {return tt.getKeywordTokenType(568);}
"unrecoverable" {return tt.getKeywordTokenType(569);}
"until" {return tt.getKeywordTokenType(570);}
"unusable" {return tt.getKeywordTokenType(571);}
"unused" {return tt.getKeywordTokenType(572);}
"update" {return tt.getKeywordTokenType(573);}
"updated" {return tt.getKeywordTokenType(574);}
"upgrade" {return tt.getKeywordTokenType(575);}
"upsert" {return tt.getKeywordTokenType(576);}
"usage" {return tt.getKeywordTokenType(577);}
"use" {return tt.getKeywordTokenType(578);}
"user" {return tt.getKeywordTokenType(579);}
"using" {return tt.getKeywordTokenType(580);}
"validate" {return tt.getKeywordTokenType(581);}
"validation" {return tt.getKeywordTokenType(582);}
"value" {return tt.getKeywordTokenType(583);}
"values" {return tt.getKeywordTokenType(584);}
"varray" {return tt.getKeywordTokenType(585);}
"version" {return tt.getKeywordTokenType(586);}
"versions" {return tt.getKeywordTokenType(587);}
"view" {return tt.getKeywordTokenType(588);}
"wait" {return tt.getKeywordTokenType(589);}
"wellformed" {return tt.getKeywordTokenType(590);}
"when" {return tt.getKeywordTokenType(591);}
"whenever" {return tt.getKeywordTokenType(592);}
"where" {return tt.getKeywordTokenType(593);}
"with" {return tt.getKeywordTokenType(594);}
"within" {return tt.getKeywordTokenType(595);}
"without" {return tt.getKeywordTokenType(596);}
"work" {return tt.getKeywordTokenType(597);}
"wrapper" {return tt.getKeywordTokenType(598);}
"write" {return tt.getKeywordTokenType(599);}
"xml" {return tt.getKeywordTokenType(600);}
"xmlnamespaces" {return tt.getKeywordTokenType(601);}
"xmlschema" {return tt.getKeywordTokenType(602);}
"xmltype" {return tt.getKeywordTokenType(603);}
"year" {return tt.getKeywordTokenType(604);}
"yes" {return tt.getKeywordTokenType(605);}
"zone" {return tt.getKeywordTokenType(606);}
"false" {return tt.getKeywordTokenType(607);}
"true" {return tt.getKeywordTokenType(608);}
