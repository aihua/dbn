...
<YYINITIAL> {
    ...
    "values" {return tt.getKeywordTokenType(533);}
    "varray" {return tt.getKeywordTokenType(534);}
    "version" {return tt.getKeywordTokenType(535);}
    "versions" {return tt.getKeywordTokenType(536);}
    "view" {return tt.getKeywordTokenType(537);}
    "wait" {return tt.getKeywordTokenType(538);}
    "wellformed" {return tt.getKeywordTokenType(539);}
    "when" {return tt.getKeywordTokenType(540);}
    "whenever" {return tt.getKeywordTokenType(541);}
    "where" {return tt.getKeywordTokenType(542);}
    "with" {return tt.getKeywordTokenType(543);}
    "within" {return tt.getKeywordTokenType(544);}
    "without" {return tt.getKeywordTokenType(545);}
    "work" {return tt.getKeywordTokenType(546);}
    "write" {return tt.getKeywordTokenType(547);}
    "xml" {return tt.getKeywordTokenType(548);}
    "xmlnamespaces" {return tt.getKeywordTokenType(549);}
    "xmlschema" {return tt.getKeywordTokenType(550);}
    "xmltype" {return tt.getKeywordTokenType(551);}
    "year" {return tt.getKeywordTokenType(552);}
    "yes" {return tt.getKeywordTokenType(553);}
    "zone" {return tt.getKeywordTokenType(554);}
    "false" {return tt.getKeywordTokenType(555);}
    "true" {return tt.getKeywordTokenType(556);}
