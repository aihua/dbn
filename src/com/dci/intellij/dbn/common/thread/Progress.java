...
public interface Progress {
    static void background(Project project, String title, boolean cancellable, ParametricRunnable.Unsafe<ProgressIndicator> runnable) {
        Failsafe.lenient(() -> {
    ...
    static void prompt(Project project, String title, boolean cancellable, ParametricRunnable.Unsafe<ProgressIndicator> runnable) {
        Failsafe.lenient(() -> {
    ...
    static void modal(Project project, String title, boolean cancellable, ParametricRunnable.Unsafe<ProgressIndicator> runnable) {
        Failsafe.lenient(() -> {
