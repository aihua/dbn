...
public class FilterConditionMoveDownAction extends AbstractObjectFilterAction {

    public FilterConditionMoveDownAction(ObjectNameFilterSettingsForm settingsForm) {
