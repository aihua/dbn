...
public class DBMethodRunConfiguration extends DBProgramRunConfiguration<MethodExecutionInput> {
    ...
    @NotNull
    public DBMethodRunConfigurationEditor getConfigurationEditor() {
        if (configurationEditor == null )
            configurationEditor = new DBMethodRunConfigurationEditor(this);
    ...
    public RunConfiguration clone() {
        DBMethodRunConfiguration runConfiguration = (DBMethodRunConfiguration) super.clone();
